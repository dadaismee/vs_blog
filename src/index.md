...
Превращаю сложные данные и знание в системы, которые объясняют сами себя: автоматические документы из сырых данных, интерактивные интерфейсы для сложных продуктов, инструменты мышления для команд, работающих со знанием. [Подробнее](/offer)
...
![Объяснение системы в одном из уроков](explanation.mp4)
