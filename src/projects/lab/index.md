...
|---|---|---|
| **Подготовка** | Пишет в Word: оформляет заголовки, списки, таблицы | Пишет в Markdown, оформление автоматизировано |
| **Библиография** | Оформляет библиографию по ГОСТу вручную | Цитирует `[@citation_key]` — никакого форматирования |
