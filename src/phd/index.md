...
- Формально, институт в нашей концепции — это сеть дельта-стабилизированных равновесий в условных стратегий с высокой взаимной информацией. 
- Прото-институт (как часть определения института) — это равновесие в условных стратегиях (коррелированное, байесовское, ЭСС) в расширенной игре с неполной информацией и конфликтом интересов, которое является Парето-улучшением по отношению к существующему равновесию в базовой игре.
  - Эквивалентная ситуация — множество игр с низкой взаимной информацией: применение санкции в одной ситуации ничего не говорит об ее применении в другой.
...
- Если каналы доставки и масштабирования санкции — суть института, то они должны быть до-институциональными (светофор и униформа полицеских — это НЕ каналы доставки дельты, а вот камера, фиксирующая превышение скорости — уже такой канал). Они онтологически примитивны:
...
- Любой механизм или устройство, обеспечивающие одну или больше функций (память, физическая доступность, наблюдаемость), может служить эмпирическим каналом «доставки» санкции.
  - Это будет важно на этапе операционализации для применения нашей теории в качестве методологии социологических исследований
