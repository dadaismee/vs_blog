...
И хотя интуиция верна, само сравнение не вполне легитимно, поскольку задействует разные эпистемические допущения: в случае животных стратегии в матрице — это фенотипы, то есть разные доли популяции, а в случае людей — действия агентов. И хотя оба случая можно описать как КР, их интерпретация необходимо будет разной — пробабилстической в случае животных и эпистемической — в лучае людей. 
...
По форме случай ЯГБ у Мейнарда-Смита, на который опирается Гуала для аргументации недостаточности равновесий для определения социальных институтов, похож на КР Ауманна [@aumann1987]: есть источник публичного сигнала — асимметрия среды (роль «владелец» или «захватчик»), которая «видна» обоим агентам — если один владеет территорией, то второй — нет. Согласно Ауманну — автору концепции КР, для КР агенты должны знать распределение вероятностей устройства корреляции, что может предполагать байесовскую рациональность и наличие убеждений (beliefs) [@aumann1987]. Однако это необязательно и вероятность, как утверждает Скирмс, может быть объективной [@skyrms2014]. В случае данного территориального спора животных агенты действительно «знают» распределение вероятностей, потому что *приватный и общий сигнал совпадают* — каждый агент либо «чужак», либо «владелец», и эти роли взаимоисключающие.

Условная стратегия у Мейнарда Смита сочетает в себе свойства КР и ЭСС — рекомендует действие в зависимости от контекста и устойчива к мутантным эксплуатирующим стратегиям. При этом источник вероятности в КР здесь — объективный: Природа назначает каждому игроку тип — «владелец» или «захватчик» — с вероятностью ¹⁄₂, и оба игрока знают общее распределение вероятностей.

В отличие от Буржуа-стратегии, условная стратегия «пасти скот, если находишься к югу от реки» в игре с племенами не имеет свойства ЭСС
