...
Однако корень проблемы, по моему мнению, глубже — в самой формулировке теории правил-в-равновесии. Аргументируя унификацию институтов как правил и равнвовесий, Гуала исходит из недостаточности каждого элемента по отдельности: правила могут не иметь принудительной силы, а равновесия могут описывать слишком большой класс феноменов — например, решение территориальных споров у животных [@hindriks2015a]. Решение Гуалы — приравнять регулятивные правила вроде «стой на красный, иди на зеленый» к условным стратегиям агентов 
<!--как источник равновесия стратегий агентов — изначально спорное, несмотря на верную интуицию о «социальных нормах» как устройстве корреляции, которую разделяют многие философы [@gintis2009a; @ross2006; @binmore2010]. -->

> Там же Гуала говорит, что rules play an essential role in *achieving* those equilibria that form institutions — правила существуют до равновесий
...
> точно есть круг в определении: сначала говорит что правила нужны для достижения равновесия в потом говорит что праивла репрезентируют стратегии, которым нужно следовать — These rules are representations in symbolic form of the strategies that ought to be followed in a given game (467)
> rules represent equilibria (or parts of equilibria) and help the players to exploit a particular correlation device (468)
> Гуала выводит прескриптивность правил из рекомендательного характера коррелирующего устройства, однако в другом месте признает, что это слабая нормативность инструментальной рациональности, а не деонтические силы [@guala2015]
...
И хотя интуиция верна, само сравнение Гуалы не вполне легитимно, поскольку задействует разные эпистемические допущения: в случае животных стратегии в матрице — это фенотипы (разные доли популяции), а в случае людей — действия агентов. В случае животных КР, представленное симметричными условными стратегиями, эволюционно стабильно (ЭСС и КР совпадают), однако в случае людей такой гарантии нет.

<!--Это предполагает анализ самого Гуалы, опирающийся на Мейнарда-Смита и Дэвиса [@maynardsmith1982; @davies1978]. -->
...
По форме случай ЯГБ у Мейнарда-Смита, на который опирается Гуала, похож на КР Ауманна [@aumann1987], столь ценное для Гуалы: есть источник публичного сигнала — асимметрия среды (роль «владелец» или «захватчик»), которая «видна» обоим агентам — если один владеет территорией, то второй — нет. В этом смысле распределение вероятностей стратегий простое. Это предельный случай, когда условная стратегия — ЭСС, однако нельзя сказать, что она КР в строгом (эпистемическом) смысле Ауманна — в ней нет субъективных ожиданий[^corr&ESS]. 
