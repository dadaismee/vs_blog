...
В этой главе мы строим формальную модель игры ЯГБ с неполной информацией и показываем условия динамической (эволюционной) стабильности условной стратегии. Это позволит разрешить проблему статуса правил в теории Гуалы — *ex ante*/*ex post*.
...
- Прото-институт (как часть определения института) — это равновесие (коррелированное, байесовское, ЭСС) в расширенной игре с неполной информацией и конфликтом интересов, которое является Парето-улучшением по отношению к равновесию в базовой игре.
- для существования института нужны:
  - ситуация с конфликтом интересов (ЯГБ, дилемма заключенного, битва полов)
  - условная стратегия, решающая конфликт и связанная с чистыми стратегиями (а не как у Гуалы)
  - $\delta$-параметр — модификатор платежа для стратегии блефа, эксплуатирующей условную стратегию
  - равновесие в условных стратегиях (неважно, КР или ЭСС)
  - множество структурно идентичных игровых ситуаций с равновесием и дельтой
  - канал информации между ними
...
- Правила — удобный язык для описания состояния параметров $\delta$ и $I$ в обпределенной сети стратегических ситуаций, а не онтологически фундаментальный слой реальности. Однако они нужны в нашей унифицированной онтологии как эпистемический «плагин» для описания
...
#### 4.1.1 Динамический подход к онтологии института
- институт сложно корректно описать статически, поскольку в нем есть несколько этапов 
- Скирмс описал образование социального контракта из состояния ястреб-голубь «из ничего» — как результата обучения с подкреплением. Однако такой социальный контракт — еще не институт в нашем понимании. Это коррелированная конвенция — по словам самого Скирмса.
- Именно такую коррелированную конвенцию описал Гуала в своей теории. Однако он не учел неполноту информации, которая привела к необходимости дельты. 
- Это значит, что для существования института необходимо существование коррелированной конвенции — равновесия в условной стратегии, которое потенциально можно эксплуатировать. Дельта появляется для «защиты» коррелированной конвенции от эксплуатации.

#### 4.1.2 Институт и протоинститут: значение параметров $\delta$ и $I$
- Дельта — это размер санкции, I — степень статистической корреляции (или взаимной информации) между игровыми ситуациями. 
- Локальное дельта-стабилизированное равновесие — это протоинститут: есть санкция, но нет глобальности ее применения. Эквивалентная ситуация — множество игр с низкой взаимной информацией: применение санкции в одной ситуации ничего не говорит об ее применении в другой.
- Если значение санкции переносимо между контекстами, то это институт. Если нет — протоинститут.

- Институт функционален этиологически

### 4.2 Статус равновесий
Равновесия необходимы, но недостаточны для определения института:
- равновесие действительно отражает стабильное состояние социальной системы, однако оно невозможно без модификатора платежа — вне зависимости от типа устойчивости (ЭСС или КР)
...
- интуиция института как корреляции стратегии, встречаемся в литературе, верна, но неточна — институт требует не только скоррелированных стратегий, но и скоррелированных усилий по защите скоррелированных стратегий от эксплуатации.

### 4.3 Статус правил
- Правила — не фундаментальная онтологическая единица, а этап развития сети, «слой» поверх сети, определяемый значением параметров $\delta$ и $I$:
...
- Правила не являются онтологическими примитивами и не необходимы для работы онтологии, но представляют собой удобный язык описания информационно-силовой сети. Если эта сеть — онтологический «бэкенд», то правила с их различением конститутивных и регулятивных — пользовательский интерфейс, делающий описание удобным и в терминах агентов, и в терминах внешнего наблюдателя.
- Правила — эпистемическия «плагин» для удобства описания онтологии, а не онтологический примитив, как полагал Сёрль. Однако это не умаляет нужность его подхода в унифицированной социальной онтологии.
