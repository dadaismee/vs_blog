...
И хотя интуиция верна, само сравнение не вполне легитимно, поскольку задействует разные эпистемические допущения: в случае животных стратегии в матрице — это *фенотипы*, то есть разные доли популяции, а в случае людей — действия агентов. И хотя оба случая можно описать как КР, их интерпретация будет разной — пробабилстической в случае животных и эпистемической — в случае людей.
...
Стратегия «блефующего чужака» направлена в первую очередь на эксплуатацию Буржуа как ЭСС. Блефер всегда посылает сигнал «владельца», то есть его вероятность блефа $e \in [0,1]$. Мы не будем рассматривать ситуации ЭСС в смешанных стратегиях, поскольку заинтересованы только в условных стратегиях.

Стратегия «блефующего чужака» устроена следующим образом. Он *всегда захватчик* и играет так же, как Буржуа, условно: 

ОСТАНОВИЛСЯ ЗДЕСЬ

- получив сигнал «захватчик», всегда играет Ястреба, 
...
<!--# Шаг 0. Что нужно доказать-->
<!---->
<!--Чтобы показать, что стратегия **B (буржуа с неполной информацией)** **НЕ является ЭСС**, достаточно показать, что существует мутант, у которого **платёж против буржуа выше**, чем у самого буржуа против себя:-->
<!---->
<!--[-->
...
<!------->
<!---->
<!--# Шаг 1. Платёж буржуа против буржуа-->
<!---->
<!--Буржуа не различает тип соперника (неполная информация), поэтому платёж стандартный:-->
<!---->
<!--[-->
<!--\pi(B,B) = \frac{V}{2}-->
<!--]-->
...
<!--* Реагирует на сигнал:-->
<!---->
<!--  * Если сигнал правдивый (с вероятностью (e)) → играет H-->
<!--  * Если сигнал ложный (с вероятностью (1-e)) → играет D-->
<!---->
<!--* Против захватчика → всегда играет H-->
<!---->
<!--> Теперь (e) — это **вероятность, что полученный сигнал соответствует реальному типу владельца**, а не вероятность внутреннего блефа.-->
<!---->
<!------->
<!---->
<!--# Шаг 3. Платёж мутанта против буржуа-->
<!---->
<!--Тип буржуа:-->
<!---->
<!--* Владелец — (1/2)-->
<!--* Захватчик — (1/2)-->
<!---->
<!--### 🔹 Если буржуа — владелец-->
<!---->
<!--* Сигнал правдивый (вероятность (e)) → M играет H → бой → получает ((V-C)/2)-->
<!--* Сигнал ложный (вероятность (1-e)) → M играет D → получает 0-->
<!---->
<!--[-->
<!--\frac12 \cdot \Big[ e \cdot \frac{V-C}{2} + (1-e) \cdot 0 \Big] = \frac12 \cdot e \frac{V-C}{2}-->
<!--]-->
<!---->
<!--### 🔹 Если буржуа — захватчик-->
<!---->
<!--* M играет H → выигрывает V-->
<!---->
<!--[-->
<!--\frac12 \cdot V-->
<!--]-->
...
<!------->
<!---->
<!--### 🔹 Итоговый платёж мутанта-->
<!---->
<!--[-->
<!--\pi(M,B) = \frac12 V + \frac12 e \frac{V-C}{2} = \frac{V}{2} + e \frac{V-C}{4}-->
<!--]-->
<!---->
<!------->
<!---->
<!--# Шаг 4. Сравниваем с буржуа-->
<!---->
<!--[-->
<!--\pi(B,B) = \frac{V}{2}, \quad-->
<!--\pi(M,B) = \frac{V}{2} + e \frac{V-C}{4}-->
<!--]-->
<!---->
<!--Если (V > C) и (e > 0), то:-->
<!---->
...
<!---->
<!--[-->
<!--\boxed{\text{Буржуа с неполной информацией НЕ является ЭСС}}-->
<!--]-->
<!---->
...
<!---->
<!--✔ не нужен (\varepsilon)-->
<!--✔ не нужен полный ESS‑анализ-->
<!--✔ достаточно одного мутанта и одного неравенства-->
<!--✔ логика прозрачна и легко объяснима-->
<!---->
<!------->
<!---->
<!--## Формула‑однострочник для статьи-->
<!---->
...
<!--> [-->
<!--> \pi(M,B) = \frac{V}{2} + e \frac{V-C}{4} > \frac{V}{2} = \pi(B,B)-->
<!--> ]-->
<!--> при (V > C) и (e > 0).-->
<!---->
<!------->
<!---->
<!--Если хочешь, я могу сделать **ещё более наглядную таблицу с «тип → сигнал → действие → платеж»**, где видно, как именно (e) влияет на матожидание, чтобы визуально развязать «сигнал ≠ выбор стратегии».-->
<!---->
<!--Хочешь такую таблицу?-->
<!---->
встречается с «честным Буржуа», который может оказаться как владельцем, так и захватчиком ресурса — в ¹⁄₂ случаев каждый. В зависимости от реального типа Буржуа, Блефер получите разный выигрыш: если Буржуа — владелец, то Блефер получает $(1-e) \frac{V-C}{2}$

наказывается физически только в случаях, когда противник-Буржа действительно владелец ресурса. Однако и «Голубь», и «честный Буржуа», неявляющий владельцем, увидев сигнал «владельца», который посылает «блефующий чужак», отступают. Это даёт больший выигрыш при любой положительной вероятности блефа:
$$
\begin{gathered}
\pi_B=(1-e) \frac{V-C}{2} \\
\pi_BL=(1-e)V + e\frac{V-C}{2}
\end{gathered}
$$
