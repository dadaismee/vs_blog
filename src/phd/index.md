...
#### 3.1.1 Создание конвенции: симметричный «Ястреб-Голубь»
...
- Используя динамику Скримса, мы говорим, что условная Буржуа-стратегия, зависимая от информационной асимметрии (сигнала) появляется в игре как результат адаптивной динамиики в популяции, даже если агенты не обладают понятием собственности.

#### 3.1.2 Буржуа-стратегия как ЭСС при неполной информации 
