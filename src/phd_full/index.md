...
[^no-mixed]: Теоретики эпистемических игр утверждают, что не существует коррелята равновесия в смешанных стратегиях, если рассматривать его с эпистемической (или интеллектуальной) точки зрения [@perea]. Я согласен с ними и говорю об этом здесь только для сравнения с CE.
...
Однако, проблема, не позволяющая в полной мере говорить о теории Гуалы как о натуралистической — композитное совмещение теорий, критикуемое Айдинонат и Юликоски [@ylikoski2018] и упоминаемое ранее. Оно не позволяет углубить представление об *онтологии домена* — социальных институтах, но лишь совмещает *разные языки* в одну объяснительную схему. 
...
Именно это структурное ядро — конфигурации $(r,\delta,\Delta u)$, обеспечивающие устойчивые коррелированные равновесия, — и задаёт ту часть реальности, которую разные социологические теории затем описывают на своём языке.

Важно подчеркнуть, что такая онтология не редуцирует социальное к теории игр. Напротив, она рассматривает игровые модели как эвристический инструмент для реконструкции минимального механизма принудительности.
