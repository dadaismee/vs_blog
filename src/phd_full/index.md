...
Основное требование нашей модели — *асимметрия ролей игроков*, которую оба из них могут наблюдать и оценивать: больше/меньше, раньше/позже и т.д. Согласно Скирмсу и Херрману, динамическое создание конвенций (то есть, условных стратегий) требует наличия *любой* интерпретируемой асимметрии [@herrmann2021]. 

ОСТАНОВИЛСЯ ЗДЕСЬ
<!--сделать и вставить картинки модели в питоне-->

<!--[? каковы условия работы этой модели]-->

- асимметрию ролей: у игроков разные роли (или типы) — это необходимо для образования условной стратегии
- неполную информацию: игроки не знают наверняка тип оппонента и могут блефовать, эксплуатируя неопределённость
- популяцию игр: наличие множества игр — например, на пространственной сетке

<!--В случае игры ЯГБ матрица для четырёх стратегий — трёх стандартных и Блефующего — выглядит следующим образом:-->
<!--- вставить матрицу 4*4 с дельтой — todo-->

<!--[? работает ли модель в других играх на кооперацию с неполной информацией]-->
