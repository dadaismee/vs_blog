...
Суровость санкции $\delta$ — это обобщённая мера «боли», которую несёт нарушитель, если наказание наступило. Это могут быть прямые материальные штрафы, ограничение свободы и доступа к ресурсам, утрата статуса, символическое унижение, долгосрочные репутационные потери. Важно и то, сколько стоит поддерживать высокий уровень $\delta$, то есть $k(\delta)$: бюджеты силовых структур, политические риски применения жёстких санкций, культурные издержки стигматизации и другое.
...
Вместе $r\delta$ — это компактное обозначение всей *социоматериальной инфраструктуры фиксации нарушений и доставки наказаний*. Сюда входят материальные артефакты, социальных технологии, символические системы и организационные формы, которые делают наказание за отклонение достаточно частым и достаточно ощутимым, чтобы нейтрализовать структурную премию за нарушение. Институт, в нашем смысле, — это именно такая инфраструктура, а не только набор текстов или «правило в головах».

ОСТАНОВИЛСЯ ЗДЕСЬ

Это сразу выводит нас на политическую и конфликтную плоскость, которая в главе 1 фигурировала лишь имплицитно. Группы и акторы могут бороться за контроль над \(\delta\) (суровостью наказаний), над \(r\) (плотностью и избирательностью мониторинга) и над определением того, какие действия вообще попадают под санкции. Наша параметризация делает видимыми эти линии борьбы: изменяя \(r\delta\), акторы изменяют то, какие условные стратегии оказываются устойчивыми, и тем самым — какие институты фактически существуют.


Под параметром $\delta$ понимается суровость санкции, при этом сама санкция может быть любой: штрафы, физические наказания, потери статуса, потеря доступа к ресурсу и т.д.

Под параметром $r$ поминается надёжность или частота применения санкции: плотность мониторинга, качество фиксации нарушений, технологические и организационные аспекты наблюдения — камеры, учёт, бюрократия, слухи и т.д. 


- \(\delta\) — **локальная суровость санкции** (насколько сильно «больно», когда наказали):
  - издержки поддержания высокой \(\delta\) (бюджеты, тюрьмы, репрессивный аппарат, социальные издержки стигматизации).
- \(r\) — **надёжность/частота применения**:
- Вместе \(r\delta\) — **эффективная сила санкции**. Но важно: это не магический «скаляр», а компактное описание **социоматериальной инфраструктуры фиксации и наказания**:
  - социальная память и репутация;  
  - пространственная и организационная связанность;  
  - материальные артефакты и информационные системы.
- Здесь можно мягко ввести идею конкуренции:
  - группы борются за контроль над \(\delta\) и \(r\) (кто определяет суровость и надёжность наказаний);  
  - это переводит модель в поле политической социологии и конфликтов.
