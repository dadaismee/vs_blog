...
1. Представлена картина социального института как БКР с санкционирующим механизмом (модификатором платежа), обобщаяющая теорию правил-в-равновесии Франческо Гуалы на ситуации неполной информации и неопределённости, где общее знание и санкции — два разных механизма достижения равновесия. С точки зрения формализма, институт — это подкласс БКР с более жёстким условием «повиновения», чем стандартные формулировки Бергемана-Морриса: «повиновение» реализуется в том числе в результате санкции, а не только информационной структуры игры, задаваемой информационным дизайнером (государством или подобным внешним актором).

    1.1 Формулировка института как БКР с санкцией позволяет провести значимые онтологические различения и отделить работающие институты от «хрупких» и номинальных, чего не делают теории Сёрла, Гуалы и Грейфа.

    1.2 Формулировка института как БКР с санкцией позволяет обобщить теорию Гуалы, включив в себя как случаи полной информации, принуждение не нужно и координация реализуется благодаря совпадению личного и общего интереса (как у Гуалы), так и неполной, где нужно внешнее принуждение. Это позволяет рассматривать принудительные институты и конвенции в духе Вандершраафа через единый формализм БКР.
...
2. *Уточнено отношение между конститутивными и регулятивными правилами и между деонтическим и теоретико-игровым подходом* в контексте унифицированной социальной онтологии в целом. В текущей литературе конститутивные правила понимаются как более фундаментальные — даже в современных синтетических подхода они создают пространство институциональной игры, а регулятивные — регулируют его [@hindriks2019]. Это как разница между «придумать правила светофора» и «следовать сигналам светофора». 
    ...
    Регулятивное правило можно понимать как отображение из информационных состояний в рекомендуемые действия, например $f: \Omega \to S$ в классическом случае КР или, более общо, $f: T \times \Theta \to \Delta(S)$ в БКР, где каждому профилю типов и состоянию мира сопоставляется распределение вероятностей на профилях стратегий. Конститутивное правило — это то же отображение, но для которого выполняется условие БКР с санкцией: отклонение от предписанного действия ведёт к ожидаемой санкции, так что следование правилу является наилучшим ответом при данных верованиях агентов. 

    Мы сохраняем идеи статусных функций и деонтических сил и переописываем коллективное принятие статусных функций как общее знание или его функциональный эквивалент — вероятностные санкции. Это позволяет не редуцировать теорию Сёрла к равновесиям, а продуктивно их связать: однако, в нашей трактовке конститутивное правило Сёрла теряет свой творческий пафос «создания реальности», поскольку онтологическая разница между ним и регулятивным — в факте выполнения условия БКР (выполнено для конститутивного и не выполнено для регулятивного). Так мы унифицируем деонтический и теоретико-игровой подход не на уровне языка, как это делают Гуала и Хиндрикс, а на уровне онтологии.
