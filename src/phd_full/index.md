...
Социальные конвенции представляют большой интерес для социальной онтологии, философского исследования сущностей, составляющих социальный мир. Некоторые ученые рассматривают их как основополагающие блоки социальной онтологии [@bickhard2008], а другие используют их как более примитивные единицы для построения сложных социальных онтологий, включающих понятия *социальных институтов*, которые часто называют нормативно-ориентированными наборами соглашений [@aoki2007; @hindriks2022]. Например, @guala2016 отмечает, что такие обыденные понятия, как «профессор», «студент» или «муж», не имеют смысла без социальных институтов как нормативных структур, встраивающих и делающих возможными эти роли и их содержание. Это потому, что эти понятия являются частью по большей части скрытой и воспринимаемой как должное инфраструктуры ролей с обязанностями и правами. И, как утверждает Гуала, именно институты скрепляют их воедино.

Значительная часть современной социальной онтологии оторвана от реальной социальной науки [@sarkia2023]. Она в основном развивалась в рамках аналитической философии [@baker2019; @searle1995; @epstein2015; @gilbert1992] и социально-научной традиции критического реализма [@archer1995; @elder-vass2010]. Существуют взгляды, согласно которым социальная онтология по своей сути сложнее любой «естественной» онтологии, поскольку она «интерактивна», зависит от убеждений отдельных лиц и, следовательно, изменчива [@hacking1999; @epstein2015], и что социальная реальность по своей природе нормативна, то есть она не может быть описательной и, следовательно, не может заимствовать методологии из «естественных» онтологий [@asta2024; @haslanger2012]. Такая позиция обосновывает важность «вненаучного» изучения социального мира. На мой взгляд, как интерактивность, так и присущая социальной реальности нормативность не препятствуют их объяснению с натуралистической точки зрения, что могло бы пролить свет на описательную социальную онтологию.

Согласно @epstein2018, область социальной онтологии делится на два отдельных направления исследований. Первое касается составляющих социальных сущностей и отвечает на вопрос «из чего состоит социальный мир?». Второе направление исследований связано с построением социальных категорий или типов и с вопросом «как устанавливаются такие социальные типы, как деньги, границы, брак и другие?». Отдельные люди, составляющие социальную группу, иллюстрируют первое направление, а дети, играющие в игру, где плюшевые игрушки устраивают чаепитие, — второе (поскольку они «создали» условия для того, чтобы что-то стало чаепитием) [@epstein2015, 57].

Разница между направлениями заключается в метафизическом отношении индивидов и социальных фактов. В первом случае социальные факты накладываются на факты об индивидах, то есть социальные свойства не могут измениться без изменения индивидуальных свойств. Во втором случае факты об отдельных лицах *создают условия* для того, чтобы что-то считалось социальным фактом, т. е. долларовые купюры, напечатанные определенными чернилами на определенной бумаге, и коллективное принятие в качестве денег [-@epstein2015, 58].

Одно из самых известных выражений последнего — формула Сёрла [-@searle1995] «X считается как Y в контексте C». Например, «купюры, выпущенные Бюро гравировки и печати (X), считаются долларами (Y) в Соединенных Штатах (C)» [-@searle1995, 28]. Эпштейн называет первое отношение (иллюстрируемое словом «выпущено») *обоснованием*, а второе (иллюстрируемое словом «считается как») *привязкой*, где обоснование отвечает за *условия реализации* того, чтобы быть, например, деньгами в определенном контексте, а привязка отвечает за *механизм установления условий реализации*. Например, в случае Сёрла, *коллективное принятие* факта X является таким механизмом[^обоснование].

[^обоснование]: Формула Сёрла включает в себя оба отношения, обоснование и привязку, но для простоты и для того, чтобы прояснить коллективное принятие как необходимое условие для формулы Сёрла, я буду называть его привязкой.

Такое соображение иллюстрирует одну из двух основных точек зрения на роль метафизики[^метафизика] в научном исследовании. Первая, эмпирическая, делает метафизику неактуальной и избыточной или, если воспринимать её всерьёз, ожидает, что её ограничения на модели будут препятствовать росту знаний. Другая точка зрения предполагает наличие специальных метафизических концепций, выходящих за рамки самого научного словаря. Например, они различают степени возможности и необходимости, в значительной степени неизвестные науке, и выходят за рамки причинной зависимости, широко используемой в науке [@ross2023].

@ross2023 предлагает различать *аналитическую* и *научную* социальную онтологию, где первая выводится из концептуального анализа, а вторая основана на эмпирических исследованиях. Для Росса «натуралистическая метафизика», как он её называет, не применяет трансцендентальные концепции, за исключением тех, которые встречаются в теориях, моделях или объяснениях «науки первого порядка».

Росс защищает то, что он называет «радикально натуралистической метафизикой», которая направлена ​​на содействие научному прогрессу и может включать в себя объединение или синтез научных открытий.

[^метафизика]: Метафизика отличается от онтологии тем, что последняя представляет собой совокупность сущностей в определенной области, существование которых считается очевидным, а первая изучает более широкие понятия тождества, причинности и тому подобное.

Физика предоставляет яркий контраст для сравнения научной и аналитической метафизики. Онтология физики формулируется в математических терминах, требующих определенной технической компетентности. Формулировка онтологии физики аналитическим способом с использованием «возможных миров» и «предложений» была бы нелогичной и излишне сложной. Она потребовала бы перевода уже существующих научных концепций на язык аналитической метафизики.

Социальные науки и социальная онтология не обладают такой прямолинейностью математических формулировок своих концепций, как физика[^математика]. Вместо этого они приглашают к использованию «народных» концепций, таких как «убеждения», «группы» и «социальные». факты». Дальнейшее разделение возникает из-за отношения к этой неоднозначности. Некоторые ученые утверждают, что таких «народных» онтологий достаточно [@ruben1989, @thomassen2003], а другие выдвигают на первый план взаимодействие «народных» и социально-научных онтологий, соединяя то, что @sellars1962 назвал «явным» и «научным» образом явлений в рамках своей социально-онтологической теории [@asta2012; @guala2016; @haslanger2018][^folk-psychology]. Неоднозначность между «народной» и научной социальной онтологией действительно может зависеть от математического аппарата и его недостаточно развитого характера в социальных науках. @ross2023 также отмечает, что построение онтологии, скорее всего, потребует ее формулировки с использованием математических моделей, чувствительных к структурному моделированию (таких как иерархический байесовский вывод[^hbi]), а не теории множеств и подобных инструментов аналитической метафизики.

[^mathsoc]: Хотя это и не широко известно, Подобные попытки были. См. @simon1962, @fararo1978 и, что особенно важно, @gintis2007.

[^народная психология]: Это отражает давнюю дискуссию в философии сознания о «народной психологии» и элиминативизме, где одна сторона утверждает, что «народные» понятия, такие как убеждения и желания, приблизительно соответствуют реальным внутренним процессам работы мозга [#insertSource], а другая сторона сводит эти понятия к состояниям мозга и утверждает, что истинные внутренние процессы могут быть описаны только в материальных и механистических терминах [#insertSource].

[^hbi]: Иерархический Байес — это модель с вероятностными параметрами (то есть неопределенными), которая допускает иерархические отношения между случайными переменными.

Как уже упоминалось, аналитическая социальная онтология основана на концептуальном анализе и утверждает, что она предшествует методологии социальных наук [@searle1995; @epstein2016; @lauer2019]. Натуралистическая сторона критикует этот подход как оторванный от Актуальные социальные науки [@elder-vass2007; @sarkia2023; @kincaid2024; @ross2023; @little2020]. Их фокус скорее метаонтологический, чем онтологический, поскольку они задаются вопросом, что значит задавать вопросы об онтологии социальных наук и каковы способы достижения онтологии, вместо того чтобы предлагать или критиковать конкретные онтологические модели.

Наше основное внимание будет уделено «единой социальной онтологии» Гуалы [@guala2015; @hindriks2015; @guala2016], которая пытается сохранить «лучшее из обоих миров» аналитической и натуралистической социальной онтологии, предлагая научно строгий подход к классической аналитической социальной онтологии Сёрла [-@searle1995].

В своих стандартных формулировках, которые @guala2007 называет «Стандартной моделью социальной онтологии» (SMOSO), социальная онтология описывает слабо ограниченный индивидуализм. Основы социальных явлений имеют три ключевых элемента [@tuomela2002]:

- рефлексивность
- перформативность
- коллективная интенциональность.

Рефлексивность — это свойство социальных образований, в значительной степени состоящее из убеждений о убеждениях. Существуют формулировки рефлексивных убеждений в режиме «я» и в режиме «мы». Некоторые философы утверждают, что исходные и наиболее основные убеждения, составляющие «ткань» социального, по сути находятся в режиме «мы» и не сводятся к режиму «я» [@tuomela2002; @gilbert1992; @schmid2023]. Однако существуют также более индивидуалистические объяснения рефлексивных убеждений, основанные на теории игр [@guala2016; @bicchieri2005].

Перформативность означает, что социальные образования нуждаются в постоянном поддержании, исполнении или воссоздании. А коллективная интенциональность, в свою очередь, относится к совместной направленности множества индивидов на явление, которое способствует его формированию. Коллективная интенциональность обычно представляется либо как производная от общеизвестных знаний и «я-убеждений» вида «все знают, что все знают, что P», где P — некоторый социальный факт, например, социальная норма [@bicchieri2005], или примитивное понятие, делающее общеизвестные знания избыточными. Более того, предпринимаются попытки натурализовать коллективную интенциональность, показывая ее неприводимость к индивидуальной интенциональности [@rakoczy2007; @gallotti2012].

Ярким примером является работа Сёрла [-@searle1995], который задаётся вопросом, возможно ли быть эпистемологически объективным в отношении онтологически субъективных вопросов. Как мы можем познать истины о вещах, существование которых зависит от наших представлений или чувств, например, о деньгах, собственности и браке? Анализируя эти различия онтологии/эпистемологии и объективности/субъективности, Сёрл пришёл к идее недостающего элемента, позволяющего составить картину онтологически субъективных сущностей, а именно *конститутивных правил* вида «X считается Y в C».

Здесь наши классификации социального мира помогают его устанавливать и поддерживать, тогда как несоциальные объекты безразличны к нашим классификациям, как утверждает @hacking1999, выделяя интерактивные и безразличные виды[^kinds]. Объекты природы не меняют своего поведения в зависимости от этих классификаций, в отличие от социальных объектов. Эта идея иллюстрирует понятия рефлексивности и перформативности, характерные для «Стандартной модели». Если социальные сущности состоят из убеждений о убеждениях, то их природа зависит от этих убеждений, и если убеждения меняются, то и социальные сущности соответственно меняются. Если социальные сущности зависят от убеждений о них, то необходимо постоянно демонстрировать эти убеждения, чтобы поддерживать их. Для этого индивидам необходимо иметь коллективное намерение относительно этих убеждений. Например, чтобы деньги существовали сами по себе, соответствующее сообщество должно иметь коллективное намерение верить, что определенные физические объекты могут быть использованы в качестве средства обмена.

[^kinds]: Это различие отражает классическое различие между естественными и социальными типами, где первые представляют собой «кластеры гомеостатических свойств», наборы необходимых и стабильных характеристик [@boyd1991].

Наряду со «Стандартной моделью», @guala2007 называет теорию игр одним из двух основных подходов к социальной онтологии. Он отходит от работ @schelling1980 и @lewis1969, утверждая, что последний первым применил анализ рационального выбора к социальной онтологии и представил социальные конвенции как системы самоподдерживающихся убеждений. Шеллинг, ещё до Льюиса, уже осознавал, что проблемы координации неразрешимы с чисто теоретико-игровой точки зрения, если допустить существование фокальных точек, поскольку последние требуют отдельного объяснения. Шеллинг выступал за дополнение априорного подхода к теории игр эмпирическими исследованиями возникновения фокальных точек. Этот момент был дополнительно развёрнут @sugden2006, как мы видели в предыдущей главе.

Внутренняя проблема применения теории игр к социальной онтологии заключается в отсутствии механизма распространения высокоэффективных стратегий среди популяции. С точки зрения биологической приспособленности, наиболее успешная стратегия, выведенная из долгой эволюционной истории, распространяется по всей популяции. Напротив, с точки зрения полезности, сама причина распространения стратегии, приносящей пользу, требует объяснения. Именно поэтому Гуала критикует применение теории игр к социальной онтологии и пытается её модифицировать.

Гуала стремится преодолеть недостатки как «стандартной модели» с её полным антиреализмом (из-за зависимости от убеждений), так и теории игр в своей собственной «единой социальной онтологии», которая интегрирует понятия рефлексивности, перформативности и интенциональности с формальными описаниями социальных конвенций как объективных структур, лежащих в основе вышеупомянутых особенностей «стандартной модели».

@hindriks2015 предлагает теорию, согласно которой социальные институты, такие как деньги, брак и другие, можно рассматривать как (наборы) конвенций в луизианском смысле с добавлением нормативности. Они используют множество аргументов из наших предыдущих обсуждений, таких как Ауманн/Вандершраф *CE*, Скирмс/Мейнард-Смит *ESS*, и подчеркивают роль *нормативных убеждений* аналогично Биккьери/Гинтису. Поскольку позже мы поставим проблему в рамках их теории, важно тщательно изложить и разобрать ее, что я и сделаю в следующем разделе.
