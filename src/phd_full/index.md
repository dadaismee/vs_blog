...
Другими словами, мы говорим о сети стратегических ситуаций, связанных информационным каналом.
...
Порог \(\delta > \frac{V}{4}\) действительно защищает Буржуа в локальном смысле ЭСС, служа аттрактором в игре с двумя стратегиями, но если игр больше одной, то важно не только существование этого порога, но и то, как фактические санкции распределены в сети взаимодействий.

Пусть есть $N$ стратегических ситуаций, где разные пастухи из племён Нуэр и Динка встречаются, чтобы пасти скот. У этих ситуаций одинаковая матрица выплат и значение $\delta$. В некоторых из этих ситуаций блеф наказывается, а в других — нет. Эти стратегические ситуации связаны друг с другом информационным каналом, по которому передаётся информация о фактах применения санкции среди игр.

Тогда *надёжность санкции* в популяции игр можно выразить как

$$r = \mathbb{E}[E\in \{0,1\}]$$,

то есть как долю игр, в которых санкция фактически следует за выявленным нарушением.

Если стратегии игроков формируют ожидания относительно применения санкций, то Блефующий оценивает свою выплату против Буржуа в “усреднённой игре” с учётом этого r:
