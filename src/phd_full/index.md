...
Жёлтым показана область параметров $(\delta, r)$, где условная стратегия Буржуа находится *в режиме института* — предполагает санкцию за отклонение, и является предсказуемой для агентов. Фиолетовым показана область параметров, где условная стратегия находится *в режиме прото-института* — формально санкция за отклонение от условной стратегии есть но она недостаточно часто применяется в сети игр. Это наводит нас на мысль, что институт — это не одно равновесие, а *область параметров, где динамическое равновесие в принципе реализуемо*.
