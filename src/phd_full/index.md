...
В интуитивных описаниях институт часто отождествляют с правилом или с устойчивым состоянием системы. В нашей рамке он выглядит иначе. Формально мы говорили о двух величинах: о премии за отклонение (насколько выгодно «жульничать» в конкретной игре) и о ожидаемой санкции за такое отклонение. Институт «по‑человечески» — это такая социоматериальная конфигурация, которая делает нарушение условной стратегии рискованным: ожидаемая санкция за блеф не меньше той выгоды, которую агент мог бы получить, exploitируя других.

Иначе говоря, институт — это не просто правило «делай X», а структура, которая делает мир устроенным так, что разумнее делать X, чем не делать. Не в том смысле, что отклонение невозможно, а в том, что оно систематически не окупается. В этом смысле институт — не одно равновесие, а целый участок параметров, в котором определённая условная стратегия может устойчиво реализовываться во множестве повторяющихся и родственных ситуаций.

Отсюда следует важное различение. Обычное коррелированное равновесие говорит нам: при текущем раскладе верований, сигналов и выплат у игроков нет стимулов отклоняться. Наша модель добавляет вопрос: почему так? Устойчивый институт — это ситуация, где отсутствие стимулов к отклонению обеспечивается не только удачной конфигурацией ожиданий, но и наличием инфраструктуры наказаний, которые делают отклонение систематически невыгодным.
