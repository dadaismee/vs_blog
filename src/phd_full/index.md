...
Физика ярко иллюстрирует контраст между научной и аналитической онтологией [@ross2023]. Онтология, которую описывает физическая теория, формулируется с помощью математического аппарата. Её формулировка аналитическим способом — например, в терминах семантики возможных миров — была бы контринтуитивной и сложной. Онтология, описываемая физикой, обусловлена (и ограничена) её матетматическим языком настолько удачно, что другие формулировки этой онтологии за пределами понятий и методов самой физики просто не нужны. 

ОСТАНОВИЛСЯ ЗДЕСЬ

<!--онтология физики обусловлена (и ограничена) её матетматическим языком настолько хорошо, что другие формулировки онтологии за прделеами самой физики просто не нужны-->
...
1. *Институт как равновесие (Раздел 1.1).* И хотя истоки этой традиции, идущей от Дэвида Льюиса, не связаны с институтами *per se*, её представители в философии, теории игр и новой институциональной экономике отождествляет институт с *равновесием в стратегическом взаимодействии* рациональных агентов. Принудительная сила здесь — сила самоисполняющегося ожидания: каждому участнику невыгодно отклоняться от своей стратегии в одностороннем порядке, если он ожидает, что другие будут следовать своим стратегиям. Кандидат на «наилучшее объяснение» — *структура стимулов как объективных ограничений*.
...
3. *Институт правило-в-равновесии: синтетический подход (Раздел 1.3).* Теория Франческо Гуалы и Фрэнка Хиндрикса представляет собой наиболее влиятельную попытку синтеза двух предыдущих подходов [@guala2016; @hindriks2015a; @hindriks2019; @hindriks2022]. Институт здесь понимается как *равновесие*, стабилизированное *правилом*. В равновесии находятся стратегии агентов, а правило — устройство корреляции и фокальная точка. Стратегии агентов зависят от общего знания правила, поэтому правило координирует ожидания. Кандидат на «наилучшее объяснение»: *единство нормативной координации и стратегической устойчивости*.
...
Ниже мы кратко представим интеллектуальные истоки теоретико-игрового подхода к социальной координации, исходящие от Дэвида Юма и Томаса Гоббса, затем рассмотрим важные для нашей работы понятия теории игр, — игра, платёжная функция, равновесие и несколько их разновидностей — а после представим реконструкцию традиции как *эндогенизации ограничения* — попытки поместить условия успешной координации внутрь структуры игры
