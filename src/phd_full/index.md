...
\end{array}
$$
<figcaption>Модификация платежей в «Дилемме заключенного»</figcaption>
...
<div class='table'>
![Параметры $r$ и $\delta$ компенсируют отклонение при разных вероятностях владельца играть $H$. Чем ниже вероятность, тем больше «красной» зоны, где равновесие рушится и институт перестаёт работать. Пунктирная линия означает порог $r\delta = \Delta$](assets/hd-parameters.png)
</div>
