...
Проблема принудительной силы социальных институтов — одна из центральных и наиболее дискуссионных в современной социальной онтологии. Социальные институты — деньги, право, собственность, брак, государство — не просто описывают, но и создают социальную реальность. Они направляют и ограничивают репертуар действий и создают устойчивые, самовоспроизводящиеся паттерны поведения. Этот феномен — принудительная сила институтов и её источник — составляет центральную проблему настоящего исследования.
...
*Цель исследования* — описать непротиворечивую унифицированную натуралистическую социальную онтологию института, которая интегрирует равновесия, правила, деонтические силы и санкции на уровне объяснения. Это значит, что она способна с помощью одной объяснительной схемы «схватить» описания разнородных теорий и показать их общее онтологическое основание.
...
С этим тесно связан *метод вывода к наилучшему объяснению* (IBE), который мы используем для «вывода» унифицированной социальной онтологии из объяснительно успешных теорий институтов — теорий Гуалы и Хиндрикса, Грейфа — и формальных инструментов теории игр. Мы критически рассматриваем существующие теории институтов, находим в них лакуны, предлагаем решение, объясняющее результаты многих из этих теорий и делаем вывод о том, что наша теория — кандидат на вывод к наилучшему объяснению принудительной силы института и его онтологии.
...
Далее мы рассматриваем игру с БКР и ненадёжным сигналом медиатора, который создаёт стимул для отклонения и систематически разрушает равновесие. Для компенсации этого стимула мы, в духе идей о санкциях у Грейфа, Остром и Гинтиса, вводим параметр величины санкции за отклонение. Поскольку концепция БКР содержит априорные и апостериорные вероятности, мы трактуем вероятность состояния мира, где санкция работает, как объективную характеристику санкционного механизма, а условную вероятность работающего санкционного механизма при получении сигнала как субъективную оценку агентом вероятности санкции при нарушении. Идея вероятностной санкции встречается в литературе в разных формах [@sousa2010; @ishikawa2025; @dari-mattiacci2021]. Этот параметр ключевой, поскольку его онтологическая интерпретация позволяет говорить о нём как о статистическом выражении работы подлежащих механизмов и инфраструктуры мониторинга нарушений и реализации санкций в отрыве от силового аппарата, обеспечивающего размер санкции $\delta$.

Структура БКР позволяет различать объективную (частотную) и субъективно-воспринимаемую (байесовскую) вероятности применения санкции в случае нарушения правила. Это позволяет учесть влияние верований агентов на поддержание принудительной силы института, а также идею, что реальная частота санкций может не совпадать с воспринимаемой. В остальном мы следуем каноничным формулировкам КР и БКР из работ Ауманна [@aumann1974; @aumann1987], Вандершраафа [@vanderschraaf1995], Машлера и коллег [@mashler2020], а также Бергемана и Морриса [@bergemann2016].

Следуя критерию «повиновения» (obedience) из работ Бергемана и Морриса, который звучит как «игрокам невыгодно отклоняться от сигнала медиатора после обновления своих верований» [@bergemann2016, 7], мы формулируем идею института как БКР с санкционирующим механизмом. Это БКР параметризовано силой санкции $\delta$ и апостериорной вероятностью — верой агента в вероятность санкции при возможном отклонении. Это позволяет представить частный случай условия «повиновения» с санкцией в свёрнутом эвристическом виде $r\delta > \Delta$, где воспринимаемая вероятность наступления санкции должна перекрывать возможный дополнительный выигрыш от отклонения от сигнала медиатора $\Delta$. Мы далее используем это неравенство и его составные части для онтологической экспликации, чтобы обозначить идею *границы устойчивости* института. Все остальные части БКР — распределения по типам и состояниям мира и другое — остаются «в фоне».
...
- вероятностный санкционный механизм, изменяющий ожидаемые выигрыши;
...
1. *Представлена картина социального института как Байес-коррелированного равновесия (БКР) с санкционирующим механизмом (модификатором платежа)*, обобщаяющая теорию правил-в-равновесии Франческо Гуалы на ситуации неполной информации и неопределённости, где общее знание и санкции — два разных механизма достижения равновесия. С точки зрения формализма, институт — это подкласс БКР с более жёстким условием «повиновения», чем стандартные формулировки Бергемана-Морриса: «повиновение» реализуется в том числе в результате вероятностной санкции, а не только информационной структуры игры, задаваемой информационным дизайнером (государством или подобным внешним актором).

    1.1 *Формулировка института как БКР с санкцией позволяет различить работающие, «хрупкие» и номинальные институты*, чего не делают теории Сёрла, Гуалы и Грейфа. Это же позволяет уточнить теорию Хиндрикса [@hindriks2022] о силе/хрупкости института.

    1.2 *Формулировка института как БКР с санкцией позволяет обобщить теорию Гуалы*, включив в себя как случаи полной информации, где принуждение не нужно и координация реализуется благодаря совпадению личного и общего интереса, так и неполной информации, где нужно внешнее принуждение. Это позволяет рассматривать принудительные институты и конвенции в духе Вандершраафа через единый формализм БКР — с санкцией или без неё соответственно.

    1.3 *Институт как БКР с санкцией показывает, что общее знание правила и вероятностные санкции функционально схожи для стабилизации равновесия.* Это вклад в линию Льюиса-Вандершраафа и конкретно в идеи Вандершраафа об институтах как механизмах возвращения правила в равновесие [@Vanderschraaf_2017]. 

    <!--Мы не только показываем, как этот механизма может быть устроен, но и связываем его с конвенцией Вандершраафа через идею отклонения от рекомендации $\Delta$.-->

    1.4 *Институт как БКР с санкцией позволяет выдвинуть тезис о возможности реализации эпистемического структурного реализма в социальных науках и конкретно в социологии*, что в литературе считалось трудноосуществимым. БКР с санкцией описывает структуру, схватываемую некоторыми теориями социологии с разных сторон. Части этой структуры — правила, санкции и механизмы фиксации нарушений и реализации санкций — можно трактовать как онтологически значимое ядро социологических теорий. Представленная рамка — кандидат на возможную структурную схему социального порядка: устойчивый социальный порядок любого масштаба реализует одну и ту же абстрактную структуру — конфигурацию вероятностных санкций и механизмов мониторинга, распределённую по ролям, делающую следование заданному правилу равновесным.
...
2. *Уточнено отношение между конститутивными и регулятивными правилами и между деонтическим и теоретико-игровым подходом* в контексте унифицированной социальной онтологии в целом. В текущей литературе конститутивные правила понимаются как более фундаментальные — даже в современных синтетических подхода они создают пространство институциональной игры, а регулятивные — регулируют его [@hindriks2019]. Это как разница между «придумать правила светофора» и «следовать сигналам светофора». 
    ...
    В противовес этому, наша рамка уточняет, что регулятивное правило логически предшествует конститутивному, и последнее — это режим, в котором правило функционирует так, как если бы оно стало общим знанием. Регулятивное правило — это предписание поведения, «правило-по-форме», если говорить узком Остром, и рекомендация медиатора, которую возможно проигнорировать при наличии достаточного стимула. 

    Это позволяет функционально развести регулятивные и конститутивные правила и описать идеи Сёрла в теоретико-игровых терминах. Вместо трансформационного подхода Гуалы и Хиндрикса, согласно которому регулятивные и конститутивные правила можно трансформировать друг в друга без потери онтологии, мы полагаем, что трансформировать можно лишь форму конститутивного правила, добавив «институциональный термин» вроде «денег» или «брака» для обозначения равновесия. 

    Регулятивное правило можно понимать как отображение из информационных состояний в рекомендуемые действия, например $\sigma: \Omega \to S$ в классическом случае КР или, более общо, $\sigma: T \times \Theta \to \Delta(S)$ в БКР, где каждому профилю типов и состоянию мира сопоставляется распределение вероятностей на профилях стратегий. Конститутивное правило — это то же отображение, но для которого выполняется условие БКР с санкцией: отклонение от предписанного действия ведёт к ожидаемой санкции, так что следование правилу является наилучшим ответом при байесовски обновлённых верованиях агентов. 

    Мы сохраняем идеи статусных функций и деонтических сил и переописываем коллективное принятие статусных функций как общее знание или его функциональный эквивалент — вероятностные санкции. Это позволяет не редуцировать теорию Сёрла к равновесиям, а продуктивно их связать: однако, в нашей трактовке конститутивное правило Сёрла теряет свой творческий пафос «создания реальности», поскольку онтологическая разница между ним и регулятивным — в факте выполнения условия БКР (выполнено для конститутивного и не выполнено для регулятивного). Такой взгляд позволяет разложить «конституцию» на этапы: создание правила $\sigma: \Omega → S$, которое ничего не делает само по себе, создание инфраструктуры принуждения $\delta$ и информационной структуры, которые обеспечивают выполнение правила и, наконец, реализация этого правила как равновесия и присвоение ему термина вроде «денег» или «брака». Так мы унифицируем деонтический и теоретико-игровой подход не на уровне языка, как это делают Гуала и Хиндрикс, а на уровне онтологии.

3. *Представлена натуралистическая унифицирующая социально-онтологическая рамка*, объединяющая не только равновесные и правилоориентированные, но также санкционирующие и деонтические подходы к социальным институтам. Осуществлённая унификация — объяснительная и онтологическая. В отличие от теории Гуалы и Хиндрикса, предложенная рамка объединяет объясняемые (*explananda*) разных теорий под одной схемой, а не только инструменты, и не приоритизирует объяснение стабильности в ущерб деонтическим силам и нормативным силам правил. Следуя методу IBE, мы можем онтологизировать подобную схему. В ней институт — это параметризованное правило в равновесии, обеспечиваемое социоматериальной инфраструктурой фиксации нарушений и реализации санкций и верой агентов в функционирование этой инфраструктуры. 

## Положения, выносимые на защиту

<!--1. Концепции статусных функций Сёрла недостаточно для объяснения принудительной силы института, поскольку она не описывает источник и механизм реализации деонтических сил.-->

1. Унифицированной социальной онтологии Гуалы и Хиндрикса — теории правил в равновесии — недостаточно для объяснения принудительной силы института, поскольку она рассматривает институт как коррелированное равновесие. Это предполагает полную информацию, прозрачность сигналов и отсутствие неопределённости и сводит институт к конвенции, стабильность которой поддерживается общим знанием правила и сонаправленностью общих и личных интересов. Подобное описание выносит за скобки необходимость социального принуждения. Использование более общего байесовского коррелированного равновесия (БКР) позволяет точнее описать типы институтов и отделить их от конвенции. БКР также позволяет описывать институты и конвенции одним формализмом, где отличаются лишь значения параметров.

2. Поздней теории правил и равновесий Хиндрикса также недостаточно для объяснения принудительной силы и решения проблемы сильных/хрупких институтов, поскольку она, вслед за теорией условного предпочтения Биккиери, *постулирует* обязательность (obligation) выполнения правила и наличие внутренней мотивации за пределами санкций и поэтому объясняет силу и хрупкость института через расхождение правил/норм и фактически реализуемых равновесий. Наша рамка института как БКР с санкцией позволяет обобщить и уточнить теорию Хиндрикса. Во-первых, социальную норму можно представить не как отдельную сущность, а как часть условия «повиновения» в БКР, выразимую как правило принятия решения $\sigma = T \times \Theta → \Delta(S)$ вместе с санкцией $\delta$, вычитаемой из платежа в случае отклонения от этого правила.  Во-вторых, поскольку норма — это не отдельная сущность, то силу института можно представить не как разницу между нормой и равновесием, а как разницу между априорной и апостериорной вероятностью санкции в условии «повиновения» БКР — если они совпадают (реальная частота санкций и оценка агента), то институт сильный, а если нет — реализован либо хрупкий, либо «спящий» (номинальный) институт.

3. Общая структура для описания конвенции, института и нормы позволяет утверждать, что теория игр и концепция БКР с санкцией, в частности, подходит для построения «радикально натуралистической» социальной онтологии в духе Дона Росса, поскольку позволяет абстрактно и точно описать структуру взаимодействия без апелляции к метафизическим понятиям, постулируемым как онтологические примитивы в других теориях — коллективной интенциональности, обязательств и социальных норм.

4. Регулятивные и конститутивные правила Сёрла можно выразить на языке теории игр, и они, в отличие от их положения в унифицирующей онтологии Гуалы, будут иметь разную функцию — «правило-по-форме» и «правило-в-действии» соответственно. Формально, регулятивное правило можно задать отображением из информационных состояний в рекомендуемые действия $f: \Omega \to S$ (или $f: T \times \Theta \to \Delta(S)$ в более общем случае БКР), тогда как конститутивное правило — это БКР с санкцией с этим отображением. Это означает, что логически регулятивное правило предшествует конститутивному, а не наоборот, как принято считать.

5. Институт с точки зрения социальной онтологии — это параметризованное правило в равновесии, чья принудительная сила проистекает из санкционной инфраструктуры и информационной структуры. Принудительная сила института не требует существования социальной нормы как онтологического примитива — нормативность уже встроена в условие равновесия как $\delta$-параметр. С точки зрения теории игр институт — это система механизмов изменения стратегического пространства игры, включающая в себя правило принятия решения (устройство корреляции) и модификатор платежа как вероятностную санкцию за отклонение от рекомендованной стратегии; математически институт — это подкласс БКР с более жёстким, чем стандартное, условием «повиновения» (obedience) с $\delta$-параметром.
...
Поиск ответа на вопрос о природе института сталкивается с радикальным расхождением в существующих теоретических подходах. Одни теории, уходящие корнями в философию действия, выводят принудительность из сферы ментального: из коллективных убеждений, интенций и разделяемых правил [@searle1995; @gilbert1992]. Другие, развиваемые в рамках экономики и теории рационального выбора, видят её источник в структуре материальных стимулов и стратегических равновесий [@lewis1969; @greif2006]. Этот конфликт интерпретаций указывает на более глубокую методологическую проблему — каким способом вообще стоит искать онтологическое основание социальных феноменов?

Философ науки Дон Росс предлагает различать *аналитическую* и *научную* социальную онтологию, где основной метод первой — концептуальный анализ, а второй — эмпирические исследования и вывод к наилучшему объяснению (inference to the best explanation, далее IBE)[^ibe] [@ross2023]. Для Росса «радикально натуралистическая метафизика», как он её называет, должна использовать только концепции, встречающиеся в теориях, моделях или объяснениях самой науки.

[^ibe]: Есть мнение, что метод вывода к наилучшему объяснению принципиально недоступен для социальных наук и социологии, в частности, поскольку в них «нет аналогов гравитационных волн или бозона Хиггса» [@hawley2018] — то есть, фундаментальных единиц анализа, исходя из которых можно выводить онтологию по лекалам научного реализма [@psillos1999]. В данном исследовании мы постараемся показать обратное: что IBE — продуктивный путь к онтологии социального.

*Аналитическая социальная онтология*, исходя из априорного теоретизирования, стремится выявить необходимые и достаточные условия социальных феноменов через логический разбор и интуитивную проверку ключевых понятий — «правило», «интенциональность», «статусная функция» и т.д. Такая онтология утверждает, что она *логически предшествует* методологии социальных наук [@searle1995; @epstein2016; @lauer2019]. Иначе говоря, невозможно изучать социальное, не определив заранее его ключевые характеристики, или видовые свойства. 

Классическим примером служит проект Джона Сёрла, который через формулу «X считается Y в контексте C» пытается эксплицировать *конститутивные правила*, лежащие в основе институциональной реальности [@searle1995]. В этой парадигме принудительная сила института вытекает из факта коллективного принятия определённых статусных функций — статусов, коллективно назначенных материальным объектам или паттернам поведения. Аналитический подход, таким образом, начинает с концептуальных допущений о природе социального и пытается прийти от них к структуре реальности. К тому же, этот подход предполагет человеческую уникальность и антропоцентризм, постулируя зависимость от языка.
...
Согласно Вндершраафу, Юм выделяет четыре ключевые особенности конвенций [@vanderschraaf1998]:
...
: Координационная игра. $L$ и $R$ — левая и правая сторона дороги
<!--</div>-->
...
\end{aligned}
$$
Это равновесие в смешанных стратегиях представляет собой компромисс справедливости и координации посредством рандомизации, хотя и менее эффективный, чем чистое равновесие Нэша из-за присущих ему рисков неправильной координации.
...
|                     | Футбол | Балет | Следовать монетке |
|---------------------|--------|-------|-------------------|
| Футбол              | 2, 1   | 0, 0  | 1, 0.5           |
| Балет               | 0, 0   | 1, 2  | 0.5, 1           |
| Следовать монетке   | 1, 0.5 | 0.5, 1| 1.5, 1.5         |

: *«Битва полов» с коррелированным равновесием*
...
Интеллектуальная атмосфера, в которой создавалась работа Дэвида Льюиса *Convention* [@lewis1969], была в значительной степени сосредоточена на вопросах языка, значения и социального поведения.
...
Эта рекурсивная концепция знания стала предметом обширных обсуждений в философской и теоретико-игровой литературе. Роберт Ауманн [@aumann1976] и другие независимо предложили формальные модели общего знания, отличающиеся от неформального подхода Льюиса.
...
![Сигнальная игра. $N$ — природа, которая назначает состояние мира, отправитель $S$ выбирает сообщение при виде состояния мира, получатель $R$ выбирает действие при виде полученного сообщения](assets/signalling-game.svg){width=70%}
...
Функция $f: \Omega \to A$ возвращает кортежи скоррелированных совместных стратегий в зависимости от состояния мира $\omega$. Для каждого $\omega \in \Omega$,
...
2.  Выполняется условие строгого предпочтения следования предписанию:
...
При подбрасывании честной монеты задаётся вероятностное пространство $\Omega = \{H, T\}$ с исходами «орёл» и «решка». У агентов есть общее информационное разбиение $\mathscr{H} = \{\{H\}, \{T\}\}$, и если выпадает «орел» ($H$), оба идут на балет, а если «решка» ($T$) — на футбол. 

<!--а коррелированная комбинация стратегий задаётся функцией-->
<!---->
<!--$$f: \Omega \rightarrow \{A1, A2\} \times \{A1, A2\}$$-->
<!---->
<!--где $f(H) = (A1, A1)$ и $f(T) = (A2, A2)$. -->
...
[^choreographer]: Многие исследователи используют метафоры, подчёркивающие внешний характер КР: «медиатор» и «корреляционное устройство» [@fudenberg1991], «хореограф» [@gintis2009a] и другие.
...
<br/>
$$
\text{Источник} \xrightarrow{сообщение} \text{Энкодер} \xrightarrow{сигнал} \text{Канал} \xrightarrow{сигнал} \text{Декодер} \xrightarrow{сообщение}
$$
<br/>

Философ биологии Маноло Мартинез предлагает подход к сигнальным играм, сфокусированный на канале, а не сообщении, и утверждает, что центральной поведенческой единицей игры Льюиса-Скирмса является не стратегия, а *пара кодирования-декодирования*, что аналогично вышеупомянутым отображениям [@martinez2019].
...
\end{array}\right]
$$
: Матрица условных вероятностей сообщений и действий
<br/>

Критикуя Скирмса, Мартинез отмечает, что тот недостаточно углубился в математическую теорию информации и анализировал информацию только *после того, как стратегии были приняты*, что не объясняет, как агенты к ним пришли. Мартинез предлагает использовать *функцию скорости–искажения Шеннона* [@shannon1948], чтобы показать минимальную *взаимную информацию* между состояниями и действиями при минимальном уровне искажения. Это позволяет *интерпретировать выплаты как показатели искажения в канале*. С этой точки зрения, координационная игра сигнализации, даже включающая обман или блеф, воспринимается как кооперативная информационная структура, поскольку этот код радзеляется обоими агентами и делает полезную работу для обоих, пусть и иногда в большую сторону для одного из них.
...
По сравнению с классической теорией социальных норм Ульманн-Маргалит, которая концептуализировала нормы прежде всего как решения повторяющихся социальных проблем — координации, кооперации и предотвращения конфликтов — и рассматривала их как функциональные образования [@ullmann-margalit1977], подход Биккиери расходится с ним в двух отношениях:
...
По словам Сёрла, «институциональные факты существуют только в системах конститутивных правил» [@searle1995]. Эти правила зависят от коллективного признания и имеют принудительную силу[^durkheim]. Коллективное признание зависит от коллективной интенциональности — постулируемой Сёрлом когнитивной способности индивидов иметь сонаправленность мысли.
...
<!--— [? как традиция серла решает проблему стабильности социальных институтов]-->

Последователи Сёрла развивают его идеи в социальной онтологии. Раймо Туомела фокусируется на «мы-интенциях», интегрируя их в теорию коллективного принятия: институты возникают из совместных интенций, но Туомела подчеркивает роль норм и санкций в поддержании принудительной силы [@tuomela2002; @tuomela2007]. Фрэнк Хиндрикс, пересматривая роль конститутивных правил, отмечает их нормативность: они касаются статусов с нормативными атрибутами, а не только наделения физического объекта статусом, что позволяет учитывать неявные институты без явного языка [@hindriks2009; @hindriks2013].
...
Дферрфи Уорнок был одним из первых, кто прокомментировал идеи Сёрла. Она считал, что различение типов правил у Сёрла — лишь лингвистическое: действия конститутивны или регулятивны относительно описания, а не онтологически [@warnock1971]. Подобную линию продолжили Дэвид-Хиллел Рубен [@ruben1997] и, что интересно, социолог Энтони Гидденс. Последний считает различение конститутивных и регулятивных правилам искусственным: все правила, по его мнению, имеют оба аспекта. Например, правило «работники должны отмечаться в 8:00» регулирует поведение, но конституирует индустриальную бюрократию [@giddens1984]. Миллер [@miller2001, 191] и Людвиг [@ludwig2017, 262] переопределяют конститутивные правила как регулятивные. В частности, Людвиг называет конститутивные правила такими регулятивными правилами, намеренное следование которым и конституирует управляемую им активность. Иначе говоря, конститутивные правила — это просто целенаправленно следуемые регулятивные правила. В данном исследовании мы также приходим к выводу, что конститутивное правило — это «режим» регулятивного, что согласуется с идеями Гидденса и других критиков. Правила отличаются не онтологически, а функционально.

Фрэнк Хиндрикс критикует Сёрла по нескольким направлениям. Во-первых, он ставит под сомнение акцент Сёрла на языке как источнике институциональной власти. Он говорит, что различение регулятивных и конститутивных правила — грамматическое: регулятивные правила формулируются с использованием явных императивов или деонтических терминов, в то время как конститутивные правила — с помощью конструкции «считается как», но оба содержат одно и то же нормативное содержание [@hindriks2009]. Нормативные обязательства явно присутствуют в регулятивных правилах («Сделай X» / «Если Y, сделай X»), тогда как конститутивные правила подразумевают эти обязательства, не заявляя о них явно. Таким образом, место нормативности на самом деле не отличается между ними, а отличается только языковое представление. Несмотря на то, что Хиндрикс предлагает логическую схему сводимости одних к другим, он также считает, что это не умаляет онтологического значения конститутивных правил. Даже если лингвистически они похожи, то онтологически (или, скорее, функционально) — нет, утверждает Хиндрикс.

Во-вторых, Хиндрикс утверждает, что Сёрл не проясняет отношение между коллективным принятием, обязательствами и деонтическими силами [@hindriks2015b]. Его последователи считают, что коллективная интенциональность предполагает коллективные обязательства [@gilbert1992], другие отрицают это [@bratman2022]. Также Сёрл не проясняет, что именно из себя представляет коллективное принятие и каким образом оно генерирует деонтические силы. Также Хиндрикс предлагает отказаться от термина «статусная функция» в пользу «статуса», поскольку, по его словам, это сделает теорию прозрачнее и понятнее. 
...
: *Модификация платежей в «Дилемме заключенного»*
...
Однако акцент на эффективности правил имеет и обратную сторону. Поскольку для подхода институтов-как-правил принуждение к исполнению правил — отдельный вопрос от их содержания, то поведение, не согласующееся с формальными правилами, автоматически объясняется неформальными правилами [@greif2011]. 
...
: *Дилемма заключённого и «Охота на оленя»*
...
: Модификация платежей с помощью дельта-параметра
...
### 1.3.1 Поздняя теория правил и равновесий Хиндрикса
После совместной работы с Гуалой, Хиндрикс начал разрабатывать собственную теорию институтов в отрыве от унифицирующего пафоса их общей социальной онтологии. Хиндрикса больше интересует проблема нормативности, которую, по его словам, их общая теория не решает [@hindriks2022]. Для этого он разрабатывает теорию правил и равновесий (ПиР), где институт зависит от веры агентов в обязательность правил, что означает, что структура стимулов — не единственный источник принуждения, как в случае ПвР.

В теории Хиндрикса институт — это социальная норма, управляющая (govern) социальной практикой, которая увеличивает выигрыш от следования правилу. Практику Хиндрикс понимает как поведенческий паттерн в духе конвенции Льюиса [@hindriks2022, 357]:

> «Социальная практика $R$ в повторяющейся ситуации $S$ в популяции $P$ существует ровно тогда, когда достаточно членов $P$:
>
> 1. ожидают, что все будут следовать $R$,
> 2. предпочитают следовать $R$ (a) условно на 1 или (b) безусловно».

Она признаёт ограничения ПвР и расширяет её на проблемы кооперации, не ограничиваясь только координацией, и позволяет мотивировать поведение не только структурой стимулов (равновесием), но и содержанием правил/норм [@hindriks2019; @hindriks2022]. Хиндрикс определяет институт следующим образом [@hindriks2022, 360]:

> «Институт $\mathcal{R}$, согласно которому в ситуации $S$ обязательно выполнять $C$ (следовать правилу), существует в популяции $P$ ровно тогда, когда значительное число ее членов:
> 
> (1) ожидают, что некоторые другие верят в $\mathcal{R}$,
> (2) ожидают, что некоторые будут выполнять $C$, а другие — $D$,
> (3) (a) сами верят в $\mathcal{R}$ и/или (b) ожидают, что некоторые будут склонны санкционировать нарушения, по крайней мере отчасти из-за (1),
> (4) более благосклонно относятся к следованию $\mathcal{R}$ благодаря (2), (3a) и/или (3b),
> (5) выполнение либо $C$, либо $D$ образует равновесие в $S$».

Хиндрикс объединяет ПвР с теорией социальных норм как условных предпочтений Биккиери [@bicchieri2005], чтобы получить более богатую картину институтов. В ней социальная норма не обязательно должна управлять социальной практикой, чтобы существовать — достаточно, чтобы значимая доля популяции верила в существование этой нормы и ожидала, что ей стоит следовать. При этом одна и та же норма может управлять разными практиками.

Подобная картина позволяет Хиндриксу говорить о силе и хрупкости институтов как совпадении двух источников мотивации — норм и практик: в сильном институте они совпадают, и норма управляет практикой, а в слабом норма существует лишь де юре. Хиндрикс предлагает измерять силу обоих типов институтов — координационных и кооперационных. 

Для первых он предлагает отношение уровня конформности (эмпирические ожидания, что другие будут следовать практике) к его нижней границе. Проще говоря, это отношение ожидаемой конформной доли популяции к нижней границе этой доли, при которой будет рационально переключиться на другое равновесие: $\frac{d_c}{d_{ct}}$.

Для кооперационных институтов Хиндрикс предлагает более сложную схему измерения. Сила института здесь — в «добавочной мотивации», а слабость — в «добавочном дефиците». Например, $c$ — выигрыш от кооперации, $d$ — выигрыш от отклонения, при этом $d > c$. Хиндрикс далее предлагает понятие «веса» социальной нормы и использует для этого дельта-параметры из работ Кроуфорд и Остром [@crawford1995]: $\delta_n$ — для прямой мотивации социальной нормой и $\delta_s$ — для косвенной мотивации санкцией. «Весом» нормы Хиндрикс называет сумму $w_a = \delta_n + \delta_s$. Первая часть нужна для выражения выгоды от следования правилу $c + \delta_n$, а вторая — для выражения потери от нарушения правила $d - \delta_s$. 

Чтобы быть эффективным, институт, по мнению Хиндрикса, требует полного следования нормам, и чтобы агенты были безраличны к выбору стратегии, выгода от следования правила должна быть идентичной потере от отклонения от правила $c + \delta_n = d - \delta_s$. Однако чтобы институт бы минимально стабильным, выгода от следования норме должна быть минимально выше потери от отклонения. Поэтому «вес следования норме» $w_с = d - c$ должен быть как минимум $w_c = d - c + \epsilon$. Тогда метрика силы кооперативного института будет $\frac{w_a}{w_c}$, то есть $\frac{\delta_n + \delta_s}{d - c + \epsilon}$. Это выражение означает, что позитивная и негативная мотивация должны быть вместе больше добавочного выигрыша за отклонение от правила для сильного института.

Несмотря на расширение и попытку обобщения ПвР, эта теория строится на постулировании нормы как дополнительного источника мотивации, что проблематично. Мы рассмотрим это подробнее в следующем параграфе.


### 1.3.2 Критика теорий Гуалы и Хиндрикса
...
Хиндрикс чётко разделяет нормы и конвенции: соблюдение норм дополнительно мотивировано, а конвенции подкрепляют сами себя. Биккиери сформулировала эту разницу в терминах личной выгоды и общего интереса [@bicchieri2005]. Они совпадают в конвенциях и не совпадают в нормах. Это означает, что конвенции могут существовать без норм. Но могут ли нормы существовать без конвенций? Экспериментальные данные Гуалы и Бреннана говорят, что нет — конвенции обретают нормативные черты в процессе повторяющейся игры [@guala2010; @brennan2013].
...
![Игра на доверие Вандершаафа: отсутствие гаранта делает предательство равновесием Нэша](assets/trust-game.png){width=70%}
...
![Расширенная игра на доверие: гарант применяет санкцию к инвестору в случае его обмана клиента](assets/trust-game-ext.png){width=70%}
...
Стоит также сказать про позднюю теорию Хиндрикса [@hindriks2019; @hindriks2022]. С нашей точки зрения, её основная проблема — использование социальной нормы как онтологического примитива: норма управляет практикой и существует отдельно от неё, что требует объяснения её каузальной силы. Другими словами, если в ПвР структура стимулов, образующая равновесие — это единственный источник мотивации с понятной каузацией (следование правилу рационально, и поэтому возникает равновесие и стабильность), то в ПиР для работы социальной нормы как отдельного источника мотивации должно быть объяснение, каким образом норма мотивирует поведение *отдельно* от практики (то есть некоторой конвенции). 

Вторая проблема — хотя Хиндрикс и расширяет теорию на проблемы кооперации, он не объясняет роль и статус равновесия. Если в ПвР это КР, то неясно, какой концепт решения подразумевает Хиндрикс. Поскольку он говорит о дельта-параметрах и санкциях, то это вряд ли может по-прежнему быть КР, поскольку дельта-параметры не нужны для КР в силу структуры игры и общего знания. Хиндриксу стоит уточнить концепт решения, чтобы сделать теорию сильнее.

Ещё одна проблема касается силы института, и она, на наш взгляд, вытекает из предыдущей: произвольный характер параметров для измерения силы института — «вес» нормы и бонус от следования норме. Мы считаем, что если бы у Хиндрикса был понятный концепт решения, параметры были бы более каноничными. В частности, не вполне ясно, почему следование кооперативной стратегии добавляет бонус $\delta_n$. Это выглядит как допущение, основанное на идее существования и каузальной силы социальной нормы, что само по себе является сильным допущением.

С нашей точки зрения, интуиции Хиндрикса по поводу кооперативных игр, дельта-параметров и силы института можно сохранить и усилить, отказавшись от нормы как онтологического примитива и отдельного источника мотивации. Мы вернёмся к этому в Главе 3.
...
### 1.3.3 Проблема соотношения правил и равновесий в ПвР
...
# Глава 2. Критический анализ унифицированной социальной онтологии Гуалы и Хиндрикса
<!--Анализ теории правил-в-равновесии Франческо Гуалы-->
...
: Случай территориального спора животных: когда оба игрока выбирают условную стратегию (играть Ястреба, если владеешь территорией, и Голубя, если вторгаешься на чужую), каждый получает максимально возможный равный выигрыш. Значения выплат — от Гуалы.
...
<!--\end{array}-->
<!--$$-->
<!--<figcaption class="caption">Случай территориального спора животных: когда оба игрока выбирают условную стратегию (играть Ястреба, если владеешь территорией, и Голубя, если вторгаешься на чужую), каждый получает максимально возможный равный выигрыш. Значения выплат — от Гуалы.</-->
...
: Территориальный спор людей с выпасом скота
...
<!--\end{array}-->
<!--$$-->
<!--<figcaption class="caption">Территориальный спор людей с выпасом скота.</-->
...
![Граница как физический маркер (слева) и как абстрактное правило (справа). Взято из @guala2016a](assets/guala.png){width=70%}
...
: Структура выплат в игре «Ястреб-Голубь-Буржуа»
...
![Подмена понятий в аргументации Гуалы: конвенция о границе не возникает как перенос заметной (salient) истории игры, поскольку если есть река, то нет стратегического выбора и самой игры: племена физически не могут пасти скот на другом берегу. Игра «Ястреб-Голубь» возникает с высыханием реки.](assets/guala-podmena.png){width=70%}
...
: Более реалистичный территориальный спор пастухов (ЯГБ)
...
<!--\end{array}-->
<!--$$-->
<!--<figcaption class="caption">Более реалистичный территориальный спор пастухов (ЯГБ)</-->
...
Можно утверждать, что Гуала и Хиндрикс неявно опираются на модель Вандершраафа, где конвенция — это не просто КР, а *строгое коррелированное равновесие с общим знанием* — одинаковым для всех агентов разбиением множества состояний $\mathcal{H}$. Игроки обладают общим знанием о структуре корреляции и о том, какие сигналы получают другие. Это похоже на факт природы — как в примере с бабочками. Там возможные состояния мира — или типы игроков — взаимоисключающие: если один владелец, то другой — захватчик. 
...
|   | Пасти     | Не пасти     | Пасти, если первый |
|---|-------|-------|-------|
| Пасти | 0,0     | 2,1     | 1,0.5   |
| Не пасти | 1,2     | 1,1     | 1,1.5   |
| Пасти, если первый | 0.5,1  | 1.5,1   | 1.5,1.5   |

: Территориальный спор пастухов (ЯГБ)
...
<!--\end{array}-->
<!--$$-->
<!--<figcaption class="caption">Территориальный спор пастухов (ЯГБ)</-->
...
Информационные разбиения будут одинаковыми: 

$$
\mathcal{H}_N = \mathcal{H}_D = \{\{\omega_N\}, \{\omega_D\}\}.
$$
...
Формально, при состояниях мира $\Omega = \{\omega_{N}, \omega_{D}\}$ разбиения также одинаковы: 

$$
\begin{gathered}
\mathcal{H}_N = \mathcal{H}_D = \{\{\omega_N, \omega_D\}\}, \quad
\mathcal{H} = \mathcal{H}_N \cap \mathcal{H}_D = \{\omega_N, \omega_D\}.
\end{gathered}
$$

Один и тот же сигнал соответствует двум состояниям, игрок не знает наверняка, в какой ветке игры находится. Это иллюстрирует идею, что *социальные факты не являются прозрачными и одинаково интерпретируемыми для всех по умолчанию подобно фактам природы*. Даже физическая асимметрия вроде очерёдности прибытия на оспариваемую территорию может интерпретироваться по-разному и тем самым препятствовать созданию разделяемого правила $f: \Omega → S$, которое создаёт единое понимание контекста реализации условной стратегии. А для Гуалы и Хиндрикса игроки фактически напрямую наблюдают типы других игроков.
...
$$
EU(L) = \frac12 \cdot \frac{V}{2} + \frac12 \cdot V = \frac{3V}{4}
$$
...
2. Показали нелегитимное сравнение игр, которое делает Гуала, чтобы аргументировать недостаточность равновесий для объяснения социального института. Игры имеют разные эпистемические и онтологические допущения: 
    - стратегии как фенотипы и как действия
    - Буржуа-стратегия — КР в примере с животными, а с людьми — нет
...
## 3.1 Институт как Байес-коррелированное равновесие

Как мы выяснили в прошлой главе, КР недостаточно для описания института, поскольку оно предполагает полную информацию и общее знание правила, что подходит только для игр на координацию, но не вполне подходит для игр со смешанными мотивами. Для этого мы предложим рассматривать институты в рамке Байес-коррелированного равновесия (БКР), поскольку она учитывает неопределённость и имеет больше параметров. Поэтому для начала мы рассмотрим БКР, его условия и формализм, а позже определим место $\delta$-параметра в этой рамке и придём к новому определению социального института.

<!--[? что такое БКР и как оно устроено]-->
Чтобы определить БКР, Бергеман и Моррис [@bergemann2016] задают игру с неполной информацией $(G,S)$.  Базовая игра $G$ включает конечное множество игроков $i=1,\dots,I$, множества действий $A_i$, множество состояний $\Theta$ и общую априорную веру $\psi \in \Delta(\Theta)$.  Полезности игроков описываются функциями $u_i : A \times \Theta \to \mathbb{R}$, где $A = \prod_i A_i$.  Информационная структура $S = ((T_i)_i,\pi)$ задаёт множества типов $T_i$ и распределение типов $\pi : \Theta \to \Delta(T)$, $T = \prod_i T_i$.

Правило принятия решения — это отображение
$$
\sigma : T \times \Theta \to \Delta(A),
$$
которое каждой конфигурации типов $t\in T$ и состоянию $\theta\in\Theta$ сопоставляет распределение над профилями действий. $\sigma$ — это коррелирующее устройство, выдающее игрокам приватные рекомендации выбора стратегии. Это правило выбирает *дизайнер информации*, как называют это Бергеман и Моррис.

Далее Бергеман и Моррис определяют «повиновение» (obedience) — условие для правила принятия решения $\sigma$. Они называют правило $\sigma$ «повинующимся» для $(G,S)$, если для каждого игрока $i$, каждого типа $t_i \in T_i$ и каждого рекомендованного ему действия $a_i \in A_i$ выполняется неравенство
$$
\sum_{a_{-i},t_{-i},\theta}
u_i((a_i,a_{-i}),\theta)\,
\sigma((a_i,a_{-i})\mid (t_i,t_{-i}),\theta)\,
\pi((t_i,t_{-i})\mid \theta)\,
\psi(\theta)
\;\ge\;
\sum_{a_{-i},t_{-i},\theta}
u_i((a_i',a_{-i}),\theta)\,
...
для всех альтернативных действий $a_i' \in A_i$.

Интуитивно мысль заключается в том, что 

1. Дизайнер информации выбирает правило $\sigma$;
2. Реализуется состояние мира $\theta$;
3. Приватно реализуется тип каждого игрока $t_i$. Типом Бергеман и Моррис называют любую приватную информацию агента;
4. Игроки получают приватные сообщения от устройства корреляции согласно правилу $\sigma$;
5. Игроки выбирают действия согласно их априорной информации и полученным сообщениям и формируют апостериорные убеждение ни их основе;
6. Игроки получают выигрыши [@bergemann2016, 49].

Подобная картина позволяет отразить идею о том, что агенты не автоматически следуют сигналам коррелирующего устройства, как в КР, а принимают решение о следовании правилу или отклонении лишь *после* получения сигнала, поскольку выбор действия зависит от состояния мира и апостериорных верований агента о нём.

Ключевая идея БКР — информационная структура, и, как пишут Бергеман и Моррис, *чем больше информации получают игроки, тем меньше множество возможных равновесных исходов*. А поскольку в интересах информационного дизайнера увеличить число равновесных исходов, он будет строить такие информационные стркутуры, которые обеспечивают рациональность следования условию «повиновения» минимально возможными средствами.

<!--[? пример про инвестора БКР]-->
Бергеман и Моррис приводят пример игры 2х2, где есть два инвестора и два возможных состояния экономики — «хорошее» и «плохое», где первое отражает перспективный проект, а второй — заведомо проигрышный. Каждый инвестор должен решить, вкладываться в проект или нет. Если он не вкладывается, то не получает прибыли, но и ничего не теряет. А если он вкладывается, то в плохом состоянии он теряет вложенное, а в хорошем — зарабатывает прибыль.

Дополнительно авторы уточняют, что есть выгода от координации — если оба инвестора вкладываются, то получают небольшой дополнительный выигрыш за счёт «стратегических комплементарностей» — например, репутации. Тогда для каждого инвестора важны не только его ожидания относительно «качества» проекта, но и ожидания относительно того, что сделает другой.

У каждого инвестора есть *собственный приватный сигнал* $t_i$ о состоянии экономики. Например, каждый получает сигнал «хорошие новости» или «плохие новости» про проект. Если проект действительно потенциально прибыльный, то «хорошие новости» приходят чаще, чем «плохие». А если проект «плохой», то, наоборот, «плохие новости» более вероятны.

То есть сигналы не идеальны, но по ним можно приблизительно «угадывать» состояние. Как только инвестор видит свой сигнал, он вычисляет апостериорную вероятность того, что экономика действительно в хорошем или плохом состоянии. Именно эти *апостериорные верования* и определяют, насколько оправдан риск инвестировать.

Инвестор с сигналом «хорошие новости» верит, что вероятность хорошего состояния велика, и поэтому склонен инвестировать, а инвестор с сигналом «плохие новости» — соответственно, нет.

Информационный дизайнер может наблюдать реальное состояние проектов и, возможно, приватные сигналы инвесторов, а затем посылает каждому инвестору рекомендацию: «инвестируй» или «не инвестируй». Его целью может быть, например, максимизировать вероятность того, что оба инвестора вкладываются, но при этом он должен учитывать, что инвесторы рациональны и будут следовать рекомендациям они согласуются с их апостериорными верованиями.

Это и есть содержательный смысл условия «повиновения» — если инвестор с определённым сигналом получает рекомендацию «инвестируй», то при своих апостериорных верованиях он должен считать инвестицию для себя не хуже отклонения от рекомендации. То же самое и в противном случае — рекомендация не должна идти вразрез с обновлёнными верованиями.

Иначе говоря, для каждого типа инвестора рекомендация дизайнера должна быть *самоподдерживающейся*: после обновления верований у агента не возникает мотивации её нарушить.

<!--[? почему БКР недостаточн для описания института]-->
Несмотря на свою абстрактность и унифицирующий пафос, БКР не способно «схватить» сущность социального института само по себе, поскольку даёт лишь очень общее и «тонкое» описание равновесия, зависимого от информационной структуры.

Во‑первых, хотя БКР и говорит о «повиновении», это не принуждение в более строгом смысле. Любой устойчивый паттерн поведения, поддерживаемый ожиданиями и информацией, может быть БКР: координационная конвенция, случайное фокальное равновесие или результат информационного манипулирования. Ничто в самой концепции БКР не различает рациональный наилучший ответ и распознавание правила и отклонения от него.

Во‑вторых, БКР не различает институциональные и другие последствия. В функции выигрыша любой элемент смешан с технологическими и другими эффектами: сломалась машина, упала цена или игрок начал испытывать стыд. Всё это — числа в матрице, обеспечивающие устойчивость. Для онтологии института, напротив, важно изолировать принудительную силу как отдельный компонент или их набор.

В‑третьих, без дополнительной параметризации БКР не позволяет говорить о «силе» института. Равновесие либо есть, либо нет. Однако в философской и эмпирической литературе именно градуальность — сильные и слабые институты, жёсткие и мягкие нормы и санкции — выходит на первый план [@ostrom1990; @bicchieri2005; @hindriks2022].

<!--[? где дельта в БКР?]-->
Чтобы расширить и обобщить теории ПвР и ПиР и связать их с БКР, достаточно добавить в структуру выигрышей санкцию $\delta$ за нарушение правила, необходимость которой мы показали в прошлой главе. Тогда стандартное условие «повиновения» можно переписать в более онтологически содержательной форме.

Ход Природы определяет, в каком «институциональном мире» оказываются участники: в мире с реально действующим механизмом принуждения или в мире без него. Пусть пространство состояний природы $\Theta = \{0,1\}$, а $\theta \in \Theta$ — состояние механизма. Состояние $\theta = 1$ означает, что механизм принуждения активен: существует работающий мониторинг и правоприменение, которые превращают нарушение правила в материальные потери $\delta>0$ для нарушителя. Состояние $\theta = 0$ означает, что механизм фактически не действует, и нарушение не ведёт к санкции. Вероятность, с которой Природа «выберет» мир с работающей санкцией задаётся как $\psi(\theta = 1)$.

Тогда определим «санкционную» функцию полезности игрока $i$:
...
Здесь $u_i(a',\theta)$ — базовая функция выигрышей, заданная структурой игры. Тогда стандартное условие повиновения (obedience) для правила $\sigma$ в терминах БКР переписывается без изменения формы, но с новой функцией выигрышей.

Онтологически это означает, что мы не меняем саму структуру БКР: санкция $\delta$ просто становится частью платёжной функции, но теперь этот выигрыш явно зависит от того, в каком «институциональном мире» находятся игроки и нарушают ли они правило.

Если зафиксировать все параметры, кроме $\psi(\theta = 1)$ и $\delta$, чтобы они не менялись, то можно переписать условие *институционального* повиновения как 

$$
\psi(\theta = 1)\,\delta \;\ge\; \Delta u_i,
$$

где $\Delta u_i = \mathbb{E}[\tilde u_i(a_i')] - \mathbb{E}[\tilde u_i(a_i)]$ — структурная премия за девиацию без учёта санкций. Это удобная репараметризация того фрагмента ожидаемой полезности, который связан с санкцией и институциональным принуждением. Она позволяет обсуждать отдельно два онтологически важных аспекта санкционного механизма:

- ресурсную и организационную сторону $\psi(\theta = 1)$: объективная частота работы судов, плотность патрулей, надёжность фиксации нарушений и другое;
- тяжесть последствий для нарушителя $\delta$: размер штрафа, срок наказания, масштаб репутационных потерь.

БКР как концепт решения хорош именно своей богатой параметризацией по сравнению с КР. В частности, он позволяет отделять *априорные и апостериорные вероятности* и трактовать их как объективную частоту и субъективную оценку срабатывания санкционного механизма при фиксации остальных параметров. В конечном счёте, решающее значение в реализации БКР имеет именно апостериорная оценка игроков — насколько они верят в работу санкционной инфраструктуры.

Если частоту реализации мира с санкциями и ход Природы мы уже затрагивали выше, то апостериорные оценки агентов по поводу наблюдаемых сигналов о работе санкционного механизма — нет. Субъективная вероятность санкции при девиации $Pr(\theta = 1 | t_1)$ — апостериорная оценка игрока. Она зависит от вероятности попасть в мир с санкциями $\psi$, информационной структуры $\pi$ и правила принятия решения $\sigma$.

Онтологически это означает, что институт — не только материальный механизм фиксации нарушений и реализации санкций с параметрами $(\psi(\theta = 1),\delta)$, но и объект верований: агенты могут ошибаться относительно действительной частоты применения санкции, что выражается в апостериорной оценке $Pr(\theta | t_i)$. Один и тот же институт (то есть поведенческий паттерн) может быть устойчив или хрупок в зависимости от того, насколько поддерживающая его санкционная инфраструктура выглядит работающей в глазах агентов. Тогда свёрнутое условие повиновения для достижения БКР принимает форму

$$
Pr(\theta = 1 | t_i)\delta \ge \Delta.
$$

Добавление байесовского обновления позволяет показать, как эпистемическая неопределённость относительно работы санкционирующего механизма (а не содержания правила) влияет на его фактическую устойчивость. Это позже позволит нам говорит об уточнении фаллибилизма Гуалы.

Таким образом, предварительно можно сказать, что институт — это правило, реализованное как Байес‑коррелированное равновесие в игре, где функция выигрышей содержит выделенный санкционный компонент $\delta >0$, а условие повиновения имеет вид $Pr(\theta = 1 | t_i)\delta \geq \Delta$. Это позволяет, во‑первых, отличать такие институты от конвенций, — равновесий без санкций — а во‑вторых, параметризовать их устойчивость по осям воспринимаемой надёжности и жёсткости санкционного механизма.

Таким образом, в первом приближении, институт — это БКР с более жёстким, чем стандартное, условием повиновения, в которое включена санкция за отклонение от рекомендуемой стратегии. Онтологически институт это параметризованное правило в равновесии с механизмом фиксации нарушении и реализации санкций.

Информационная структура БКР задаёт, как разные типы агентов оценивают вероятность санкционного исхода (через апостериорные верования о состояниях мира), параметр $\delta$ выражает интенсивность самих санкций, а правило совместно с санкцией определяют, какие действия считаются желаемым поведением, а какие — нарушением.

По нашему мнению, институт в духе Гуалы и Хиндрикса возникает там, где эти три элемента сходятся: правило включено в игру, санкционная компонента $\delta$ делает соблюдение устойчивым, а информационная структура формирует такие верования, при которых условие повиновения выполняется. Без выделения санкции как отдельного параметра БКР остаётся формальным описанием устойчивой координации.

\newpage


<!--[? наш пример с ястреб-голубем и графиками]-->
## 3.2 Проблема силы института и возможное байесовское решение
Ранее мы сказали, что БКР с санкционным механизмом отражает в своём условии объективную и субъективную оценку применения санкций при нарушении правила. Формально обе их них содержатся в условии повиновения, однако мы можем развести их, чтобы делать онтологически значимые различения. Чтобы это показать, рассмотрим редуцированную 2×2‑версию игры Ястреб-Голубь.
...
<!--Сформулированное условие повиновения с санкцией позволяет очертить границу между работающими и неработающими социальными институтами. Параметр $\psi(\theta)$ отражает надёжность механизма принуждения — вероятность мира с работающей санкцией, а $\delta$ — тяжесть этой санкции. В совокупности значение $\psi(\theta)\delta$ внутри условия БКР задает «объективную цену блефа». С онтологической точки зрения $r$ статистически отражает ресурсоёмкость инфраструктуры фиксации нарушений и реализации санкций: эффективность работы бюрократии, число патрулей на дорогах, охват камер видеонаблюдения, прочность неформальных репутационных сетей — всё, что влияет на вероятность фактического применения санкции при выявленном нарушении.-->

<br/>

![Игра с выпасом скота (Ястребы-Голуби) с реализованным КР, обозначенным как серые клетки. Адаптировано из @Vanderschraaf_2017](assets/vandersch-ce.svg){width=70%}

<br/>

Предположим, что в этой игре пастухи обоих племён следуют правилу «пришёл первым — пасти скот, а если вторым — уступить», но игроки могут от него отклоняться. Назовём для простоты роли «первого» и «второго» «владелец» и «захватчик» соответственно. Они задаются устройством корреляции — очерёдностью прибытия.

Согласно правилу $\sigma$ и сигналу коррелирующего устройства, «захватчик» должен играть $D$, а отклонением является выбор $H$. Пусть с вероятностью $p$ — частью распределения действий, генерируемого коррелирующим устройством — «владелец» фактически агрессивен и играет $H$, а с вероятностью $1-p$ играет $D$. Тогда ожидаемый выигрыш «захватчика» при следовании правилу:
$$
...
Теперь предположим, что нарушение правила влечёт санкцию $\delta > 0$ с апостериорной вероятностью $Pr(\theta = 1 | t_i) \in [0,1]$, которую для краткости мы далее обозначим $r$. Тогда ожидаемый выигрыш «захватчика» при нарушении в мире $\theta = 1$, где санкционный механизм работает, становится:
$$
...
Онтологически $p$ — это часть устройства корреляции, распределяющего сигналы. Эта маргинальная вероятность описывает состояние фоновой координации: насколько часто игроки и без санкций готовы следовать правилу «ястреб, если владелец и голубь, если захватчик». Чем выше $p$, тем меньше премия за отклонение $\Delta u(p)$ и, соответственно, меньше минимальное требование к $r\delta$. Институт же фиксируется не самим $p$, а неравенством $r\delta \ge \Delta u(p)$ при остальных фиксированных параметрах: санкционный механизм должен перекрывать *структурный* стимул к девиации, задаваемый игрой и коррелирующим устройством.

<br/>

![Отношение премии и вероятности следования сигналу в «Ястребы-Голуби» для стандартной матрицы описывается уравнением $\Delta u(p) = 1 - 2p$. Чем меньше вероятность, что оппонент последует сигналу, тем выше возможная премия.](assets/hd-line.png){width=70%}
...
![Параметры $r$ и $\delta$ компенсируют отклонение при разных вероятностях владельца играть $H$. Чем ниже вероятность, тем больше «красной» зоны, где равновесие рушится и институт перестаёт работать. Пунктирная линия означает порог $r\delta = \Delta$](assets/hd-parameters.png){width=100%}

<br/>

Хотя график не нужен для решения, он эвристически показывает, что одному и тому же институту соответствует не одна точка (не одно равновесие), а целая *область параметров* $(r,\delta)$: БКР в этом примере может быть устойчиво как при мягких, но почти неизбежных санкциях, так и при редких, но более жёстких. Однако это обобщается и на другие примеры и игры. Онтологически это отражает его *множественную реализуемость*: институт — это не одно правило‑в‑равновесии, поддерживаемое санкцией, а правило, которое может быть равновесным во множестве конфигураций санкционной инфраструктуры.

Зелёным показана область параметров $(r, \delta)$, где правило реализует БКР. Красным показана область, где БКР не реализуется и институт фактически коллапсирует. Это ситуация «института на бумаге», для которого задекларированы правило и санкция, но они не имеют принудительной силы. Линия $r\delta = 1 - 2p$ показывает границу — в точках этой линии санкция за отклонение от условной стратегии есть, но её едва хватает для удержания нейтральной устойчивости. В этом смысле институт не имеет «запаса прочности» и может коллапсировать в любой момент.

В онтологическом плане $r\delta$ здесь — воспринимаемое агентами состояние институционального механизма (права, санкций общины, репутационных потерь и другого), которое компенсирует «сырую» премию $\Delta u(p)$ и делает отклонение от правила невыгодным.

<!--При $r\delta < \Delta u(p)$ правило остаётся лишь «бумажной нормой», тогда как при $r\delta \ge \Delta u(p)$ оно реализуется как КР.-->

Важно подчеркнуть, что пороговое значение будет разным для разных игр, поскольку зависит от конкретных значений выигрышей и от информационной структуры игры в целом. В этом кроется достоинство БКР как инструмента для описания института — в абстрактной структуре, позволяющей разные комбинации ограничений на условие повиновения, однако мы уточняем, что для использования БКР в описании онтологии института к нему нужно добавить параметр величины санкции. Пример выше служит для иллюстрации общего принципа: в любой игре чтобы институт как БКР с санкцией реализовывался, ожидаемый штраф $r\delta$ при фиксации остальных параметров должен перекрывать премию от отклонения от рекомендованной стратегии.

<!--В модели выше мы трактовали $r$ как объективную вероятность того, что нарушение правила повлечёт санкцию: $P(\theta = 1) = r$, $P(\theta = 0) = 1 - r$. Это «игрушечный» пример, призванный показать, каким образом размер и вероятность санкции параметризуют правило $\sigma$ и как они влияют на реализацию БКР. Однако в БКР важна субъективная апостериорная оценка агента.-->

Ранее мы говорили, что хотя априорная и апостериорная вероятности уже содержатся в условии БКР, их можно аналитически разделить, чтобы сделать онтологические различения и сравнить объективную и субъективно воспринимаемую санкционную инфраструктуру.

<!--Когда сигналы и наблюдения информативны относительно состояния санкционного механизма, агенты используют не фиксированное априорное $r$, а апостериорную оценку $Pr(\theta = 1 | t_i)$, зависящую от полученного ими типа/сигнала $t_i$. -->

Это позволяет различить ситуацию, где фактически обеспеченный санкционный механизм слабее, чем вера агентов в него. Чтобы не вдаваться в тяжеловесные байесовские вычисления и продемонстрировать нашу идею о расхождении реальной и воспринимаемой надёжности санкций, положим, что в нашем примере с пастухами субъективная оценка вероятности санкции систематически выше реальной частоты (например, $r = 1.5\psi$). В таком случае институт как БКР будет устойчив даже при деградировавшей или нестабильной санкционной инфраструктуре.

![$\psi(\theta)$ и субъективная оценка агента $r = Pr(\theta = 1 | t_i)$ вместе показывают область хрупкого института](assets/protoinstitute.png){width=70%}

Это означает, что агенты *переоценивают* вероятность санкций за отклонение от правила. Голубая пунктирная линия на графике выше показывает субъективно воспринимаемый порог стабильности института. В зоне под ней институт в глазах агентов коллапсирует, а над ней — работает, даже несмотря на то, что объективной инфраструктуры для этого уже недостаточно. Жёлтая область между линиями — институт как *ожидаемый порядок*, а не как *самоподдерживающееся равновесие*: равновесие здесь есть, но оно хрупкое и зависит исключительно от верований агентов. В этой ситуации возможны два варианта развития события: верования могут измениться и «догнать» реальную частоту санкций или же санкционная инфраструктура может «сползти» ниже, снова встретившись с субъективной оценкой. Стоит заметить, что обе операции предполагают изменение геометрии равновесия и требуют изменения его *структурных* параметров — в данном случае распределения вероятностей коррелирующего устройства (однако это могут быть и другие параметры).

Чтобы институт функционировал как самоподдерживающееся равновесие, реальные и субъективные уровни вероятности санкций должны лежать в одной и той же «зелёной» области: ожидания игроков не должны систематически расходиться с фактической частотой применения санкций $r\delta \approx \psi\delta$.

В пределе полной информации и устойчивых ожиданий «сильный институт», находящийся в «зелёной зоне» в нашей модели совпадает с конвенцией Вандершраафа (или институтом Гуалы), реализованной как коррелированное равновесие.

Жёлтую область параметров на графике можно назвать *хрупким* институтом — когда объективной надёжности санкционного механизма не хватает, но агенты её переоценивают и следуют правилу, как если бы санкции были гарантированы. Формально, хрупкий институт — это область:
$$
\mathcal{P} = \{ (r,\delta) | r\delta > \psi\delta \}.
$$

<!--Пример такой ситуации — знаменитое «самоисполняющееся пророчество» [@merton1948; @mackenzie2006], где верования агентов «вызывают к жизни» социальные факты. Например, распространется новость о банкротстве банка, агенты начинают изымать средства со своих вкладов и счетов, тем самым фактически делая банк банкротом. Сходство с хрупким институтом здесь в том, что отклонение от правила «держать деньги на вкладе, чтобы они не обесценились» потенциально выгоднее, чем следование ему-->

Пример подобной ситуации — судебная система в авторитарном государстве: вероятность наказания за коррупционные практики мала, поскольку суды перегружены, а бизнес и граждане продолжают переоценивать риск наказания, потому что помнят несколько показательных наказаний и медийный нарратив. Другой пример: чтобы сэкономить деньги, на дорогах установили муляжи камер наблюдения — водители верят, что они настоящие (или не знают наверняка), поэтому «на всякий случай» снижают скорость. Это фактически поднимает $r$, а значит увеличивает шансы на равновесный исход. Если водитель точно будет знать, что камера перед ним — муляж, то он, скорее всего, отклонится от правила и превысит скорость. Применительно к нашей игре с выпасом скота это могло бы означать то же самое — пастухи верят в возможную санкцию и поэтому следуют правилу.

Возможна и обратная ситуация — когда агенты *недооценивают* вероятность санкций и институт из-за этого переходит в «спящий» режим и де факто не поддерживает равновесие. Это значит, что санкционный механизм есть и функционирует, но его недостаточно для поддержания равновесия из-за скепсиса агентов или других обстоятельств, мешающих соответствующему обновлению их верований и поднятию $r$. Правило остаётся задекларированным, санкция (или поощрение) $\delta$ существует, но рациональный игрок, оценивая вероятность санкции как низкую, возвращается к отклонению.

Например, налоговые вычеты и пособия от государства вроде возврата НДФЛ за учёбу: инфраструктура есть и работает, но встречается либо с незнанием о её работе, либо с неверием в её функционирование. Такое понимание проблемы подсказывает способы её решения — поднять $r$ и упростить вход и пользование инфраструктурой.
...
![Объективная и субъективная оценки работы санкционного механизма вместе показывают область «спящего» института с недостаточно активированным санкционным механизмом](assets/sleeping-institute.png){width=70%}

По аналогии с хрупким протоинститутом, «спящий» институт — это область:
$$
\mathcal{S} = \{ (r,\delta) | r\delta < \psi\delta \}.
$$

Что интересно, наша модель описывает не только принуждение, но и мотивацию, просто $r\delta$ будут не вычитаться, а добавляться к выигрышу. Например, $\delta'$ — сумма налогового вычета, который можно получить (52 тыс. рублей), $\psi$ — объективная частота одобрения заявок, $r$ — субъективная оценка работы этой инфраструктуры, $\Delta$ здесь становится не премией, а издержкой участия (например, затраченным временем на оформление и ожидание). Условие устойчивости при этом сохраняется и обобщается: 

$$r \cdot |\delta| > \Delta.$$

Наша модель силы института концептуально близка к предложенной Хиндриксом [@hindriks2022] и развивает её в двух направлениях: переопределяет его идею «избытка мотивации» в байесовских терминах априорной и апостериорной вероятностей санкций и различает режимы, в которых одно и то же правило может функционировать как сильный, хрупкий или «спящий» институт.

Во‑первых, в случае кооперативных игр Хиндрикс измеряет силу института как отношение «веса» нормы к структурной премии за девиацию: $w_a = \delta_n + \delta_s$ и $w_c = d - c + \varepsilon$, так что $\frac{w_a}{w_c}$ показывает, насколько совокупная мотивация (прямая нормативная $\delta_n$ и санкционная $\delta_s$) перекрывает выигрыш от нарушения правила $d - c$, который у нас обозначен как $\Delta$.

Вместо абстрактного «веса» нормы мы используем ожидаемый санкционный вклад $r\delta$ и структурную премию за девиацию $\Delta$. Сила института измеряется величиной избытка мотивации $r\delta - \Delta$ — тем «избытком мотивации», который Хиндрикс хочет схватить через $\frac{w_a}{w_c}$.

Во‑вторых, наша модель обобщает подход Хиндрикса за счёт явного различения априорной и апостериорной вероятностей санкций. В его формуле $\frac{w_a}{w_c}$ мотивация и структура выигрышей заданы единожды, и хрупкость института — это малый избыток $\delta_n + \delta_s$ над $d - c$. В байесовской рамке мы рассматриваем пары $(\psi,r)$ и выделяем несколько режимов:

- *самоподдерживающийся (сильный) институт*: $r \approx \psi$ и $r\delta \ge \Delta$ — апостериорные верования не расходятся систематически с объективной частотой наказаний, и норма поддерживается как Байес‑коррелированное равновесие с санкционным механизмом. Это совпадает по духу с идеями Хиндрикса: избыток мотивации порождён и структурой информации, и содержанием нормы, и устойчив к обновлению верований.
- *хрупкий институт*: область, где $\psi\delta < r\delta$ — избыток мотивации существует только за счёт завышенных верований $r > \psi$: агенты переоценивают риск санкций, и норма «держится» на информационном дизайне (или на когнитивных искажениях), а не на реальной частоте наказаний. Система Хиндрикса не позволяет различить такое состояние.
- *«спящий» институт*: область, где $r\delta < \psi\delta$ — объективная инфраструктура санкций достаточна, чтобы перекрыть премию за девиацию, но агенты её недооценивают, так что норма существует де юре, но не управляет практикой.
- неработающий институт: $r\delta < \Delta$ — «красная зона» на графике, где условия БКР не выполняются.

Важно отметить, что в одних и тех же играх возможны как конвенции, так и институты. В обоих случаях устойчивый социальный порядок можно описать посредством БКР. Различается не целевое состояние, а *механизм* корреляции: в случае конвенции корреляция обеспечивается общим знанием структуры игры и взаимных ожиданий (в смысле Вандершраафа), тогда как в случае института — внешним механизмом принуждения, задающим ожидаемый штраф $r\delta$ за отклонение. 
...
Институт — это параметризованное правило в равновесии, имеющее *санкционный механизм*, который надстраивается над заданным правилом «следуй сигналу» и базовой игрой и систематически изменяет выигрыши нарушителей на величину $\delta>0$ с вероятностью $r = Pr(\theta | t_i)$.

Онтологически институт — это не равновесие и не само правило, а правило, поддерживаемое в равновесии *социоматериальным механизмом принуждения* и верой агентов в его работу, выразимые как $r\delta$.
...
В реальных институтах сила санкции $\delta$ зависит от того, какие ресурсы общество или конкретные группы готовы вкладывать в наказание: от бюджета правоохранительных органов, длительности и суровости наказаний до технологий мониторинга и обычаев социальной стигматизации. Аналогично $\psi$ определяется плотностью мониторинга и эффективностью обработки зафиксированных нарушений. То, что можно увидеть в данных — лишь вершина айсберга, а реальное $\psi$ формируется через практики наблюдения, фильтрации и отбора [@riascosvillegas2023]. 

Для этого удобно говорить об информационном дизайнере, как это делают Бергеман и Моррис [@bergemann2016], или об «инвесторах» — группе, заинтересованной в стабильности института. Бергеман и Моррис различают буквального и метафорического информационного дизайнера, где первый — это государство или группа заинтересованных, а второй — фигура, используемая исследователем при моделировании ситуации. В примере с видеокамерами-муляжами «инвесторы» потратили меньше ресурсов, чем могли бы, поскольку такого способа достаточно для обеспечения следования правилу.

Это позволяет говорить о $\psi$ и воспринимаемом агентами $r$ с точки зрения «инвесторов» в институт и его пользователей. Агенты могут воспринимать институт как «сильный», хотя с точки зрения инвестиций в него он не обеспечивает нужное значение $r\delta$. Это позволяет нам говорить о фаллибилизме — что агенты могут ошибаться по поводу *силы института*, но не по поводу его содержания, как это есть у Гуалы и Хиндрикса.
...
1. Обнаруживает, что БКР с санкцией $r\delta \ge \Delta$ ему выгоднее, чем его отсутствие;
...
Это объясняет, почему институты могут функционировать при заниженных реальных параметрах: агенты оценивают $r$ по наблюдаемым сигналам, а не по объективным данным $r$ и Инвестор эксплуатирует эту асимметрию.

\*\*\*  

В этой главе мы формально описали институт и критерии его силы, взяв за основу логику БКР. Ключевыми переменными институциональной устойчивости выступают тяжесть применяемой санкции $\delta$ и апостериорная вероятность её наступления $r$. Формализованный «порог институциональности» выражается соотношением $r\delta \ge \Delta$, которое представляет собой свёрнутое условие БКР с санкцией и позволяет разграничивать функционирующие институциональные механизмы от конвенций, хрупких, спящих и нефункционирующих институтов. Идея «Инвестора» позволяет показать эндогенную природу инфраструктуры принуждения — что параметры $(r,\delta)$ могут возникнуть из оптимизации макро-агента, заинтересованного в стабильности и что коллапс института может происходить из-за потери макро-агента интереса в инвестировании в этот институт.
...
Надёжность санкции $\psi$ отражает, с какой частотой отклонение от правила влечёт санкцию. Это плотность наблюдения, технические средства фиксации, организация контроля, работа бюрократии и судов, а также социальная память и репутационные механизмы. Одна и та же формальная норма может означать высокий $\psi$ в обществе с развитой инфраструктурой мониторинга и низкий $\psi$ там, где фиксация нарушений случайна и выборочна.

Важно, что сам параметр $\psi$ — статистический, он отражает статичное состояние системы санкционирования. Однако его онтологический смысл — в механизме (или способе), которым обеспечивается тот или иной уровень обнаружения и санкционирования нарушений. $\psi$ отражает инфраструктуру фиксации и обработки нарушений. Это кибернетический (или информационный) слой института: система «сенсоров», определяющих нарушение, и процедур обработки информации, активирующих «силовой» слой института.

С онтологической точки зрения, именно $\psi$, а не только $\delta$ отражает глубинную природу института. Ключевая задача инфраструктуры фиксации и обработки нарушений — *масштабирование санкции*. Это особенно хорошо видно, если представить институт как сеть эпизодов (или игр).

Санкция, действующая локально в одной стратегической ситуации, не гарантирована к исполнению в другой, и нужен способ её переноса. Для этого нужен информационный канал, переносящий информацию о факте применения санкции из одного эпизода в другие. $\psi$ отражает *эффективность работы этого информационного канала*. Если он высокий для большого числа эпизодов, то информация о фактах нарушения передаётся качественно, и санкция фактически становится предсказуемой для агентов. Например, публичная казнь — «недорогой» механизм поднятия $\psi$ для средневековых институтов права, который одновременно служил санкцией для нарушителя.

Группы и агенты могут бороться за контроль над $\delta$ (суровостью наказаний), над $\psi$ (плотностью и избирательностью мониторинга) и над определением того, какие действия вообще попадают под санкции. Наша параметризация делает видимыми эти линии борьбы: изменяя $\psi\delta$, агенты изменяют то, какие условные стратегии оказываются устойчивыми, и тем самым — какие институты фактически существуют.
...
В нашей рамке конститутивные правила качественно отличаются от регулятивных, хоть и по-прежнему не дают новой онтологии, а лишь язык её описания. Отличие в том, что конститутивное правило — это то же правило, но фактически реализуемое как БКР  с санкционным механизмом. Иначе говоря, это функция $f: \Omega → S$, которая реализует БКР при $r\delta > \Delta$. Несмотря на то, что есть соблазн трактовать конститутивные правила как изменения, которые фактически изменяют информационную структуру игры посредством модификации платежа, стоит помнить, что конститутивное правило — это то, что создаёт статусную функцию для материального объекта или паттерна поведения: «что-то считается чем-то». Поэтому изменения в структуре игры — это не само конститутивное правило, а условия его возможности. У самого Сёрла можно заметить, что «X считается Y в контексте C» предполагает уже существующие условия для того, чтобы это было правдивым: соглашение по поводу того, что считать правило, что — его нарушение, и какие деонтические силы вменяет конститутивное правило агентам. Само правило в таком случае — лишь вершина айсберга. Наша формализация это схватывает и также показывает внутренние условия возможности — наличие санкции, наличие правила и информационной структуры, которые вместе обеспечивают рациональность следования правилу. Другими словами, мы можем утверждать, «X считается Y в контексте C», когда X *фактически функционирует* как равновесное состояние, возможное благодаря вероятной санкции, перекрывающей блеф.
...
![Теория $T_1$ объясняет все классы феноменов теории $T_2$, поэтому она более «сходима» (consilient) в «подчинительном» (subsumptive) смысле. Взято их @maki2009](assets/consilience-1.png){width=70%}
...
![Теория $T_1$ объясняет больше классов феноменов, поэтому она более «сходима» (consilient), чем $T_2$ в «кардиналном» смысле. Взято их @maki2009](assets/consilience-2.png){width=70%}
...
Кинкейд игнорирует идею структурного инварианта, онтологически объединяющего домен, Росс — нет. Однако Росс явно утверждает, что у социологии пока нет математизированного основания, необходимого для онтологических утверждений об инвариантах, как это делает Росс для экономики. И хотя Росс прав, он не упоминает математическую [@fararo1989] и аналитическую социологию [@hedstrom2005; @hedstrom2009], которые пытаются сделать то, о чём он пишет. Однако обе ветви скорее изучают отдельные механизмы и строят модели процессов и явлений, используя разные математические инструменты, а не стремятся обнаружить структурный инвариант.
...
<!--Без выполнения неравенства $r\delta \ge \Delta$ социологические понятия институционального порядка перестают описывать принудительную силу.-->
...
Одно из основных достижений настоящей работы — углубление, обобщение и объединение теорий правил в рановесии Франческо Гуалы и теории правил и равновесий Фрэнка Хиндрикса с помощью понятия Байес-коррелированного равновесия. 

Мы выявили лакуны в теории Гуалы — допущение о полноте информации и отсутствии неопределённости и логический круг в определении института, предполагающий существование готовой конвенции для существования института — и показали, что его институт как коррелированное равновесие — это частный случай более общей ситуации, где структура игры предполагает полную информацию. Теория Гуалы не учитывает санкции и принуждение в ней исходит исключительно из инструментальной рациональности наилучшего ответа. Мы показываем, что институт как равновесие, обеспечиваемое общим знанием правила — ситуация *идеально* работающего института, где принуждение не требуется. Важная проблема, следующая из этого и отмеченная Вандершраафом в его критике теории Гуалы — отсутствие механизма возрата системы в равновесие [@Vanderschraaf_2017]. 

В нашей расширенной унифицированной социальной онтологии институт — это БКР с санкционным механизмом или параметризованное правило в равновесии. Основная идея заключается в том, что институт как БКР имеет множество параметров — правило, рекомендуемые действия, типы агентов (их приватная информация), состояния мира и верования агентов, и мы добавляем к нему санкцию $\delta$ и трактуем состояния мира как либо то, где санкционный механизм работает, либо то, где нет. Мы выделяем именно санкцию и её вероятности — априорную и апостериорную — как ключевые в определении института, поскольку именно они отличают его от других устойчивых паттернов вроде конвенции. Если институт как КР Гуалы просто советует стратегии, от которых невынодго отклоняться, то БКР с санкцией позволяет описать институт как устойчивый паттерн, реализуемый после получения рекомендаций коррелирующего устройства. Подобное обобщение позволяет более гибкие описания и объяснения принудительной силы института, чем у Гуалы, поскольку учитывает больше параметров.

Наша рамка также позволяет объединить теории Гуалы и Хиндрикса, в последней из которых социальная норма служит отдельным источником мотивации помимо структуры стимулов самой социальной практики. Мы считаем, что норма вписывается в формальное условие БКР как правило $\sigma$ вместе с санкцией размера $\delta$, что позволяет не выносить её как отдельный онтологический примитив, тем самым убирая необходимость объяснять каузальную силу нормы в отрыве от структуры стимулов практики. К тому же, поскольку Хиндрикс стремится объединить теорию правил в равновесии с теорией нормы как  *условного предпочтения*, наше обобщение института как БКР с санкцией это также схватывает, ввиду условной вероятностной природы выбора стратегии агентом: агент выбирает действие условно на сигналы коррелирующего устройства (как в КР Гуалы и Хиндрикса), а также на свою оценку реального состояния мира. Это похоже на идею Биккиери об активации социальных норм как «контекстуальных скриптов» [@bicchieri2005]. Иными словами, обе теории описывают правило в равновесии, но Хиндрикс делает больше акцента на нормативности, и БКР с санкцией позволяет это описать, не разделяя теорию Гуалы и теорию Хиндрикса.

Также наша рамка развивает идеи Хиндрикса о силе институтов. Она переопределяет метрики не через вес, который агенты атрибутируют норме, а через разницу априорных и апостериорных оценок санкции. Такое динамическое определение позволяет различать сильные, хрупкие и спящие институты, где в первых априорные и апостериорные оценки сопоставимы, во вторых — апостериорные превышают априорные (агенты переоценивают вероятность санкций), а в третьих — априорные превышают апостериорные (агенты недооценивают вероятность санкций).
...
<!--- позволяет различать объективную ($r$) и воспринимаемую ($r$) вероятности применения санкций, а значит различать два критерия оценки стабильности института — объективный и субъективный;-->
...
Равновесия позволяют натурализовать онтологию без дополнительных метафизических сущностей вроде коллективной интенциональности. При этом они естественным образом совмещаются не только с правилами и санкциями (поскольку последние выразимы на теоретико-игровом языке), но даже со статусными функциями Сёрла, что до этого считалось, мягко говоря, маловероятным [@searle2015].
...
Формулировка нашей теории делает вклад в натуралистическую унифицированную социальную онтологию, уточняя и углубляя теорию Гуалы и Хиндрикса. В ней институт — это не одно правило-в-равновесии, а правило-в-равновесии, поддерживаемое множественно реализуемой санкционной инфраструктурой и верой агентов в её функционирование. Институт стабилен во множестве параметров $(r, \delta)$. Параметрическое описание института обеспечивает объяснительную унификацию, превосходящую унифицированную социальную онтологию Гуалы. В то время как теория правил-в-равновесии Гуалы и Хиндрикса объясняет устойчивость, наша теория объясняет также и принудительную силу.

Мы прояснили отношение правил и равновесий, оказавшееся проблематичным для теории Гуалы. В его теории и теории Аоки [@aoki2011] важна идея символической репрезентации — что агенты репрезентируют существующие равновесия с помощью правил, которые выступают их сжатыми описаниями для когнитивной экономии. Это создавало проблему ex ante / ex post правил — что логически первично из правил и равновесий. С одной стороны правила были нужны для достижения равновесий, а с другой — равновесия нужны для их репрезентации как правил и рецептов действия для агентов. С точки зрения БКР правила предшествуют равновесию и служат условием его возможности, поскольку изначально информационный дизайнер выбирает правило принятия решения [@bergemann2016]. Наша рамка не схватывает правило как репрезентацию равновесия, поскольку правило его не репрезентирует: во-первых, поскольку само является частью условия равновесия, а во-вторых поскольку подобная репрезентация как источник каузальной силы институа — это допущение, частично вызванное отсутствием идеи санкций в теориях Гуалы и Аоки. Точнее, агенты оценивают (и, можно скзать, репрезентируют) *вероятность санкции* $r\delta$, а не само правило $\sigma$ и именно эта оценка каузально значима в достижении равновесия. Смежный вывод, значимый для сравнения с теорией Гуалы — что фаллибилизм по поводу института заключается не в возможности ошибки по поводу содержания правила, как считает Гуала, а в ошибке по поводу вероятности санкции. Таким образом, между правило и равновесием теперь нет логического напряжения, поскольку мы устранили проблему с каузальной силой репрезентации равновесия агентом.

С точки зрения унификации, мы предложили более жёсткое условие «повиновения» (obedience) с санкционным механизмом для БКР, которое позволяет описать принудительную силу института с помощью одной схемы на языке равновесий, при этой включив в себя и другие языки описания: правила, санкции и статусные функции. В терминах вывода к наилучшему объяснению (IBE):
...
- Неоторые классические социологические теории (Вебер, Дюркгейм, Бурдьё, Гидденс) могут описывать различные социоматериальные реализации этой схемы.

Институциональный критерий повиновения в нашем БКР с санкцией можно считать кандидатом на структурный инвариант социального порядка, поскольку он схватывает реальный паттерн в смысле Деннета. Критерий и его части ($r$ и $\delta$), интерпретированные онтологически, также позволяют обнаружить общее онтологическое ядро у некоторых социологических теорий: многие их них описывают социальный порядок в терминах принуждения и мониторинга. Это позволяет говорить о возможности реализации структурного реализма в социальных науках и социологии, в частности.
...
<!--      - $r\delta > \Delta$ — работающий институт-->
<!--      - $r\delta \gg \Delta$ — полицеский/репрессивный институт-->
<!--      - $r\delta < \Delta < r\delta$ — «спящий» институт (агенты недооценивают вероятность санкций)-->
<!--      - $r\delta < \Delta < r \delta$ — «хрупкий» институт (агенты переоценивают вероятность санкций)-->
<!--      - $r < \Delta$ — неработающий, «де юре» институт.-->
<!---->
...
<!--<br/>-->
<!---->
<!--|   | нет санкции (1−r) | есть санкция (r)      |-->
<!--|---|--------------------|---------------------|-->
<!--| F | x                  | x                   |-->
<!--| N | x+Δ                | x+Δ−δ               |-->
<!---->
...
<!---->
<!--Более реалистичная картина — допустить, что сигналы медиатора *информативны* для агентов относительно состояния мира $\theta$. Это значит, что агенты могут обновлять свои оценки вероятности работы санкционирующего механизма после получения сигнала (точнее, условно на сигнал). Тогда релевантный для игрока множитель ожидаемой санкции станет $r(s_i)\delta$, где $r(s_i)=\mathbb{P}(\theta=1\mid s_i)$. -->
<!---->


<!---->

<!--Такое параметрическое представление позволяет различать типы норм. Конвенция — это норма $\sigma$, для которой $\Delta_i(t_i,a_i,a_i') \le 0$ уже при исходных полезностях $u_i$, то есть структурная премия за отклонение не положительна и условие $(OB)$ выполняется без санкций. Институт — это норма, для которой для некоторых $(t_i,a_i,a_i')$ имеем $\Delta_i(t_i,a_i,a_i')>0$, но условие $(★)$ выполняется за счёт того, что воспринимаемая вероятность санкции $\hat r_i(t_i,a_i,a_i')$ и её размер $\delta_i$ компенсируют эту премию. Хрупкие и «спящие» режимы института можно описывать тем, насколько «с запасом» выполняется $(★)$ и как соотносятся объективная структура $\psi$ и субъективные постериоры $\hat r_i$; но формально все они сводятся к различным конфигурациям одного и того же условия obedience в форме $(OB)$ или его параметрической свёртки $(★)$. -->
...
<!---->
<!--«Спящий» институт — ситуация, когда агенты недооценивают де факто существующую санкционирующую инфраструктуру: $r\delta < \Delta < r\delta$. -->
<!---->
...
<!--Таким образом, наша модель развивает и частично обобщает метрику силы институтов Хиндрикса. Модель сохраняет его базовую интуицию — сила как избыток мотивации по отношению к структурной премии, но переписывает её в байесовских терминах. Это позволяет связать теорию институтов с Байес‑коррелированным равновесием и информационным дизайном и различать разные режимы одного и того же института (правила) в зависимости от расхождения между объективной и субъективной вероятностями санкций, чего нет в явном виде в его формальной схеме.-->
...
<!--<br/>-->
<!---->
<!--| Режим                         | $r\delta$ и $\Delta$ | $r\delta$ и Δ | Статус                      |-->
<!--| ----------------------------- | ---------------------               | ---------------------- | -------------------------------- |-->
...
<!---->
<!--: Режимы функционирования института в зависимости от отношения между объективным и воспринимаемым $r$ и $\Delta$-->
<!---->
<!--<br/>-->

<!--Мы не включили пограничные случаи вроде $r\delta \approx \Delta$ и $r \approx \Delta$, поскольку они не дают принципиально новых результатов, а лишь показывают «тонкие» места и границы устойчивости.-->

<!--1. *Доинституциональный*: $r(s_i)\delta < \Delta u$. Отклонение от рекомендации медиатора выгодно, условная стратегия уязвима, коллапс института.-->
<!--2. *Протоинституциональный*: $r(s_i)\delta = \Delta u$. Отклонение и следование роли дают одинаковый ожидаемый выигрыш. Формально санкция есть, но она лишь нейтрализует премию от отклонения и не создаёт устойчивого перекоса в пользу роли. Пограничное состяние, нестрогое КР.-->
<!--3. *Институциональный*: $r(s_i)\delta > \Delta u$. Отклонение строго невыгодно, строгое БКР.-->
<!---->
