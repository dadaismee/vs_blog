...
В отличие от нормативных и эпистемических подходов Биккиери и Гинтиса [@bicchieri2005; @gintis2009a], теории институтов-как-равновесий фокусируются не на том, *почему агенты считают некоторое поведение обязательным*, а на том, *почему отклонение от равновесия становится невыгодным*.
...
Мотивируемое поведение зависит от когнитивных категорий и способности правил координировать ожидания, основанные на этих категориях. Мотивация, выраженная в самопринуждающих равновесиях (self-enforcing) зависит от правил — точнее, от когнитивных категорий, в терминах которых формулируются ожидания. Это значит, что институты-как-равновесия невозможны без правил. Это станет особенно важно в при рассмотрении теории правил-в-равновесии в следующем разделе данной главы.
