...
Философ науки Дон Росс предлагает различать *аналитическую* и *научную* социальную онтологию, где основной метод первой — концептуальный анализ, а второй — эмпирические исследования и вывод к наилучшему объяснению (inference to the best explanation, далее IBE)[^ibe] [@ross2023]. Для Росса «натуралистическая метафизика», как он её называет, не применяет концепции, которые не встречаются в теориях, моделях или объяснениях «науки первого порядка».
