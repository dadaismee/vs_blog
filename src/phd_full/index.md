...
Как мы показали в прошлой главе, в игре в развёрнутой форме Буржуа не будет различать тип соперника, поэтому против себя получит стандартный платёж:
$$
\pi(B,B) = \frac{V}{2}$$
...
Стратегия Блефующего направлена в первую очередь на эксплуатацию Буржуа, что подрывает статус последней как ЭСС. Это означает, что условная стратегия сама по себе не может быть эволюционно стабильной — блеф нарушает равновесие.
...
$\delta$-параметр — часть определения института, поскольку он необходим для поддержания равновесия. 
...
Для поддержания глобального равновесия нужен механизм, который позволил бы агентам поступать так, *как если бы санкция была применена мгновенно в любой их игр популяции*. И если санкция $\delta$ — это механизм компенсации блефа *в одной игре,* то «доставка санкции» — это механизм компенсации шума между играми при *масштабирования* санкции $\delta$ на несколько игр.
...
$$\delta_{eff} = r \times \delta = 1 \times \delta = \delta$$
