...
Рассмотрим модель на примере игры ЯГБ с двумя пастухами. Два пастуха встречаются на высохшем русле реки, чтобы пасти скот, и используют условную стратегию «если пришёл первым, паси скот». 
...
Матрица 4х4 здесь не имеет онтологического смысла (как и матрица Гуалы с выпасом скота), потому что отражает два разных этапа формирования института. Стратегии Ястреба ($H$) и Голубя ($D$) определяют поведенческую основу для условных стратегий и имеют смысл в доинституциональном состоянии. Когда есть Буржуа стратегия, чистые стратегии Ястреба и Голубя становятся не нужны.

а стратегия Блефа имеет смысл только при наличии устоявшейся стратегии Буржуа.

, . Сразу добавим параметр $\delta$ в выплату Блефующего. Матрица выигрышей имеет вид:

<div class='table'>

\begin{array}{|l|c|c|c|c|} 
\hline 
 & \textbf{H} & \textbf{D} & \textbf{B} & \textbf{L} \\ 
\hline 
\textbf{H} & \frac{V-C}{2} & V & \frac{3V-C}{4} & V \\ 
\hline 
\textbf{D} & 0 & \frac{V}{2} & \frac{V}{4} & 0 \\ 
\hline 
\textbf{B} & \frac{V-C}{4} & \frac{3V}{4} & \frac{V}{2} & \frac{V}{4} \\ 
\hline 
\textbf{L} & 0 & V & \textcolor{red}{\frac{3V}{4} - \delta} & \frac{V}{4} \\ 
\hline 
\end{array}

<figcaption>Структура матрицы ЯГБ 4*4 со стратегией Блефа</figcaption>
</div>
...
\hline 
 & \textbf{H} & \textbf{D} & \textbf{B} & \textbf{L} \\ 
\hline 
\textbf{H} & -25 & 50 & 12.5 & 50 \\ 
\hline 
\textbf{D} & 0 & 25 & 12.5 & 0 \\ 
\hline 
\textbf{B} & -12.5 & 37.5 & 25 & 12.5 \\ 
\hline 
\textbf{L} & 0 & 37.5 & \textcolor{red}{37.5 - \delta} & 25 \\ 
\hline 
\end{array}
$$
<figcaption>Платёжная матрица ЯГБ 4*4 со стратегией Блефа</figcaption>
</div>
...
5Институт как область параметров](assets/BL_heatmap_delta_r.png)
