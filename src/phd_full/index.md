...
Как предполагает Гуала и как мы показали в прошлой секции, в данном случае стратегия Буржуа будет КР (и ЭСС). Однако это так только в случае, если мы полагаем, что факт раннего прибытия нельзя оспорить — как будто это факт природы, как в примере с бабочками.

Подобное допущение связано с *полнотой информации* в игре — что игроки знают возможные стратегии, историю игры и реальный *тип* другого игрока. Тип — это характеристика, доступная только самому игроку. Например, в классической ЯГБ это «владелец» или «захватчик», и каждый игрок знает свой тип [@maynardsmith1982].

ОСТАНОВИЛСЯ ЗДЕСЬ

<details>

У животных сигналы в ЯГБ — общие, потому что вероятных приватных сигналов, которые устройство корреляции может «послать» каждому агенту, всего два — роль владельца или захватчика. Они взаимоисключающие и устройство корреляции не посылает каждому агенту истинно приватный сигнал, недоступный другим, как в КР Аумана [@aumann1987; @vanderschraaf1995].
