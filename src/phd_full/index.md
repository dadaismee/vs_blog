...
Проблема принудительной силы социальных институтов — одна из центральных и наиболее дискуссионных в современной социальной онтологии. Социальные институты — деньги, право, собственность, брак, государство — представляют собой не просто описания наших взаимодействий, но активные силы, формирующие социальную реальность. Их отличительная черта — способность не только направлять, но и ограничивать репертуар действий, создавая устойчивые, самовоспроизводящиеся паттерны поведения. Этот феномен — принудительная сила институтов — и составляет центральную проблему настоящего исследования.

Вопрос о природе и источнике институционального принуждения приобрёл особую остроту в контексте современных дискуссий о возможности унифицированной социальной онтологии. Философ науки Дон Росс отмечает, что социальные науки характеризуются «теоретической фрагментацией» — отсутствием общепринятого объяснительного ядра, аналогичного теории эволюции в биологии [@ross2023]. Эта фрагментация проявляется, в частности, в радикальном расхождении подходов к объяснению принудительной силы институтов: менталистские теории выводят её из сферы коллективных убеждений и интенций, тогда как экономико-игровые подходы трактуют её как функцию структуры материальных стимулов и стратегических равновесий.

Актуальность исследования определяется несколькими обстоятельствами теоретического и практического порядка.

Во-первых, существующие теории институтов оставляют без удовлетворительного ответа ключевой вопрос: каков источник принудительной силы? Теория конститутивных правил Джона Сёрла объясняет существование институциональных фактов через формулу «X считается Y в контексте C», однако не раскрывает механизм возникновения деонтических (обязывающих) сил, принуждающих к следованию этим правилам [@searle1995]. Теория правил-в-равновесии Франческо Гуалы и Фрэнка Хиндрикса предлагает понимание институтов как коррелированных равновесий из математической теории игр, стабилизированных правилами, однако не объясняет происхождение механизма, необходимого для стабильности равновесия [@guala2015; @hindriks2015]. Теории конвенций Дэвида Льюиса объясняет координацию ожиданий, но не объясняет принуждение [@lewis1969]. Институциональная экономика в традиции Дугласа Норта и Элинор Остром детально описывает роль формальных и неформальных правил, мониторинга и санкций, однако причина следования правилам остаётся за пределами их анализа [@north1990; @ostrom1990].

Во-вторых, проблема принудительной силы имеет непосредственное отношение к практическим вопросам институционального дизайна. Понимание того, каким образом институты приобретают и удерживают принудительную силу, необходимо для эффективного проектирования институтов в экономической политике и управлении организациями. Без адекватной онтологической теории любая реформаторская деятельность остаётся в значительной мере интуитивной и эмпирически необоснованной.

В-третьих, актуальность исследования связана с дискуссией о статусе социальных наук и возможности их унификации. В современной литературе по социальной онтологии выделяют индивидуалистские, холистские и натуралистические подходы к объяснению социальной реальности, различающиеся по тому, редуцируют ли они социальное к индивидуальным свойствам, постулируют ли несводимые социальные сущности или же выводят онтологию социального из успешных научных теорий. Натуралистическая программа, развиваемая Доном Россом, предлагает третий путь: онтология социального должна строиться на основе радикально натурализованной метафизики и выводиться из объяснительно успешных социальных и поведенческих наук методом вывода к наилучшему объяснению (inference to the best explanation, IBE). Принятие этой методологии открывает перспективу унификации социальных наук вокруг единого онтологического ядра, согласованного с общенаучной картиной мира.

В-четвёртых, актуальность приобретает вопрос о генезисе институционального принуждения. Традиционные теории объясняют, как поддерживаются уже существующие институты, но оставляют без ответа вопрос о том, откуда берётся сама возможность принуждения. Как возникает санкционная инфраструктура, если она предполагает наличие уже сформированного социального порядка? Ответ на этот вопрос имеет принципиальное значение для понимания исторического возникновения институтов — от права собственности до государства.

В-пятых, исследование имеет значение для понимания динамики институционального распада и трансформации. Если принудительная сила институтов определяется конкретными параметрами санкционной инфраструктуры, то изменение этих параметров (падение надёжности мониторинга, снижение силы санкций, рост привлекательности отклонения от правила) должно вести к предсказуемым последствиям для институциональной устойчивости. Это открывает возможность для теоретически обоснованного анализа институциональных кризисов.

Таким образом, настоящее исследование направлено на решение фундаментальной проблемы социальной онтологии — объяснение источника возникновения и функционирования принудительной силы социальных институтов. Основная исследовательская проблема формулируется следующим образом: каковы необходимые и достаточные условия существования устойчивого института как прокси социального порядка?

## 2. Степень разработанности проблемы

Исследование проблемы принудительной силы социальных институтов опирается на несколько исследовательских программ, каждая из которых внесла существенный вклад в понимание институциональной реальности, однако оставила нерешёнными ключевые вопросы. В данном исследовании рассматриваются три таких программы: 

- традиция конвенций в теории игр и философии;
- традиция регулятивных правил;
- традиция конститутивных правил.

Важным этапом в развитии теоретико-игрового подхода к социальным институтам стала теория конвенций Дэвида Льюиса [@lewis1969]. Льюис возродил и операционализировал идеи Юма в теории конвенций, используя теорию игр и рассматривая конвенции как равновесия, поддерживаемые общими знаниями и прецедентами. В то время как Юм подчёркивал историческую случайность и постепенное возникновение, Льюис сформулировал более строгие критерии рациональности и взаимных ожиданий.

Льюис рассматривал конвенции как решения проблем координации — класса проблем в теории игр, которые требуют от двух или более агентов согласования своих действий для достижения совместно оптимального результата. Ключевой характеристикой конвенции является то, что она представляет собой регулярность в поведении, которая удовлетворяет следующим условиям: (1) каждый следует ей; (2) каждый ожидает, что все остальные следуют ей; (3) предпочтение следовать ей обусловлено ожиданием, что все остальные следуют ей; (4) существует альтернативная конвенция, которой каждый мог бы следовать.

Льюис показал, что конвенции могут возникать как решения проблем координации в ситуациях с множественными равновесиями. Важным вкладом Льюиса является понятие «общего знания» (common knowledge): конвенция требует, чтобы все агенты не только знали правило, но и знали, что все остальные его знают, и так далее до бесконечности.

Однако теория конвенций Льюиса и её последующие уточнения в работах Питера Вандершраафа [@vanderschraaf1995] имеет существенные ограничения для объяснения принудительной силы институтов. Во-первых, конвенции объясняют координацию, но не принуждение: следуя конвенции, агент получает выигрыш только если другие также следуют ей, но конвенция сама по себе не создаёт механизма наказания за отклонение. Во-вторых, Льюис не объясняет, как возникает конвенция из до-конвенционального состояния (хотя Вандершрааф и особенно Брайан Скирмс — последователи Льюиса — объясняют [@vanderschraaf1994; @skyrms2010a].

Экономист Авнер Грейф в серии работ [@greif1989; @greif2006] применил теоретико-игровой подход к объяснению источника принудительной силы институтов в средневековых торговых сообществах. Его анализ генуэзских и магрибских торговцев показал, как механизмы коллективного наказания и остракизма могли обеспечить соблюдение контрактов в отсутствие централизованного правоприменения. Однако Грейф не предлагает общей теории, связывающей параметры санкционной системы с условиями её возникновения.

Традиция равновесного подхода к институтам — неспособность объяснить нормативность за пределами инструментальной рациональности, а также широта равновесных объяснений (они подходят и для описания взаимодействия животных [@davies1978]).

Традиция регулятивных правил, представленная экономистами и социологи, особенно Дугласом Нортом [@north1990] и Элинор Остром [@ostrom1990], определяет институты как «правила игры» — формальные ограничения (законы, конституции, контракты) и неформальные ограничения (обычаи, традиции, кодексы поведения).

Подход к институтам как регулятивным правилам делает *акцент на регуляции поведения*. Эти правила известны всем в сообществе и ограничивают возможные способы поведения в разных ситуациях, создавая повторяемый и масштабируемый социальный порядок. Принуждение к следованию правилам имеет «стоимость издержек», и институт определяется как структура правил и структура принуждения к следованию им [@greif2011].

Согласно Оливеру Уильямсону [@williamson2000], «транзакционные издержки» — это издержки в процессе стратегического взаимодействия, связанные с ограниченной рациональностью и оппортунизмом участников. Важно, что эффективные правила ведут к снижению таких издержек. Эффективность институтов связана с тем, *насколько хорошо они минимизируют трансакционные издержки*.

Дуглас Норт определяет институты как «правила игры» или «созданные человеком ограничения поведения» и делит их на формальные и неформальные. Оба типа *принудительны* и регулируют поведение, потому что *подкреплены силой*. Эти «правила игры» структурируют стимулы и ограничения человеческого взаимодействия.
...
Особое значение для настоящего исследования имеет анализ Нортом роли санкций в поддержании институтов. Норт подчёркивает, что «эффективность институтов зависит от издержек измерения и издержек принуждения» [@north1990, 97]. Однако сам Норт признаёт, что его теория не объясняет происхождения механизма принуждения: она описывает, как существующие институты поддерживают себя, но не то, как они возникают.
...
Проблема этого подхода — в оторванности содержания правила и принуждения к его исполнению.

Традиция конститутивных правил Джона Сёрла предложила влиятельную онтологию институтов через формулу «X считается Y в контексте C» [@searle1995; @searle2010]. Согласно этой теории, институциональные факты конституируются правилами вида «X считается Y», которые создают деонтические силы — права, обязанности, полномочия. Сёрл утверждает, что коллективное принятие статусных функций создаёт объективные институциональные факты.

Джон Сёрл одним из первых сформулировал проблему онтологического статуса социальных фактов и институтов: как можно быть эпистемологически объективным касательно онтологически субъективных вещей? Сёрл показал, что социальные (или, как он их называет, институциональные) факты создаются *конститутивными правилами* вида «X считается Y в контексте C», где X — факт как таковой (brute fact). Например, «забить мяч в сетку ($X$) считается голом ($Y$) в футбольном матче ($C$)». Такие правила не просто регулируют уже существующее поведение, а *создают* новые социальные факты.

По словам Сёрла, «институциональные факты существуют только в системах конститутивных правил» [@searle1995]. Эти правила зависят от коллективного признания (collective acceptance) и имеют принудительную силу. Коллективное признание зависит от коллективной интенциональности (we-intentionality) — постулируемой Сёрлом когнитивной способности индивидов иметь сонаправленность мысли.

Сёрл считает, что институциональные факты — это статусные функции, присваивающие материальным объектам новый статус, а институты — это системы, делающие возможным создание и поддержание статусных функций. Принудительная сила и каузальность конститутивных правил исходят из их «деонтических сил» — создаваемых конститутивными правилами прав, обязанностей, полномочий, разрешений, требований и запретов. Например, факт «этот человек — судья» наделяет его деонтической силой: правом выносить приговор, обязанностью соблюдать процедуру, полномочиями требовать показания. Эти полномочия имеют причинную силу, потому что *мотивируют поведение*. Люди признают эти полномочия и действуют в соответствии с ними, а также требуют их признания от других.
...
В целом, традиция Сёрла не объясняет источник принудительной силы институтов. Видовая характеристика института для этой традиции — наличие статусной функции, которая возможна только при наличии языка и коллективного намерения. Однако, несмотря на критику, теория Сёрля остаётся влиятельной в философии науки, предлагая рамку для анализа того, как социальные институты с принудительной силой возникают из коллективных практик и языка.

Наиболее влиятельной попыткой синтеза менталистской и стратегической программ является теория «правило-в-равновесии» (rule-in-equilibrium, ПвР), разработанная Гуалой [@guala2015; @guala2016] и Хиндриксом [@hindriks2015; @hindriks2019; @hindriks2022]. Согласно этой теории, институт представляет собой равновесие, стабилизированное правилом. Равновесие определяет устойчивые стратегии агентов, а правило выполняет функцию координации ожиданий и фокальной точки.

Теория ПвР соединяет подходы, основанные на регулятивных правилах, равновесных объяснениях и конститутивных правилах. Первые два дополняют друг друга и составляют собственно правила-в-равновесии, а третий дополняет его, предоставляя символическую репрезентацию — возможность описывать поведенческие паттерны вида «Если X, делай Y» как термин вроде «денег» или «брака».

Гуала и Хиндрикс утверждают, что концепции конститутивных правил и равновесных объяснений, распространённые в экономике, могут быть интегрированы с помощью понятия коррелированного равновесия. Их ключевая идея состоит в том, что *конститутивные правила не являются онтологически фундаментальными*, а могут быть реконструированы из систем регулятивных правил, действующих в условиях координационных равновесий в повторяющихся играх:

> Ключевая идея заключается в том, что конститутивные правила можно создавать по своему усмотрению, используя более фундаментальные строительные блоки — регулятивные правила или теоретико-игровые стратегии — путём введения институциональных терминов [@hindriks2015a, 477].

Авторы показывают, что правила — это репрезентации стратегий в заданной игре. Эти репрезентации не только служат символическими маркерами свойств равновесий, но и значительно экономят когнитивные усилия агентам. Как отмечает экономист Масахико Аоки, на идеи которого опираются Гуала и Хиндрикс:
...
Важно, что Гуала переосмысливает проект Сёрла в теоретико-игровых терминах, не отказываясь от его интуиций. Он признаёт, что институциональные статусы влияют на то, как мы классифицируем мир и действуем в нём, но настаивает, что эти статусы всегда согласованы с поведенческими регулярностями, выраженными как коррелированные равновесия:
...
Трактовка институтов как «правил-в-равновесии» может искажать их онтологию, игнорируя материальные субстраты и историю [@rabinowicz2018]. Многие институты — университеты, денежные системы, рынки — включают конкретных людей, практики и блага, а не только абстрактные стратегии.

Сёрл критикует ПвР, утверждая, что равновесия не объясняют деонтическую силу. Он разводит нормативность и деонтическую силу: любое правило нормативно, но не каждое создаёт обязательства. Для Сёрла «способность создавать обязательства и права» — определяющее свойство институтов, которое равновесный подход не схватывает [@searle2015].

Питер Вандершрааф указывает, что ПвР не отражает механизмы возвращения института в равновесное состояние [@Vanderschraaf_2017].

Поль Эдуин критикует ПвР за переоценку координации как основы института. Хотя теоретико-игровой подход Гуалы предлагает элегантную модель институтов как координационных равновесий, в конечном счёте она слишком «тонка», чтобы охватить полную социальную онтологию институтов. Конструктивный тезис Эдуина призывает к более широкой, нормативно насыщенной и исторически укоренённой рамке, которая признаёт институты как конституирующие предпочтения и идентичности агентов, встроенные в социальные и культурные контексты [@hedoin2016; @hedoin2021].

Теория Гуалы и Хиндрикса сталкивается с фундаментальной критикой по нескольким основаниям. Во-первых, композитный характер теории, «собранной» из других теорий, не обеспечивает подлинной онтологической унификации: правило и равновесие остаются двумя отдельными сущностями, связь между которыми требует дополнительного объяснения [@aydinonat2018]. Во-вторых, и это наиболее существенно для настоящего исследования, теория не объясняет источник принудительной силы, несмотря на свою унифицирующую претензию. 
...
Анализ существующих программ позволяет сформулировать следующие лакуны:

Во-первых, не достигнута подлинная онтологическая унификация внутри социальной онтологии. Синтетические модели (правило-в-равновесии) объединяют элементы конкурирующих программ, но не объясняют, почему эти элементы должны быть связаны именно так, а не иначе.

Во-вторых, не предложено параметрической формализации принудительной силы, позволяющей связать абстрактные социологические категории с измеримыми переменными. Социологические теории (легитимность, ритуал, символическое насилие) описывают различные аспекты институционального принуждения, но не связаны в единую объяснительную схему.

В-третьих, не предложено модели, объясняющей, каким образом принуждение возникает из доинституционального состояния. Теории конститутивных правил постулируют деонтические силы, но не объясняют их генезис. Теории равновесия объясняют устойчивость, но не источник принуждения.

Настоящая диссертация направлена на восполнение указанных лакун.

## 3. Объект и предмет исследования

*Объект исследования* — социальные институты как феномены, обладающие принудительной силой по отношению к агентам. Под социальными институтами в настоящем исследовании понимаются устойчивые паттерны поведения и взаимодействия, поддерживаемые системой правил, санкций и мониторинга. К социальным институтам относятся: право собственности, государство и его органы, деньги, корпорации, брак и семейные структуры, профессиональные ассоциации и иные формы социальной организации.
...
*Предмет исследования* — источник принудительной силы социальных институтов, включая его параметры и условия устойчивости. Исследование сосредоточено на ответе на вопрос: с помощью чего институты направляют и ограничивают поведение агентов даже вопреки их индивидуальным интересам?

Предмет исследования включает три взаимосвязанных аспекта:

Во-первых, структурный аспект: параметры, определяющие принудительную силу института — надёжность фиксации нарушений, серьёзность санкций.

Во-вторых, генетический аспект: механизм возникновения санкционной инфраструктуры — роль специального агента (Инвестора) в создании и поддержании канала санкций.

В-третьих, интеграционный аспект: связь формальной модели с классическими социологическими теориями — демонстрация того, что теории Вебера, Дюркгейма, Бурдьё, Гидденса могут быть реконструированы как описания различных реализаций единой параметрической структуры.

## 4. Цель и задачи исследования

*Цель исследования* — разработка параметрической модели социальной онтологии, объясняющей источник и условия устойчивости принудительной силы социальных институтов. Модель должна: (а) формализовать условия институциональной устойчивости через измеримые параметры; (б) предлагать идею происхождения санкционной инфраструктуры; (в) связать формальную модель с классическими социологическими теориями.

*Задачи исследования:*

1. *Критический анализ существующих теорий институтов* в философии социальной науки и социальной онтологии с точки зрения их способности объяснить принудительную силу. В рамках этой задачи предстоит:
   - Проанализировать теорию конститутивных правил Сёрла на предмет объяснения генезиса деонтических сил;
   - Оценить теорию правил-в-равновесии Гуалы и Хиндрикса на предмет объяснения источника принудительной силы;
   - Рассмотреть ограничения институциональной экономики и теории игр в объяснении принуждения;
   - Выявить лакуны, которые должна закрыть предлагаемая модель.

2. *Разработка параметрической модели института*, включающей три ключевых параметра:
   - $\delta$, тяжесть санкции — величина негативных последствий, применяемых к нарушителю;
   - $r$, надёжность санкции — вероятность того, что нарушение будет обнаружено и зафиксировано.
   
   В рамках этой задачи предстоит:
   - Формализовать ожидаемый выигрыш от следования институциональной стратегии и от отклонения от неё;
   - Вывести условие институциональной устойчивости;
   - Показать, почему конвенция Льюиса-Вандершраафа — частный случай нашей модели, где не принуждение структурно не нужно.

3. *Формализация условия институциональной устойчивости: $r\delta \ge \Delta u$. Данное условие означает, что институт устойчив, когда ожидаемая санкция за отклонение (произведение вероятности обнаружения на тяжесть санкции) превышает возможный выигрыш за нарушение. В рамках этой задачи предстоит:
   - Показать, как условие $r\delta ≥ \Delta u$ работает в различных играх («Ястребы и голуби», «Охота на оленя»);
   - Проанализировать граничные случаи и переходы между устойчивостью и неустойчивостью;
   - Рассмотреть динамические аспекты: как изменение параметров влияет на институциональную динамику.

4. *Демонстрация применения модели к классическим социологическим теориям* в рамках умеренного эпистемического структурного реализма. В рамках этой задачи предстоит:
   - Показать, как параметры $(r, \delta)$ могут быть интерпретированы в терминах веберовского понятия легитимного господства;
   - Раскрыть связь дюркгеймовского ритуала с механизмом синхронизации мониторинга (повышение $r$);
   - Проанализировать символическое насилие Бурдьё как конфигурацию интернализованных и внешних санкций;
   - Показать, как структурация Гидденса связана со способностью агентов изменять параметры $r$ и $\delta$ для других агентов.

6. *Формулировка онтологического тезиса* о санкционной инфраструктуре как структурном инварианте социального порядка. В рамках этой задачи предстоит:
   - Сформулировать тезис в терминах вывода к наилучшему объяснению;
   - Показать, почему предложенная модель превосходит конкурирующие программы по объяснительной силе;
   - Обосновать нередукционистский характер модели;
   - Указать ограничения модели и направления дальнейших исследований.

Сформулированные задачи определяют структуру диссертации, которая включает четыре главы. Первая глава посвящена критическому анализу существующих теорий институтов. Вторая глава содержит детальный анализ теории правил-в-равновесии Гуалы и Хиндрикса как наиболее влиятельной современной программы. Третья глава представляет разработку параметрической модели. Четвёртая глава обосновывает унифицированную социальную онтологию и её связь с классическими социологическими теориями.

## 5. Теоретические основания исследования

Диссертация опирается на несколько взаимодополняющих теоретических оснований, каждое из которых вносит существенный вклад в формирование целостной исследовательской программы.

*Натуралистическая социальная онтология Дона Росса.* Центральным теоретическим основанием исследования является программа натуралистической социальной онтологии, развиваемая Доном Россом [@ross2023] и его коллегами. Согласно этой программе, онтология социального должна выводиться не из априорных концептуальных схем или логического анализа понятий, а из объяснительно успешных научных теорий. Онтологические обязательства должны быть пропорциональны объяснительной силе теорий: мы вправе считать реальными те сущности и структуры, которые лучше всего объясняют наблюдаемые феномены.

Важным элементом программы Росса является понятие «реальных паттернов» (real patterns), заимствованное из философии сознания Дэниела Деннета [@dennett1991]. Социальные институты рассматриваются как реальные паттерны — устойчивые объективные структуры, которые поддерживают индуктивные обобщения и, следовательно, могут служить основой для научного объяснения.

*Вывод к наилучшему объяснению (Inference to the Best Explanation, IBE).* Методологическим принципом, обеспечивающим переход от конкурирующих теорий к онтологическим обязательствам, является вывод к наилучшему объяснению [@harman1965; @lipton2013]. Согласно этому принципу, среди конкурирующих гипотез следует выбирать ту, которая наилучшим образом объясняет наблюдаемые феномены. Критерии «наилучшего объяснения» включают: объяснительную силу (способность объяснить широкое поле данных), когерентность (согласованность с другими принятыми убеждениями), плодотворность (способность предсказывать новые феномены) и простоту.

Применительно к социальной онтологии IBE означает следующее: если теория $T_1$ лучше объясняет устойчивость и принудительность социальных институтов, чем альтернативные теории $T_n$, то мы имеем основания принять онтологические обязательства, предполагаемые $T_1$.

*Эпистемический структурный реализм (ЭСР).* Философское основание для признания структур, а не конкретных сущностей, в качестве онтологически фундаментальных предоставляется эпистемическим структурным реализмом. Эта позиция, развиваемая Джоном Уорралом [@worrall1989] и Джеймсом Лэдиманом [@ladyman1998], утверждает, что научные теории схватывают реально существующие структуры, даже если конкретные онтологические сущности, к которым эти структуры применяются, остаются под вопросом.

Уоррал формулирует ключевой тезис: «то, что сохраняется при смене теорий, — это структура (математические уравнения), а не конкретные онтологические сущности» [@worrall1989, 115]. Лэдиман уточняет: ЭСР утверждает, что «единственное, что мы можем узнать о мире, — это его структура» [@ladyman1998, 429].

Применительно к социальным наукам эпистемический структурный реализм означает, что онтологические обязательства должны принимать форму структурных (а не субстанциальных) утверждений: реальны не сами по себе институты как «вещи», а структурные конфигурации, которые они реализуют.

*Теория игр и коррелированные равновесия.* Формальным аппаратом исследования является теория игр, в особенности теория коррелированных равновесий, развитая Робертом Ауманном [@aumann1974; @aumann1987]. Коррелированное равновесие (КР) представляет собой обобщение равновесия Нэша, допускающее корреляцию стратегий агентов через общий сигнал, не являющийся результатом действий агентов. Важное свойство КР состоит в том, что оно может быть Pareto-эффективным в играх координации — в отличие от равновесия Нэша, которое может «застревать» в неэффективных равновесиях.

Для настоящего исследования ключевым является объяснительный потенциал КР: модель показывает, как координация может возникать без предварительного соглашения, через медиатора, распределяющего сигналы агентам. Это объясняет, каким образом агенты координируют свои ожидания, даже если они не разделяют общей конвенции.

## 6. Методология исследования

Методологический подход диссертации сочетает философский анализ с формальным моделированием, обеспечивая как концептуальную строгость, так и объяснительную силу.

*Философский анализ существующих теорий.* Первый методологический шаг состоит в критическом анализе существующих теорий институтов с оценкой их объяснительной силы и границ применимости. Этот анализ проводится в духе вывода к наилучшему объяснению: из сравнения объяснительных возможностей конкурирующих теорий делается вывод о том, какая теория (или комбинация теорий) располагает к принятию её онтологических обязательств.

Критический анализ включает:

- Реконструкцию логической структуры каждой теории;
...
*Формальное моделирование.* Центральным методом исследования является формальное моделирование с использованием аппарата теории игр. Моделирование включает:

*Матричные игры* — представление институционального взаимодействия в виде матрицы выигрышей с последующим анализом условий существования и устойчивости равновесий. Базовые игровые формы включают: «Ястребы и голуби» и «Охоту на оленя».

*Параметрическая формализация.* Ключевым методологическим новшеством является введение трёх параметров:

- $\Delta u$  — премия за отклонение: разница между выигрышем при одностороннем отступлении от институциональной стратегии и выигрышем при её соблюдении;
- $\delta$ — тяжесть санкции: величина негативных последствий, применяемых к обнаруженному нарушителю;
- $r$ — надёжность фиксации: вероятность того, что нарушение будет обнаружено, зафиксировано и станет основанием для санкции.

Условие институциональной устойчивости формализуется как $r\delta ≥ \Delta u$.

Данное условие означает, что институт устойчив, когда ожидаемая санкция (вероятность обнаружения, умноженная на тяжесть санкции) превышает премию за нарушение. Если это условие не выполняется, у агентов появляется стимул к отклонению, и институт неустойчив.

*Онтологическая параметризация классических теорий.* Методологический подход включает демонстрацию того, что классические социологические теории могут быть реконструированы как описания различных конфигураций базовых параметров. Это не означает редукции социологии к формальной модели, но показывает, что формальная модель задаёт онтологическое ядро, вокруг которого социологическое знание приобретает структурную определённость.

*Основные источники.* Исследование опирается на следующие категории источников:

*Первичные философские источники:* работы Сёрла, Гуалы, Хиндрикса, Росса, Льюиса, Ауманна, Олсона, Уоррала, Лэдимана, Деннета.

*Вторичные источники по социальной онтологии:* работы Кинкейда, Чёрчленд, Фаулера, Иликоски, Саркиа, Хаслайнджера.

*Источники по институциональной экономике:* работы Норта, Остром, Уильямсона, Грейфа.

*Классические социологические источники:* работы Вебера, Дюркгейма, Бурдьё, Гидденса.

*Формальные источники по теории игр:* работы Нэша, Ауманна, Селтена, Крейга, Скирмса, Боулза.

## 7. Научная новизна

Научная новизна диссертации определяется совокупностью теоретических результатов, выходящих за рамки существующих исследовательских программ.

1. *Разработана параметрическая модель социальной онтологии*, вводящая три ключевых параметра институционального принуждения: Δu (премия за отклонение от институциональной стратегии), r (вероятность обнаружения нарушения, надёжность мониторинга) и δ (тяжесть санкции). Условие институциональной устойчивости формализовано как rδ ≥ Δu. Данная формализация позволяет связать абстрактные социологические категории с измеримыми переменными и обеспечивает возможность эмпирической проверки.

2. *Предложен механизм генезиса санкционной инфраструктуры* через модель Инвестора (оседлого бандита), интегрированную с параметрическим подходом. В отличие от существующих моделей, объясняющих поддержание институтов, предложенная модель объясняет возникновение санкционного механизма из доинституционального состояния. Показано, что значения параметров r и δ определяются инвестиционным решением Инвестора в зависимости от технологических условий, структуры населения и величины ренты.

3. *Сформулирован онтологический тезис* о санкционной инфраструктуре как структурном инварианте социального порядка. Тезис утверждает, что устойчивый социальный порядок любого масштаба реализует одну и ту же абстрактную структуру: конфигурацию вероятностных санкций и механизмов мониторинга, распределённую по ролям, делающую следование заданному правилу равновесным. Это не «одна из» перспектив, а единственно возможный фундамент, привязывающий множественные семантические языки социальных наук к единой каузальной реальности.

4. *Обоснована позиция умеренного эпистемического структурного реализма* применительно к социальным наукам. Показано, что классические социологические теории (Вебер, Дюркгейм, Бурдьё, Гидденс) могут быть реконструированы как различные описания одной параметрической структуры. Это открывает перспективу унификации социальных наук вокруг единого онтологического ядра.

5. *Преодолён разрыв между формальными моделями и социологической теорией.* Продемонстрировано, что параметры (r, δ, Δu) позволяют формализовать интуиции Вебера о легитимности (конфигурация r и δ, при которой rδ ≥ Δu; утрата легитимности — коллапс r ниже критического порога), Дюркгейма о ритуальной интеграции (ритуалы как механизм синхронизации мониторинга, повышающий r), Бурдьё о символическом насилии (доминирование $δ_int$ — интернализованной санкции — над $δ_ext$ — внешней), Гидденса о структурации (ресурсы власти как способность изменять параметры $r$ и $δ$ для других агентов).

6. *Обоснована объяснительная унификация*, превосходящая по кардинальности теорию Гуалы и Хиндрикса. В то время как теория правил-в-равновесии объясняет устойчивость институтов (как они поддерживаются), параметрическая модель объясняет также и принудительную силу (почему отклонение влечёт негативные последствия). Это расширяет объяснительные возможности социальной онтологии.

## 8. Основные положения, выносимые на защиту

На основании проведённого исследования выносятся следующие положения:

1. *Принудительная сила социального института определяется не «коллективной интенциональностью» или «конститутивными правилами», а социоматериальной инфраструктурой санкций, параметризованной через три переменные: премию за отклонение Δu, надёжность фиксации r и тяжесть санкции δ.* Это означает, что принуждение имеет не менталистскую или нормативную природу, а материальную: оно зависит от объективных характеристик инфраструктуры мониторинга и наказания.

2. *Институт существует тогда и только тогда, когда для критической массы агентов выполнено условие rδ ≥ Δu: ожидаемая санкция за отклонение превышает премию за это отклонение.* Когда это условие нарушается (падение r, снижение δ или рост Δu), институт теряет устойчивость и начинает распадаться. Когда условие выполняется с избытком, институт стабилен.

3. *Параметрическая модель обеспечивает объяснительную унификацию, превосходящую по кардинальности теорию Гуалы и Хиндрикса.* Теория правил-в-равновесии объясняет устойчивость (как поддерживается), но не принудительную силу (почему нарушение влечёт последствия). Модель rδ ≥ Δu объясняет оба аспекта и интегрирует их в единую объяснительную схему.

4. *Классические социологические теории (Вебер, Дюркгейм, Бурдьё, Гидденс) могут быть реконструированы как описания различных социоматериальных реализаций одной и той же параметрической структуры (r, δ, Δu).*

5. *Устойчивый социальный порядок любого масштаба реализует одну и ту же абстрактную структуру: конфигурацию вероятностных санкций и механизмов мониторинга, распределённую по ролям, делающую следование заданному правилу равновесным.* Этот структурный инвариант не зависит от конкретного содержания институтов и может быть применён к анализу любых институциональных контекстов.
...
1. *Критический анализ теорий институтов* (Глава 1) показал, что ни одна из существующих теорий не объясняет механизм возникновения санкционной инфраструктуры:
   - Теория Сёрла постулирует деонтические силы через конститутивные правила, но не объясняет, откуда берётся принуждение к этим правилам. Коллективное принятие не создаёт материальной силы.
   - Теория Гуалы объясняет устойчивость через коррелированное равновесие, но не объясняет происхождение механизма, обеспечивающего негативные последствия за отклонение.
   - Теории конвенций (Льюис) объясняют координацию ожиданий, но не принуждение.
   - Институциональная экономика (Норт, Остром) детально описывает условия поддержания институтов, но не их возникновения.
   - Эволюционная теория игр объясняет кооперацию, но не санкционные механизмы.

2. *Разработана формальная модель* (Глава 3) с тремя параметрами, определяющими принудительную силу института:
   - Δu (дельта u) — премия за отклонение: дополнительный выигрыш, который агент получает при одностороннем отступлении от институциональной стратегии. Δu зависит от структуры выигрышей в конкретной игровой форме и может быть измерена эмпирически через сравнение выигрышей.
   - r — надёжность фиксации: вероятность того, что нарушение будет обнаружено, зафиксировано и станет основанием для санкции. r зависит от технологии мониторинга, плотности социальных связей, наличия специализированных агентов мониторинга.
   - δ (дельта) — тяжесть санкции: величина негативных последствий, применяемых к обнаруженному нарушителю. δ включает как материальные (штрафы, тюремное заключение), так и социальные (стигма, исключение) компоненты.

   *Условие институциональной устойчивости: rδ ≥ Δu.*

   Это условие означает: институт устойчив, когда ожидаемая санкция (r × δ) превышает премию за нарушение (Δu). Если rδ < Δu, у агентов появляется математический стимул к отклонению, и институт неустойчив.

   Показано, что модели координации (Льюис) и коррелированного равновесия (Ауманн) недостаточны без параметров r и δ: они объясняют, как агенты координируют ожидания, но не объясняют, почему отклонение влечёт негативные последствия.

3. *Выдвинута идея генезиса санкционной инфраструктуры* (Раздел 3.4). Традиционные теории объясняют поддержание, но не возникновение институтов. Модель Инвестора предлагает решение:
   - Инвестор (осёдлый бандит) — специализированный агент, оптимизирующий долгосрочную ренту от стабильного порядка.
   - Инвестор инвестирует в создание и поддержание канала санкций: системы мониторинга (повышает r) и механизма наказания (обеспечивает δ).
   - Инвестиционное решение определяется: технологическими условиями (издержки мониторинга и наказания), структурой населения (численность, плотность, гетерогенность), величиной ренты (ожидаемый выигрыш от стабильности).
   - Оптимальные значения r и δ определяются из условия максимизации ренты: дополнительный доход от повышения r или δ должен превышать дополнительные издержки.

   Эта модель объясняет, почему санкционная инфраструктура не возникает «спонтанно» из координационных механизмов: она требует специализированных инвестиций, которые может осуществлять только агент с достаточными ресурсами и временным горизонтом.

4. *Сформулирован онтологический тезис* (Глава 4): существует реально действующий макроструктурный инвариант — конфигурация стимулов, санкций и мониторинга — делающая социальный порядок стабильным.

   В терминах вывода к наилучшему объяснению (IBE):
   ...
   - Классические социологические теории (Вебер, Дюркгейм, Бурдьё, Гидденс) описывают различные социоматериальные реализации этого инварианта.

   Тезис обоснован в рамках умеренного эпистемического структурного реализма: онтологические обязательства принимают форму структурных (а не субстанциальных) утверждений.

5. *Продемонстрированы примеры параметрической реконструкции некоторых классических теорий социологии* (Раздел 4.3.4):
   - *Вебер:* Легитимное господство — это конфигурация (r, δ), при которой rδ ≥ Δu. Типы легитимности (традиционное, харизматическое, легальное-рациональное) соответствуют различным механизмам поддержания r и δ. Утрата легитимности — снижение r ниже критического порога, при котором rδ < Δu.
   - *Дюркгейм:* Ритуалы — механизм синхронизации мониторинга, повышающий r. Коллективные представления — общий язык, обеспечивающий координацию ожиданий. «Священный» характер социальных фактов — интернализация δ.
   - *Бурдьё:* Символическое насилие — конфигурация, при которой δ_int (интернализованная санкция — стыд, вина) превышает δ_ext (внешняя санкция — материальные последствия). Габитус — стабильный паттерн интернализации параметров.
   - *Гидденс:* Ресурсы власти — способность изменять параметры r и δ для других агентов. Структура — набор правил (алгоритмы определения r и δ) и ресурсов (материальные и авторитетные).

6. *Обоснован статус модели* (Раздел 4.3.5) как рамки, а не редукционизма:
   - Параметрическая модель задаёт необходимые условия институциональной устойчивости, но не достаточные для понимания конкретных исторических форм.
   - Модель не сводит социологию к теории игр: она задаёт онтологическое ядро, в рамках которого социологическое знание приобретает структурную определённость.
   - Социология остаётся незаменимой в описании того, каким образом параметры конкретизируются в различных обществах, эпохах, культурных контекстах.

7. *Разработана типология институциональной устойчивости.* На основе параметрической модели предложена классификация институтов по степени устойчивости:
   - *Устойчивые институты*: конфигурация (r, δ) обеспечивает значительное превышение ожидаемых санкций над премией за отклонение (rδ >> Δu);
   - *Маргинальные институты*: конфигурация параметров близка к пороговому значению (rδ ≈ Δu);
   - *Хрупкие институты*: конфигурация параметров нестабильна и чувствительна к внешним воздействиям (rδ < Δu или близко к порогу).

   Данная типология позволяет прогнозировать институциональные кризисы и разрабатывать стратегии институционального дизайна.

8. *Предложен аналитический инструментарий для сравнительных исследований.* Параметрическая модель позволяет проводить систематические сравнения институциональных конфигураций в различных обществах, эпохах и контекстах. Это открывает возможности для:
   - Кросс-культурных сравнительных исследований институциональной устойчивости;
   - Исторического анализа динамики институциональных параметров;
   - Эмпирической проверки выводов модели на основе архивных и статистических данных.
...
Основной вывод состоит в том, что принудительная сила институтов имеет не менталистскую или нормативную природу, а социоматериальную: она определяется параметрами санкционной инфраструктуры — надёжностью фиксации нарушений, тяжестью санкций и премией за отклонение, — которые могут быть формализованы и измерены. Это не означает редукции социологии к теории игр — напротив, модель задаёт рамку, в пределах которой социологическое знание приобретает строгую онтологическую опору.

Инвестиционная идея генезиса даёт способ закрыть важный пробел в объяснении возникновения институтов: она показывает, что санкционная инфраструктура не возникает спонтанно из координационных механизмов или коллективных интенций, а создаётся целенаправленными агентами (Инвесторами) в расчёте на «ренту». Это связывает объяснительные уровни: формальная онтология (rδ ≥ Δu), экономическая теория (инвестиционное решение) и социология (конкретные формы санкционной инфраструктуры) оказываются компонентами единой объяснительной схемы.

Параметрическая модель обеспечивает объяснительную унификацию, превосходящую по кардинальности существующие программы. В то время как теория правил-в-равновесии Гуалы и Хиндрикса объясняет устойчивость (как поддерживаются институты), модель rδ ≥ Δu объясняет также и принудительную силу (почему нарушение влечёт негативные последствия). Это расширяет объяснительные возможности социальной онтологии и обеспечивает связь с эмпирическими исследованиями.

Вместе с тем настоящее исследование имеет ряд ограничений, которые должны учитываться при интерпретации результатов. Во-первых, модель основана на предпосылке о рациональности агентов, которая является упрощением реального поведения. Во-вторых, модель преимущественно фокусируется на микроуровне парного взаимодействия; распространение на макроуровень (социальная стратификация, глобальные системы) требует дополнительной разработки. В-третьих, фигура Инвестора не объясняет, почему в одних обществах возникают «осёдлые бандиты», а в других — нет; этот вопрос требует обращения к историческим, культурным и экологическим факторам.

Направления дальнейших исследований включают: (1) разработку формальных моделей, расширяющих параметрический подход на случаи множественных Инвесторов, конкурирующих юрисдикций и динамических изменений параметров; (2) эмпирическую проверку модели через кросс-культурные и исторические сравнительные исследования; (3) интеграцию с теориями социальных движений и политической социологии для объяснения условий институционального распада и трансформации; (4) исследование роли технологий мониторинга и коммуникации в изменении параметра r в современных обществах.
...
$$\begin{gathered}
\mathcal{H}_N = \{\{\omega_N\}\} \\
\mathcal{H}_D = \{\{\omega_D\}\} \\
\mathcal{H} = \mathcal{H}_N \cap \mathcal{H}_D = \{\{\omega_N\}, \{\omega_D\}\}
\end{gathered}$$

Информационные разбиения — одноэлементные: конкретному сигналу соответствует конкретная стратегия, а значит реализуется КР — есть условная стратегия «пасти, если пришёл первым / не пасти, если вторым».
...
Чтобы $\delta$-параметр перестал выглядеть как произвольный модификатор полезности и обрёл онтологическое содержание, нужно явно указать, где именно он находится в модели, и как связан с вероятностью применения санкций. Для этого удобно перейти от классического КР к байесовскому (БКР) с ходом фиктивного игрока — Природы.
...
\mathbb{P}(\theta = 0) = 1 - r,
$$
так что $r$ получает онтологическую интерпретацию как вероятность того, что институт работает. Это означает, что $r$ кодирует вероятность наступления санкции в случае нарушения.

<!--- вставить картинку байесовской игры с матрицами  todo-->

Устройство корреляции (медиатор) в базовой игре рассылает агентам сигналы-рекомендации $s_i$. Совместное распределение $(\theta,s)$ можно записать как $\mu(\theta,s) = \mu_0(\theta)\mu(s\mid\theta)$, где $\mu_0$ — априорное распределение по $\theta$, а $\mu(s\mid\theta)$ описывает сигнальный механизм. В простейшем сценарии мы предполагаем, что сигналы не несут информации о $\theta$ — о том, активен институт или нет, то есть $\mu(s\mid\theta)$ не зависит от $\theta$, и, следовательно, апостериорное распределение совпадает с априорным: $\mathbb{P}(\theta=1\mid s_i)=r$. В этом случае все математические ожидания $\mathbb{E}[\cdot\mid s_i]$ по-прежнему байесовские, но обновление верований по сигналу тривиально — его фактически нет.

Функции выигрыша игроков зависят от профиля действий и состояния мира: $u_i : S \times \Theta \to \mathbb{R}$. В мире $\theta = 0$ игра совпадает с базовой игрой без санкций, и мы будем писать $u_i(s_i,s_{-i},0) = u_i(s_i,s_{-i})$. В мире $\theta = 1$ отклонение от сигнала медиатора наказывается санкцией $\delta$: если игрок $i$ получает рекомендацию $s_i$, но выбирает действие $a_i' \neq s_i$, его выигрыш в этом мире уменьшается на $\delta$, тогда как при следовании сигналу выигрыши совпадают в обоих состояниях $\theta$. Формально это можно записать как:
$$
u_i(s_i,s_{-i},1) = u_i(s_i,s_{-i},0) = u_i(s_i,s_{-i}),
u_i(a_i',s_{-i},1) = u_i(a_i',s_{-i},0) - \delta = u_i(a_i',s_{-i}) - \delta.
$$
Если игрок $i$ следует рекомендации $s_i$, его ожидаемая полезность не зависит от состояния санкционного механизма, поскольку санкция применяется исключительно за девиацию, и в обоих состояниях $\theta$ payoff совпадает:
$$
\mathbb{E}\bigl[u_i(s_i, s_{-i},\theta) \mid s_i\bigr]
=
\mathbb{E}\bigl[u_i(s_i, s_{-i}) \mid s_i\bigr].
$$

Однако если игрок решает отклониться от предписания и выбрать действие $a_i' \neq s_i$, его итоговый выигрыш будет зависеть от скрытого для него хода Природы $\theta$. Ожидаемая полезность такого оппортунистического отклонения, с учётом неопределённости относительно того, действует ли институт, равна
$$
\mathbb{E}\bigl[u_i(a_i', s_{-i},\theta) \mid s_i\bigr]
=
(1-r)\,\mathbb{E}\bigl[u_i(a_i',s_{-i}) \mid s_i,\theta=0\bigr]
+
r\,\mathbb{E}\bigl[u_i(a_i',s_{-i}) - \delta \mid s_i,\theta=1\bigr].
$$
Учитывая, что базовые выигрыши $u_i(a_i',s_{-i})$ не зависят от $\theta$, получаем компактное выражение:
$$
\mathbb{E}\bigl[u_i(a_i', s_{-i},\theta) \mid s_i\bigr]
=
\mathbb{E}\bigl[u_i(a_i', s_{-i}) \mid s_i\bigr] - r\delta.
$$
Профиль рекомендаций образует БКР, если ни одному агенту не выгодно отклоняться от своего сигнала. В канонической форме это означает, что ожидаемая полезность следования правилу не меньше ожидаемой полезности девиации:
$$
\mathbb{E}\bigl[u_i(s_i, s_{-i},\theta) \mid s_i\bigr] 
\;\ge\;
\mathbb{E}\bigl[u_i(a_i', s_{-i},\theta) \mid s_i\bigr]
...
\text{для всех } a_i'.
$$
Подставляя выражения выше и сворачивая ожидания по $\theta$, получаем аналитически удобное условие
$$
\mathbb{E}\bigl[u_i(s_i, s_{-i}) \mid s_i\bigr] 
\;\ge\;
\mathbb{E}\bigl[u_i(a_i', s_{-i}) \mid s_i\bigr] - r\delta.
...
Для краткости введём чисто аналитическое обозначение структурной премии за отклонение в базовой игре (без учёта санкций):
$$
\Delta u_i(s_i, a_i') = \mathbb{E}\bigl[u_i(a_i', s_{-i}) \mid s_i\bigr] - \mathbb{E}\bigl[u_i(s_i, s_{-i}) \mid s_i\bigr].
$$
Важно оговорить эпистемический статус величины $\Delta u_i$. Строго говоря, в теории рационального выбора финальная функция ожидаемой полезности уже интегрирует все субъективные предпочтения агента, включая моральный дискомфорт или социальные издержки. Разделяя выигрыш на «сырую премию» $\Delta u_i$ и «ожидаемую санкцию» $r\delta$, мы не вводим новых независимых онтологических сущностей и не допускаем «двойного счета». Выделение $\Delta u_i$ является исключительно аналитическим (эпистемическим) инструментом исследователя. Оно позволяет деконструировать мотивацию агента, изолировав «структурную выгоду« от нарушения предписания саму по себе, чтобы затем наглядно продемонстрировать функциональную роль внешнего институционального механизма в стабилизации равновесия.

Другими словами, в отличие от $r$ и $\delta$, это обозначение не претендует на самостоятельное онтологическое содержание, а служит лишь для ясности вывода. Тогда условие устойчивости институционального порядка записывается предельно лаконично:
$$
r\delta \;\ge\; \Delta u_i(s_i, a_i').
$$

Это выражение можно назвать *порогом институциональности* поведенческого паттерна: ниже этого значения применение санкций станет непредсказуемым и не приведёт к равновесию.

Эта формула показывает, почему нельзя «просто» добавить абстрактный штраф $\delta$ в любую игру и объявить, что у нас есть институт: ожидаемая величина санкции $r\delta$ должна быть достаточно большой, чтобы в *конкретном* стратегическом взаимодействии перекрыть структурный стимул к девиации, порождённый базовой игрой и фактическим распределением сигналов $\mu$. Если $\Delta u_i(s_i,a_i')<0$ уже в базовой игре, то есть отклонение уменьшает полезность, мы имеем дело с конвенцией: правило поддерживается чистой структурой payoffs, без института. Если же $\Delta u_i>0$, возникает пространство для института: санкционный механизм с параметрами $r,\delta$ делает возможным устойчивое следование правилу, при условии что $r\delta$ достигает нужного порога.

В простой постановке, рассмотренной выше, игроки исходят из фиксированного априорного распределения $\mathbb{P}(\theta=1)=r$, и сигналы медиатора не несут информации о том, действует ли институт. Такая модель полностью статична: игроки не обновляют верования, и параметр $r$ выступает как *объективная* вероятность мира с активным механизмом принуждения.

Более реалистичная картина — допустить, что сигналы $\mu(s\mid\theta)$ *информативны* относительно состояния мира $\theta$. Тогда апостериорное распределение $\mathbb{P}(\theta=1\mid s_i)$ будет отличаться от априорного $r$, а фактически релевантный для игрока множитель ожидаемой санкции станет $\tilde r(s_i)\delta$, где $\tilde r(s_i)=\mathbb{P}(\theta=1\mid s_i)$. 

Онтологически это означает, что институт — это не только материальный механизм наказания с параметрами $(r,\delta)$, но и объект верований: агенты могут ошибаться относительно действительной вероятности применения санкции. В разных информационных состояниях один и тот же «объективный» механизм может восприниматься как более или менее надёжный, а условие устойчивости принимает локальную форму
$$
\mathbb{P}(\theta=1\mid s_i)\,\delta \;\ge\; \Delta u_i(s_i,a_i').
$$
Тем самым базовая формула $r\delta \ge \Delta u_i$ остаётся структурным ядром модели, но добавление байесовского обновления позволяет показать, как эпистемическая неопределённость относительно работы института (а не содержания правила) влияет на его фактическую устойчивость. В разных играх $\Delta u_i$ будет разной.

Иначе говоря, институт как механизм «надстраивается» над устройством корреляции и делает его более «заметным» (salient) для игроков. Медиатор даёт личные сигналы $s_i$, а институт добавляет публичный и наблюдаемый канал санкций, повышая «заметность». 

В первом приближении институт — это социоматериальный механизм, трансформирующий изначальную матрицу выигрышей через параметр $r\delta$ таким образом, чтобы БКР надежно поддерживалось вопреки стимулам к оппортунизму.

\newpage

## 3.2 Вероятность санкции и область параметров $(r, \delta)$

Сформулированное неравенство $r\delta \ge \Delta u$ позволяет очертить границу между работающими и неработающими социальными правилами. Параметр $r$ отражает надёжность механизма принуждения — вероятность того, что обман повлечёт за собой издержки, а $\delta$ — тяжесть этих издержек. В совокупности значение $r\delta$ задает математическое ожидание наказания, или «объективную цену блефа». Онтологически $r$ отражает ресурсоёмкость и плотность мониторинга: эффективность работы бюрократии, число патрулей на дорогах, охват камер видеонаблюдения и прочность неформальных репутационных сетей.

В главе 2 мы показали, что в байесовской игре ЯГБ с возможностью блефа в развернутой форме возникает структурная премия $\Delta u$ от эксплуатации доверчивости других участников. Ниже мы рассмотрим редуцированную 2×2‑версию игры Ястребы-Голуби, трактуя $\Delta u$ как уже выведенный параметр стимула к нарушению, чтобы проиллюстрировать достижение институционального порога.
...
\end{array}
$$
<figcaption>Игра с выпасом скота (Ястребы-Голуби)</figcaption>
</div>

Предположим, что пастухи обоих племён следуют правил «пришёл первым — пасти скот, а если вторым — уступить», но игроки могут от него отклоняться. Назовём для простоты роли «первого» и «второго» «владелец» и «захватчик» соответственно. Они задаются устройством корреляции — очерёдностью прибытия.

По правилу собственности «захватчик» должен играть $D$, а отклонением является выбор $H$. Пусть с вероятностью $p$ «владелец» фактически агрессивен и играет $H$, а с вероятностью $1-p$ играет $D$. Тогда ожидаемый выигрыш «захватчика» при следовании правилу (играть $D$):
$$
\mathbb E[u(D)] = p\cdot 0 + (1-p)\cdot 25 = 25(1 - p) = 1 - p;
$$
А при нарушении правила (играть $H$):
$$
\mathbb E[u(H)] = p\cdot (-25) + (1-p)\cdot 50 = 50 - 75p = 2 - 3p.
$$
Премия за нарушение правила для «захватчика»:
$$
\Delta u(p) = \mathbb E[u(H)] - \mathbb E[u(D)] = 1 - 2p.
$$
Если $p < 0{,}5$, то $\Delta u(p) > 0$: когда «владельцы» недостаточно часто ведут себя агрессивно, «захватчику» выгодно нарушать правило и играть ястреба. При $p \ge 0{,}5$ правило поддерживается структурой игры и среды, и премии за отклонение нет. 

Теперь предположим, что нарушение правила влечёт санкцию $\delta > 0$ с вероятностью $r \in [0,1]$. Тогда ожидаемый выигрыш «захватчика» при нарушении в мире $\theta = 1$, где санкция вообще возможна,  становится:
$$
\mathbb E[u(H)]_{\theta_1} = 1 - 2p - r\delta.
$$
Институт «собственности» реализован, если следовать правилу (играть $D$ в роли «захватчика») не менее выгодно, чем его нарушать:
$$
\mathbb E[u(D)] \ge \mathbb E[u(H)]_{\theta_1}.
$$
Подставляя выражения, получаем:
$$
r\delta \ge 1 - 2p = \Delta u(p).
$$
где $\Delta u(p) > 0.5$ — структурный стимул «захватчика» к нарушению правила в мире, где «владельцы» с вероятностью $p$ ведут себя мягко.

Онтологически $p$ описывает состояние фоновой координации: насколько часто игроки и без санкций готовы следовать правилу «ястреб, если владелец и голубь, если захватчик». Чем выше $p$, тем меньше премия за отклонение $\Delta u(p)$ и, соответственно, меньше минимальное требование к $r\delta$. Институт же фиксируется не самим $p$, а неравенством $r\delta \ge \Delta u(p)$: санкционный слой должен перекрывать *структурный* стимул к девиации, задаваемый игрой и коррелирующим устройством.

![Параметры $r$ и $\delta$ компенсируют отклонение при разных вероятностях владельца играть $H$. Пунктирная линия означает порог $r\delta = \Delta u$](assets/hd-parameters.png)

Связь между размером выигрыша от отклонения и вероятности владельца играть «ястреба»:

![Отношение премии и вероятности следования сигналу в «Ястребы-Голуби» для стантартной матрицы описывается уравнением $1 - 2p$. Чем меньше вероятность, что оппонент последует сигналу, тем выше возможная премия.](assets/hd-line.png)
...
Зелёным показана область параметров $(\delta, r)$, где условная стратегия «будь агрессивным, если владелец и уступай, если захватчик» находится *в режиме института* — предполагает санкцию за отклонение, и является предсказуемой. Розовым показана область, где условная стратегия не является наилучшим ответом и институт фактически коллапсирует. Это ситуация «института на бумаге» или «спящего института»: правило определено, определена санкция за его нарушение, но фактически она не реализуется. Линия *прототинситута* проходит по $r\delta = 1 - 2p$ — здесь формально санкция за отклонение от условной стратегии есть, но она недостаточно часто применяется, поэтому её едва хватает для удержания нейтральной устойчивости. В этом смысле протоинститут не имеет «запаса прочности» и может коллапсировать в любой момент.

В онтологическом плане $r\delta$ здесь — институциональный механизм (право, санкции общины, репутационные потери и т.п.), который компенсирует «сырую» премию $\Delta u(p)$ и делает отклонение от правила невыгодным. При $r\delta < \Delta u(p)$ правило остаётся лишь «бумажной нормой» или «спящим» институтом, тогда как при $r\delta \ge \Delta u(p)$ оно реализуется как *строгое КР*.

Это наводит нас на мысль, что институт — это не одно равновесие, а *конфигурация параметров, где коррелированное равновесие в принципе реализуемо*.

Важно подчеркнуть, что пороговое значение не универсально и будет разным для разных игр. Пример выше служит не чтобы зафиксировать конкретный коэффициент, а для иллюстрации общего принципа: в любой игре ожидаемый штраф $r\delta$ должен перекрывать премию от отклонения от рекомендованной стратегии. В игре Ястреб-Голубь, чтобы премия за отклонения от правила была положительной, «владелец« должен играть «ястреба» с вероятностью $p < 0.5$. В других играх премия и, следовательно, порог будут иметь другую форму.

Однако идея порогового результата обобщается: в любой игре, где при некотором профиле рекомендаций премия от отклонения $\Delta u_i > 0$, для институциональной устойчивости требуется
$$
r\delta \geq \Delta u_i.
$$
ЯГ-случай даёт конкретный числовой пример $\Delta u = 0.5$, но не исчерпывает общее условие.
...
Обозначим
$$
\tilde r(s_i) = \mathbb{P}(\theta=1\mid s_i).
$$
Эта величина выражает эпистемическую оценку игрока: насколько вероятно, что именно в данном информационном состоянии институт функционирует и нарушение правила повлечёт санкцию.

Функция выигрыша теперь зависит и от $\theta$. При следовании рекомендациям (играть $S$ при сигнале $S$) санкция не применяется ни в одном состоянии, поэтому
$$
u(S,\theta=0) = u(S,\theta=1) = u(S),
$$
и ожидаемый выигрыш при соблюдении правила остаётся
$$
\mathbb{E}[u(S)]_{\theta=0}(p,s_i) = \mathbb{E}[u(S)](p) = 4p.
$$
При отклонении (играть $H$ при сигнале $S$) выигрыши в двух состояниях различаются: в мире без института $\theta=0$ игрок получает исходный выигрыш $u(H)$, а в мире с действующим институтом $\theta=1$ — штрафованный $u(H) - \delta$. Соответственно, ожидаемый выигрыш при отклонении с учётом неопределённости относительно применения санкций равен
$$
\mathbb{E}[u(H)]_{\theta=1}(p,s_i)
=
\mathbb{E}[u(H)\mid s_i,\theta=0]\cdot \mathbb{P}(\theta=0\mid s_i)
+
\mathbb{E}[u(H)-\delta\mid s_i,\theta=1]\cdot \mathbb{P}(\theta=1\mid s_i).
$$
Поскольку базовые выигрыши $u(H)$ не зависят от $\theta$, это сворачивается в
$$
\mathbb{E}[u(H)]_{\theta=1}(p,s_i)
=
\mathbb{E}[u(H)](p) - \tilde r(s_i)\,\delta
=
(2+p) - \tilde r(s_i)\,\delta.
$$

Институциональное правило «охоться на оленя» реализовано в информационном состоянии $s_i$ тогда и только тогда, когда для любого допустимого отклонения (здесь — перехода с $S$ на $H$) соблюдается условие:
\[
\mathbb{E}[u(S)]_{\theta=1}(p,s_i)
\;\ge\;
\mathbb{E}[u(H)]_{\theta=1}(p,s_i).
\]
Подставляя выражения, получаем
$$
4p \;\ge\; (2+p) - \tilde r(s_i)\,\delta,
$$
то есть
$$
\tilde r(s_i)\,\delta \;\ge\; 2 - 3p = \Delta u(p).
$$
...
p \geq \frac23.
$$
Это означает, что если $p < \frac23$, то санкция должна компенсировать недостаток. При $p = 0.5$
$$
r\delta \ge \Delta u(1/2) = 0.5.
$$
Отношение премии и вероятности следования $S$ для этой игры будет следующим:
...
А пространство параметров эффективности санкции для возвращения системы к равновесию будет следюущим:

![Объективная $r$ и субъективная оценка агента $\tilde r(s_i)$ вместе показывают «запас прочности» института](assets/stag_hunt_epistemic.png)

Структурная премия $\Delta u(p)$ по-прежнему определяется базовой игрой и распределением сигналов, а эпистемический слой входит только в виде множителя $\tilde r(s_i)$: игроку важно не «истинное» значение $r$, а то, насколько он *верит*, что санкции в данном контексте возможны. В базовой (неэпистемической) постановке условие устойчивости имело вид $r\delta \ge \Delta u(p)$. В полной эпистемической версии оно локализуется в виде
$$
\mathbb{P}(\theta=1\mid s_i)\,\delta \;\ge\; \Delta u(p).
$$
Если сигналы систематически указывают на редкое или избирательное наказание нарушителей (то есть $\mu(s_i\mid \theta=1)$ невелика, а $\mu(s_i\mid \theta=0)$ велика), апостериорная вероятность $\tilde r(s_i)$ может опуститься ниже порога, необходимого для устойчивости: при фиксированных $p$ и $\delta$ неравенство $\tilde r(s_i)\delta \ge \Delta u(p)$ перестанет выполняться. Тогда правило остаётся задекларированным, санкция $\delta$ — номинально существущей, но рациональный игрок, оценивая вероятность реальной санкции как низкую, возвращается к отклонению. Напротив, при сигналах, подтверждающих регулярное и беспристрастное применение санкций, $\tilde r(s_i)$ может быть существенно выше априорной оценки $r$, и условие устойчивости будет выполняться даже там, где на уровне одной только «материальной» комбинации $r\delta$ порог едва достигался.

Таким образом, эпистемический анализ «Охоты на оленя» показывает, что институциональный порог задаётся всё той же структурной формой $\Delta u(p)$, но фактически реализуется через локальную величину $\mathbb{P}(\theta=1\mid s_i)\delta$: агенты могут заблуждаться не относительно того, какие действия предписывает правило «охоться на оленя», а относительно того, насколько вероятно, что нарушение действительно повлечёт санкцию. И именно эти верования определяют, в каких информационных состояниях институт функционирует как устойчивый порядок, а в каких — деградирует до «института на бумаге».

Это позволяет различить несколько режимов функционирования институтов:
...
Мы оцениваем фактическую работоспособность института по субъективным оценкам агентов, поскольку именно они влияют на поведение агентов. Например, чтобы сэкономить деньги, на дорогах установили муляжи камер наблюдения: водителя верят, что они настоящие (или не знают наверняка), поэтому «на всякий случай» снижают скорость. Это фактически поднимает $r$, а значит увеличивает шансы на равновесный исход.

Важно, что в играх одного и того же типа (например, «Охота на оленя») возможны как конвенции, так и институты. В обоих случаях устойчивый социальный порядок можно описать посредством строгого БКР. Различается не целевое состояние, а *механизм* корреляции: в случае конвенции корреляция обеспечивается общим знанием структуры игры и взаимных ожиданий (в смысле Вандершраафа), тогда как в случае института — внешним механизмом принуждения, задающим ожидаемый штраф $r\delta$ за отклонение. Формальном это отражается в том, что и конвенция, и институт реализуют одно и то же множество аумановских КР, но в институциональном случае условие отсутствия стимулов к отклонению принимает вид
$$
\mathbb E[u_i(\sigma_i(s_i),\sigma_{-i}(s_{-i}))\mid s_i]
\;\ge\;
\mathbb E[u_i(a_i',\sigma_{-i}(s_{-i})) - r\delta D_i(s_i,a_i')\mid s_i],
$$
где параметр $r\delta$ компенсирует структурный стимул к нарушению $\Delta u$ в тех ситуациях, когда предпосылки полного общего знания конвенции не выполняются.

В конвенции же $\Delta u^{\max} \le 0$ — у агентов отсутствует структурный стимул к отклонению от координационного профиля, их интересы совпадают, о чём говорит отрицательная премия за блеф. Внешнее принуждение $r\delta$ здесь избыточно, а устойчивость порядка всецело опирается на взаимные ожидания и условие общего знания (подобно моделям Льюиса и Вандершраафа).
...
Онтологически институт — это не равновесие и не само правило, а именно *социоматериальный механизм принуждения*, который делает нарушение правила сопряжённым с ожидаемыми потерями $r\delta$ и тем самым влияет на стратегические расчёты игроков.

Формально мы говорим, что в игре «есть институт», если к базовым выигрышам $u_i$ добавлен такой механизм, что при отклонении от предписания ожидаемый выигрыш игрока заменяется на
$$
\mathbb{E}[u_i(a_i',s_{-i})\mid s_i] - \tilde r(s_i)\delta,
$$
в то время как при следовании сигналу выигрыши остаются базовыми. Это и есть минимальное формальное содержание института.

На этом фоне:

- *рабочий (устойчивый) институт* — это институт (в смысле механизма выше), для которого правило «следуй сигналу» фактически поддерживается как равновесное поведение, то есть выполняется условие
  $$
  r\delta \;\ge\; \Delta u_i(s_i,a_i')
  \quad\text{для всех } i,s_i,a_i'.
  $$

- *протоинститут* — это тот же тип механизма, заданный на том же правиле, но с параметрами ровно на пороге:  
  $$
  r\delta = \max_{i,s_i,a_i'} \Delta u_i(s_i,a_i'),
  $$
  так что институт уже определён (есть правило и санкционный механизм), но устойчивость поведения минимальна и легко теряется.
...
## 3.4 Эндогенность параметров и проблема генезиса институтов
Хотя в предложенной модели параметры надёжности санкции $r$ и её тяжести $\delta$ выступают экзогенными детерминантами байесовского коррелированного равновесия, в социальной реальности эти величины глубоко эндогенны. Они — не предзаданные свойства среды, а продукты *целенаправленных* структурных инвестиций.
...
Это позволяет нам говорить о реальном и воспринимаемом агентами $r$ — с точки зрения «инвесторов» в институт и его пользователей. Агенты могут воспринимать институт как «сильный», хотя с точки зрения инвестиций в него он не обеспечивает нужное значение $r\delta$. Это позже позволит нам говорить о фаллибилизме — что агенты могут ошибаться по поводу *силы института*, но не по поводу его содержания, как это есть у Гуалы и Хиндрикса.
— деятельности специфического агента, которого можно назвать Инвестором.

Ключевой вопрос генезиса институционального порядка в нашей модели звучит так: откуда берётся сама санкционная инфраструктура? Кто первым несёт издержки на создание механизма мониторинга и карательный аппарат? Кто оплачивает «издержки второй стороны» — наказание нарушителей?
...
Подобную идею можно обобщить. Инвестор — это любой макро-агент (доминирующая группа, коалиция, государство), который:

1. Обнаруживает эвристически, что стабильное равновесие $r\delta \ge \Delta u$ ему выгоднее, чем хаотичное перераспределение.
2. Инвестирует часть ресурсов в создание и поддержание санкционной инфраструктуры: бюрократии, судов, армии, полиции и другого.
3. Взамен получает *институциональную ренту* — стабильный поток ресурсов от функционирующего порядка.

Формально введём *функцию издержек* $k(r,\delta)$, показывающую, во сколько обходится поддержание данного уровня надёжности $r$ и суровости $\delta$. Эти издержки несёт Инвестор.

Другая вещь, которая вытекает из эндогенности $r$ — что надёжность санкции $r$ снижает минимальную жёсткость санкции, нужную для поддержания условной стратегии в равновесии. Санкция вряд ли будет непропорционально высокой, имеет стоимость поддержания $k(\delta)$, которую «оплачивает» Инвестор. И чем выше надёжность санкции, тем «дешевле» её поддерживать. Если на дорогах страны треть камер — муляжи, и водители не знают в каждый конкретный момент, муляжи перед ними или нет, это снижает количество нарушений скоростного режима и последующих разбирательств. Однако если стоимость поддержания санкции небольшая, то зависимости между $k(\delta)$ и $\delta$ может и не быть: например, автоматический штраф при видеофиксации нарушения имеет минимальные издержки и может быть сколь угодно высоким.

В нашей модели параметры $(r,\delta)$ были экзогенными. Теперь покажем, как они могут возникать из оптимизации Инвестора.
...
- В доиндустриальных обществах физическое наращивание $\delta$ — публичные казни, жестокие наказания — обходилось дешевле, чем масштабирование $r$. «Театральная» жестокость выступала суррогатом информации — попыткой достичь $r\delta \ge \Delta u$ в условиях низкой раскрываемости преступлений.

- В современных обществах цифровизация — камеры, цифровые реестры, алгоритмический контроль — резко снижает предельную стоимость обеспечения $r$, позволяя развитым государствам уменьшать $\delta$, делая ставку на неотвратимость наказания.
...
Это объясняет, почему институты могут функционировать при заниженных реальных параметрах: агенты оценивают $\tilde r(s_i)$ по наблюдаемым сигналам (муляжи работают), а не по объективным данным $r$. Инвестор эксплуатирует эту асимметрию.
...
Резюмируя данную главу, мы построили параметрическую модель социального института, базирующуюся на логике байесовского коррелированного равновесия (BCE). Ключевыми переменными институциональной устойчивости выступают тяжесть применяемой санкции $\delta$ и статистическая надёжность её наступления $r$. Формализованный «порог институциональности» выражается лаконичным соотношением $r\delta \ge \Delta u^{\max}$, которое позволяет разграничивать функционирующие институциональные механизмы от неформальных конвенций и «бумажных» норм. Внедрение концепта Инвестора позволило раскрыть эндогенную природу инфраструктуры принуждения — показать, как параметры $(r,\delta)$ могут возникнуть из оптимизации макро-агента, заинтересованного в стабильности.

В следующей главе разработанный теоретико-игровой каркас будет интегрирован с проектом натуралистической социальной онтологии. Предстоит продемонстрировать, как именно предложенная архитектура параметров переопределяет классическое понимание правил и равновесий, обосновать притязания модели в качестве базиса для структурно-реалистской онтологии институтов и показать, как она согласуется с классическими социологическими теориями.
...
В предыдущих главах мы построили такую модель. Она описывает институт как *механизм*, который изменяет структуру стратегического взаимодействия: за отклонение от рекомендованной условной стратегии вводится ожидаемый штраф, зависящий от размера и надёжности применения санкции. Устойчивость института определяется тем, перекрывает ли ожидаемая санкция премию за отклонение. 

В этой главе нас интересует не столько формальная сторона, сколько онтологический смысл этой конструкции: что именно в мире реализует параметры нашей модели, как в неё вписываются правила и равновесия, и почему она является хорошим кандидатом на «естественный вид» института в натуралистическом смысле.
...
- *фундаментален санкционный слой*: наличие ожидаемого штрафа $r\delta$ за отклонение от условной стратегии;  
- коррелированные равновесия Ауманна — *удобный способ описать устойчивые паттерны поведения*, когда санкция перекрывает премию от отклонения $r\delta \ge \Delta u$;  
...
![Теория $T_1$ объясняет все классы феноменов теории $T_2$, поэтому она более «сходима» (consilient) в «подчинительном» (subsumptive) смысле. Взято их @maki2009](assets/consilience-1.png)
...
![Теория $T_1$ объясняет больше классов феноменов, поэтому она более «сходима» (consilient), чем $T_2$ в «кардиналном» смысле. Взято их @maki2009](assets/consilience-2.png)
...
Настоящее исследование было посвящено решению фундаментальной проблемы социальной онтологии — объяснению принудительной силы социальных институтов. В заключении необходимо подвести итоги, ответить на вопрос, поставленный в начале, и наметить перспективы развития предложенного подхода.

## Почему «правила-в-равновесии» не решают проблему принудительной силы

Проведённый в первой главе анализ существующих исследовательских программ позволил выявить глубокий тупик, в котором оказалась социальная онтология при объяснении принудительной силы институтов.

*Традиция конститутивных правил* в лице Джона Сёрла предложила влиятельную онтологию институтов через формулу «X считается Y в контексте C». Однако эта теория постулирует деонтические силы, не объясняя их механизм. Коллективное принятие само по себе не создаёт материальной силы, способной принуждать к следованию правилам. Теория остаётся в рамках менталистской парадигмы, не связывая нормативность с материальной инфраструктурой санкций.

*Традиция равновесного подхода* (Льюис, Ауманн, Скирмс) объясняет координацию ожиданий, но не принуждение. Коррелированные равновесия показывают, как агенты могут координировать свои действия без предварительного соглашения, но не объясняют, почему отклонение от equilibrium влечёт негативные последствия для нарушителя.

*Теория правил-в-равновесии* Гуалы и Хиндрикса представляет собой наиболее влиятельную попытку синтеза. Однако, как было показано во второй главе, эта теория сталкивается с фундаментальной проблемой — *кругом в определении*: правила помогают агентам достичь равновесий и одновременно репрезентируют уже существующие стратегии, которым необходимо следовать в игре. Неясно, что онтологически первично — правила или равновесия, и откуда возникает нормативность.

Более того, теория правил-в-равновесии не объясняет *происхождение санкционного механизма*. Гуала и Хиндрикс признают, что их объяснение принудительной силы — это «слабая нормативность» инструментальной рациональности: агентам невыгодно отклоняться от стратегии, предложенной устройством корреляции. Однако это объяснение работает только при условии, что отклонение уже влечёт негативные последствия. Откуда берутся эти последствия — теория умалчивает.

Таким образом, существующие программы объясняют либо координацию (но не принуждение), либо постулируют нормативность (но не объясняют её механизм), либо объединяют оба элемента в композицию с неясным онтологическим статусом. *Проблема принудительной силы остаётся нерешённой.*

## 5.2. Предложенное решение: параметрическая социальная онтология

Предложенная в третьей главе параметрическая модель преодолевает указанные ограничения путём введения двух ключевых параметров, характеризующих санкционную инфраструктуру:

- *r* — надёжность фиксации: вероятность того, что нарушение будет обнаружено, зафиксировано и станет основанием для санкции;
- *δ* — тяжесть санкции: величина негативных последствий, применяемых к обнаруженному нарушителю.

*Условие институциональной устойчивости*: институт устойчив тогда и только тогда, когда ожидаемая санкция превышает премию за отклонение:

$$r\delta \geq \Delta u$$

Это условие связывает воедино то, что ранее оставалось разрозненным: координацию (обеспечиваемую механизмом коррелированного равновесия) и принуждение (обеспечиваемое санкционной инфраструктурой). Координация объясняет, как агенты координируют свои ожидания; санкционная модель объясняет, почему отклонение влечёт негативные последствия.

*Идея генезиса институтов* объясняет возникновение санкционной инфраструктуры через фигуру *Инвестора* (оседлого бандита). Инвестор — специализированный агент, оптимизирующий долгосрочную ренту от стабильного порядка. Он инвестирует в создание и поддержание канала санкций (мониторинг и наказание) в расчёте на экономическую ренту. Эта модель показывает возможность закрыть пробел в существующих теориях, объясняющих лишь поддержание, но не возникновение институтов.

*Онтологический тезис* параметрической модели состоит в следующем: существует реально действующий макроструктурный инвариант — конфигурация стимулов, санкций и мониторинга, — делающая социальный порядок стабильным. Это не одна из конкурирующих перспектив, а единственный обнаруживаемый нами структурный инвариант, обеспечивающий объяснительную унификацию социальных феноменов.

Параметрическая модель не претендует на онтологическую завершённость. Она задаёт необходимые структурные условия институциональной устойчивости, но не достаточные для понимания конкретных исторических форм. Социологическое знание остаётся незаменимым в описании того, каким образом параметры конкретизируются в различных обществах, эпохах и культурных контекстах.

## 5.4. Продуктивность модели как исследовательской программы

Предложенная модель обладает рядом свойств, делающих её продуктивной исследовательской программой.

*Обратная совместимость с существующими теориями.* Параметрическая модель не отвергает, а интегрирует находки предшествующих программ. Теории конвенций (Льюис) объясняют механизм координации ожиданий. Теории правил (Норт, Остром) описывают институциональные формы. Теория правил-в-равновесии (Гуала, Хиндрикс) показывает, как правила стабилизируют равновесия. Параметрическая модель добавляет недостающий элемент — объяснение того, почему отклонение влечёт негативные последствия.

*Связь с классической социологией.* Модель позволяет реконструировать классические социологические теории как описания различных конфигураций базовых параметров:

- *Веберовское легитимное господство* — это конфигурация (r, δ), при которой rδ ≥ Δu. Типы легитимности соответствуют различным механизмам поддержания r и δ. Утрата легитимности — снижение r ниже критического порога.
- *Дюркгеймовский ритуал* — механизм синхронизации мониторинга, повышающий r. Коллективные представления — общий язык координации ожиданий.
- *Символическое насилие* (Бурдьё) — конфигурация, при которой δ_int (интернализованная санкция) превышает δ_ext (внешняя санкция).
- *Ресурсы власти* (Гидденс) — способность изменять параметры r и δ для других агентов.

*Эмпирическая операционализируемость.* В отличие от многих социально-онтологических конструкций, параметры модели могут быть операционализированы для эмпирических исследований:

- Δu может быть измерена через сравнение выигрышей от следования правилу и от его нарушения;
- r может быть оценена через вероятность обнаружения нарушений (например, через статистику правонарушений, данные аудита, социологические опросы);
- δ может быть измерена через тяжесть формальных и неформальных санкций.

*Прогностический потенциал.* Модель позволяет прогнозировать институциональную динамику при изменении параметров:

- Рост Δu (например, вследствие технологических изменений, создающих новые возможности для нарушений) ведёт к нестабильности;
- Снижение r (например, при ослаблении мониторинга) ведёт к нестабильности;
- Снижение δ (например, при либерализации санкций) ведёт к нестабильности.

Это открывает возможности для анализа институциональных кризисов и разработки стратегий институционального дизайна.

*Типология институциональной устойчивости.* На основе модели можно выстроить типологию институтов по степени устойчивости:

- *Устойчивые институты*: rδ >> Δu;
- *Маргинальные институты*: rδ ≈ Δu;
- *Хрупкие институты*: rδ < Δu или близко к порогу.

Эта типология позволяет проводить сравнительные исследования институциональной конфигурации в различных обществах и эпохах.

## 5.5. Ограничения и направления дальнейшего развития

Настоящее исследование имеет ряд ограничений, которые должны учитываться при интерпретации результатов и определении направлений дальнейшей работы.

*Ограничения модели:*

*Предпосылка о рациональности.* Модель основана на предпосылке о рациональности агентов, способных вычислять ожидаемые выигрыши и принимать решения на основе этих вычислений. В реальности агенты не являются полностью рациональными; их поведение определяется более сложными когнитивными, эмоциональными и культурными механизмами. Однако для целей структурного объяснения предпосылка о рациональности может быть принята как рабочая — подобно тому, как физика принимает предпосылку о точечных частицах для объяснения макроскопических феноменов.

*Уровень анализа.* Модель преимущественно фокусируется на микроуровне парного взаимодействия и его экстраполяции на «широкую сеть сходных ситуаций». Социальные феномены макроуровня — социальная стратификация, институциональные поля, глобальные системы — требуют дополнительной разработки. Интеграция с теориями среднего уровня (социальные сети, институциональные поля) остаётся задачей дальнейших исследований.

*Фигура Инвестора.* Модель Инвестора объясняет возникновение санкционной инфраструктуры, но не объясняет, почему в одних обществах возникают «осёдлые бандиты», а в других — нет. Этот вопрос требует обращения к историческим, культурным и экологическим факторам, выходящим за рамки формальной модели.

*Интернализация санкций.* Модель преимущественно рассматривает внешние санкции. Интернализованные санкции (стыд, вина, совесть) требуют отдельного анализа. Связь между внешними и внутренними санкциями — важная тема для дальнейших исследований.

*Направления дальнейших исследований:*

*1. Расширение на множественных агентов.* Модель может быть расширена на случаи множественных Инвесторов, конкурирующих юрисдикций и сетевых эффектов. Это позволит анализировать институциональную конкуренцию, федеративные системы и глобальное управление.

*2. Динамическая параметризация.* Разработка моделей с динамически изменяющимися параметрами r, δ и Δu позволит анализировать институциональные трансформации, кризисы и эволюцию.

*3. Эмпирическая проверка.* Проведение эмпирических исследований для проверки выводов модели на материале конкретных институтов (право собственности, трудовое законодательство, экологические нормы и др.).

*4. Интеграция с социологией.* Разработка операциональных мер для параметров модели на основе социологических и экономических данных; тестирование предсказаний модели на кросс-культурном и историческом материале.

*5. Технологический мониторинг.* Исследование влияния новых технологий (цифровой мониторинг, искусственный интеллект, блокчейн) на параметр r и, следовательно, на институциональную устойчивость.

*6. Институциональный дизайн.* Разработка практических рекомендаций по институциональному дизайну на основе параметрической модели: как повышать r и δ, как снижать Δu, как обеспечивать устойчивость при минимизации издержек.

---

Подводя итог, отметим, что настоящее исследование не претендует на окончательное и исчерпывающее решение проблемы принудительной силы социальных институтов. Социальная реальность слишком сложна и многообразна для какой-либо одной формальной модели. Однако, следуя методологии вывода к наилучшему объяснению, мы можем утверждать, что предложенная параметрическая модель представляет собой лучшее на сегодня объяснение механизма принудительной силы.

Наша модель заимствует сильные стороны конкурирующих программ — идею стратегической устойчивости у равновесных подходов, внимание к нормативным описаниям у теорий правил, синтетический характер у теории правил-в-равновесии, — но добавляет недостающий элемент: объяснение того, почему нарушение правила влечёт негативные последствия для нарушителя. Именно этот элемент — санкционный механизм, параметризованный через (r, δ, Δu) и генетически объяснённый через инвестиционное решение Инвестора, — и составляет суть принудительной силы социального института.

Социальный порядок длится ровно до тех пор, пока для критической массы акторов следование правилам остаётся математически не хуже отклонения с учётом всей матрицы социоматериальных последствий. Когда это условие перестаёт выполняться — институт распадается. Этот структурный инвариант — не метафора и не предпосылка, а эмпирически обнаруживаемая закономерность, которую призвана схватить параметрическая социальная онтология.

В этом смысле наша унифицированная параметрическая онтология замыкает методологическое движение, начатое в первой главе. От критики аналитической социальный онтологии и вопроса о возможных «естественных видах» мы пришли к конкретному кандидату: институт как социоматериальная инфраструктура фиксации нарушений и реализации наказаний, делающая определённый класс условных стратегий устойчивым. Этот кандидат не претендует на окончательную истину, но, в терминах IBE, предлагает лучшее на сегодня объяснение того феномена, с которого мы начали: того, как институты приобретают и удерживают принудительную силу.
