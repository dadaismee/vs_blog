...
Для конкретной симуляции удобно взять $\delta_{min} = 12.51$, чтобы удовлетворить строгому неравенству $\pi(I,I) > \pi(J,I)$ в ЭСС [@maynardsmith1982]. При $\delta = 12.5$ выигрыши $B$ и $L$ в игре против Буржуа совпадают ($25$), так что условная стратегия Буржуа теряет статус *чистой* ЭСС, потому что исчезает перекос в её пользу. Однако значения выше этого порога стабильно приведут Буржуа к чистой ЭСС. Чтобы продемонстрировать это, рассмотрим *репликаторную динамику* в упрощённой игре между Буржуа и Блефующими (без Ястребов и Голубей — потому что мы вслед за Мейнардом Смитом [@maynardsmith1982] и Скирмсом [@skyrms2014] допустим, что Буржуа стала ЭСС и вытеснила остальные стратегии из популяции).
...
В дальнейших разделах мы будем интерпретировать r как результат существования или отсутствия институционального канала, связывающего отдельные игры, и покажем, как вложения в такой канал со стороны “элит” позволяют удерживать систему в области $r\delta > \frac{V}{4}$, где условная стратегия Буржуа остаётся эволюционно устойчивой.
