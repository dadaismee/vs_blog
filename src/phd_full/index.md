...
\begin{array}{|l|c|c|c|}
\hline
& \textbf{Ястреб} & \textbf{Голубь} & \textbf{Буржуа} \\ \hline
\textbf{Ястреб} & \frac{V-C}{2}, \frac{V-C}{2} & V, 0 & \frac{V-C}{2}, V-C \\ \hline
...
В онтологическом смысле, правила у Гуалы существуют *только потому*, что, как мы выяснили, являются результатом базовой игры. То есть на самом деле у Гуалы всё же два вида правил — подни создают пространство игры «второго уровня», описывающей институт, и вторые — правила в игре «второго уровня». Это очень похоже на конститутивные и регулятивные. Трюк заключается в том, что их формулировка в обоих случаях одинакова — «если…, то…». Это даёт Гуале возможно редуцировать все правила к регулятивным.
