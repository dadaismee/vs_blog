...
\end{array}
$$
<figcaption class="caption">Когда оба агента выбирают <span style="color: red">условную стратегию</span>, каждый получает равный выигрыш.</figcaption>
</div>
...
Однако если присмотреться к играм, можно заметить разницу в допущениях — онтологических и эпистемологических. 

Например, по мнению К. Бинмора, Гуала и Хиндрикс «мутят воду», приводя пример с ЯГБ, поскольку последняя предполагает *эволюционно стабильную стратегию* (ЭСС) в качестве концепции равновесия, а не КР [@binmore2015].
