...
*Объект исследования* — социальные институты, под которыми понимаются устойчивые паттерны поведения и взаимодействия. К социальным институтам относятся собственность, государство и его органы, деньги, брак и другое.
...
2. Интеграционный аспект: как единообразно описать источник принудительной силы института между разнородными теориями в экономике социологии.
...
1. *Имманентная критика существующих теорий институтов* в философии социальной науки и социальной онтологии. В рамках этой задачи предстоит:
   ...
   - Рассмотреть равновесный подход к институтам и социальной стабильности более широко: традицию Льюиса-Вандершраафа, теории социальных норм как «слабого» принуждения Биккиери [@bicchieri2005; @bicchieri2023] и Гинтиса [@gintis2009a], теорию Грейфа, чтобы обнаружить общие черты, формализуемые с помощью игры;
...
5. *Предложить непротиворечивую онтологическую и объяснительную унификацию теорий социальных институтов*. В рамках этой задачи предстоит:
    ...
    - Показать, что унификация, производимая ПвР, не производит единой объяснительной схемы, а лишь связывает инструменты;
...
6. *Вписать нашу унифицированную натуралистическую онтологическую рамку в контекст философии науки*. В рамках этой задачи предстоит:

    - Очертить положение социальных наук и социологии, в частности, в дискуссии о научном реализме;
    ...
    - Показать, что наше условие стабильности института, а также онтологическая интерпретация параметров размера и вероятности санкции как механизмов и инфраструктуры реализации санкций  «схватывает» общее основание некоторых социологических теорий;
    - Выдвинуть онтологический тезис, что наше условие стабильности института отражает реально существующую в мире структуру, «реальный паттерн» в смысле Деннета, необходимый для социального порядка и многоаспектно схватываемый теориями социологии.

  - Показать, что наше условие стабильности института отражает минимальную структурную характеристику института.
