...
<!--[? как из методологической разницы игр следует онтологическая]-->
...
Как так получилось, что разные по своей сути игры — на конфликт и на координацию — стали одинаковыми по форме? Так получилось потому, что Гуала, по нашему мнению, описывает несуществующий объект как решение игры — конвенцию, естественно возникшую из истории игры, которая логически невозможна.
...
Это означает, аргумент Гуалы о недостаточности равновесий не вполне состоятелен, поскольку сравнивает две кардинально разных игры, похожих лишь поверхностно. 
