...
- посмотреть @gilbert1992 и найти про интеллектуализм

Другая лакуна в теоретической традиции Сёрла — переоценка коллективной интенциональности и языка, или «сверхинтеллектуализм», как это назвала Маргарет Гильберт [@gilbert1992]. 

[? критика хиндрикса про институты без конститутивных правил] Хиндрикс показывает, что институты могут существовать без явных деклараций. В 

[? критика гуалы про умозависимость] Франческо Гвала критикует умозависимость: она подразумевает инфаллибилизм (нет ошибок об институтах), противореча реализму (Guala, 2010). 
...
На наш взгляд, спор о различении типов правил имеет под собой два несколько вопросов:

- каковы условия, при которых нечто *считается* социальным фактом??
- каковы условия, при которых нечто *функционирует* как социальный факт?
- что значит «функционировать как социальный факт»?
- необходимо ли, чтобы нечто считалось социальным фактом, чтобы функционировать таким образом?
