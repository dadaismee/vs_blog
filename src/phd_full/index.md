...
## 3.1. $\delta$-параметр как условие устойчивости
...
## 3.2 Вероятность реализации санкции и институт как область параметров
...
## 3.3 Возможная эмпирическая операционализация параметра $r$
...
### 4.2 Онтологический статус правил, равновесий и санкций

Поскольку мы расширяем онтологию правил-в-равновесии, закономерный вопрос — как в нашей параметрической онтологии интегрированы правила и равновесия, и что есть помимо них. 
