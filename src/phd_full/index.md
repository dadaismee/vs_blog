...
Теория Сёрла часто подвергалась критике: из-за недостаточности деонтических сил для объяснения следования правилам [@guala2015], отсутствия механизма возникновения конститутивных правил и каузальности деонтических сил [@hindriks2009], переоценки роли рационального коллективного признания и «сверхинтеллектуализма» [@gilbert1992] и других. Помимо критики внутри философии и социальной онтологии, теория Сёрла подвергалась критике в философии социальной науки — особенно за постулирование примата социальной онтологии над методологией изучения социальной реальности [@lauer2019; @little2020; @kincaid2021; @ross2023]. 

Социолог Энтони Гидденс считает различие между конститутивными и регулятивными правилами искусственным: все правила, по его мнению, имеют оба аспекта. Например, правило «работники должны отмечаться в 8:00» регулирует поведение, но конституирует индустриальную бюрократию [@giddens1984]. Дэвид-Хиллел Рубен и Джеффри Уорнок видят в этом различении лишь лингвистическую разницу: действия конститутивны или регулятивны относительно описания, а не онтологически [@ruben1997; @warnock1971]. Миллер [@miller2001, 191] и Людвиг [@ludwig2017, 262] переопределяют конститутивные правила как регулятивные. В частности, Людвиг называет конститутивные правила такими регулятивными правилами, намеренное следование которым и конституирует управляемую им активность. Иначе говоря, конститутивные правила — это просто целенаправленно следуемые регулятивные правила.

Фрэнк Хиндрикс продолжает идею Гидденса и Уорнока, что различение типов правил у Сёрла — лингвистическое, и даже предлагает логическую схему сводимости одних к другим [@hindriks2009]. Однако он также считает, что это не умаляет онтологического значения конститутивных правил. Даже если лингвистически они похожи, то онтологически (или, скорее, функционально) — нет, утверждает Хиндрикс.

ОСТАНОВИЛСЯ ЗДЕСЬ

Помимо этого, Хиндрикс критикует переоценку Сёрлом роли языка и показывает, что институты могут существовать без явных деклараций. 
...
Хиндрикс [-@hindriks2005] подверг сомнению несколько аспектов конститутивно-правовой модели Сёрла. Его деконструкция сосредоточена на понятиях *функций статуса* и роли языка. В целом, Хиндрикс утверждал, что теоретический аппарат Сёрла вводит в заблуждение, и что более упрощенное объяснение может быть дано путем сосредоточения внимания на коллективном принятии и нормативных полномочиях.

- **Функции статуса как деонтические полномочия.** Хиндрикс считает термин *функция статуса* запутанным и несколько избыточным. Он предлагает отказаться от «функции» и просто рассматривать статусы как нормативные полномочия. По его словам, «мы можем обойтись без термина «функция», сохранив при этом термин «статус», вместо этого объясняя статусы непосредственно как совокупность деонтических полномочий, которые они предоставляют [@hindriks2009]. Приравнивая статусы к деонтическим полномочиям (правам, обязанностям), Хиндрикс делает нормативный аспект институтов явным, а не скрывает его под метафорой «функции» [@hindriks2009]. Действительно, сам Сёрл признавал, что «все статусные функции являются деонтическим полномочиям», что поддерживает стремление Хиндрикса к более прямой терминологии [@hindriks2009].

- **Избыточность заявлений о статусных функциях.** Идея Сёрла о *заявлении о статусной функции* — речевом акте, который якобы создает или признает статус, — для Хиндрикса является излишней. Он утверждает, что два ключевых утверждения, которые Сёрл приписывает таким заявлениям (что коллективное принятие является необходимым и достаточным условием для статуса), уже имплицитно присутствуют в стандартной формулировке «считается как». Как только мы признаем, что *институциональные статусы требуют коллективного принятия и что только коллективное принятие приводит их к существованию* («Принцип коллективного принятия»), особое понятие Декларации о статусной функции ничего нового не добавляет [@hindriks2015]. Введение деклараций без всяких доводов предполагает, что только явные речевые акты могут создавать институты; Хиндрикс считает это неоправданным и бесполезным. Он заключает, что от дополнительного механизма Сёрла (Декларация о статусной функции с ее «двойным направлением соответствия») следует отказаться, поскольку он «не добавляет ничего ценного» [@hindriks2015].

- **Лингвистическое и нормативное различие.** Хиндрикс также ставит под сомнение акцент Сёрла на языке как источнике всей институциональной власти. В своих ранних работах Хиндрикс утверждал, что различие между регулятивными и конститутивными правилами носит преимущественно грамматический характер: регулятивные правила формулируются с использованием явных императивов или деонтических терминов, в то время как конститутивные правила формулируются с помощью конструкции «считается как», но оба содержат одно и то же нормативное содержание [@hindriks2009]. Нормативные обязательства явно присутствуют в регулятивных правилах («Сделай X» / «Если Y, сделай X»), тогда как конститутивные правила подразумевают эти обязательства, не заявляя о них явно. Таким образом, место нормативности на самом деле не отличается между ними; отличается только языковое представление. Хиндрикс призывает к такому взгляду на институты, который сосредоточен на *коллективной приверженности* и принятии стандартов, а не на языковых декларациях как таковых [@hindriks2009].


В целом, Хиндрикс разрушает концепцию Сёрла о надстройке статусных функций и деклараций, предлагая вместо этого «объяснить статусы с точки зрения нормативных полномочий» и опираться на более простой принцип коллективного принятия [@hindriks2009; @hindriks2015]. Согласно этой точке зрения, институты поддерживаются группами, коллективно одобряющими определенные правила, и именно результирующие нормативные полномочия этих правил имеют решающее значение. Его критика прокладывает путь к объединению подхода Сёрла с более аналитическими моделями, переводя конститутивные утверждения на язык регулятивных правил и равновесий.
