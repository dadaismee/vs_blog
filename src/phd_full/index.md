...
## 4.2 Онтологическая унификация и сравнение с другими теориями

ОСТАНОВИЛСЯ ЗДЕСЬ

<!--В первой главе мы отнесли теорию Гуалы и Хиндрикса к наиболее продвинутым кандидатам на унифицированную социальную онтологию. Там же поднимался вопрос о том, не подменяется ли объяснение конвенции ссылкой на уже существующую конвенцию и не остаётся ли принудительная сила институтов в тени.-->
<!---->
<!--Наша модель сохраняет важные интуиции этого подхода, но перераспределяет акценты. Мы согласны, что институциональный порядок — это устойчивый паттерн, а правила играют роль фокальных точек, координирующих ожидания. Но устойчивость этого порядка зависит не только от верований, а от наличия объективной инфраструктуры наказаний, которая задаёт параметры ожидаемой санкции. Одно и то же правило может описывать как конвенцию (когда структура игры сама делает отклонение невыгодным и общие ожидания достаточно сильны), так и институт (когда требуется внешняя санкционная поддержка).-->
<!---->
<!--В этой рамке идея Гуалы о институте как «естественном виде» получает уточнение. Институтом мы называем не просто правило‑в‑равновесии, а класс социоматериальных структур, которые обеспечивают устойчивое превышение ожидаемой санкции над премией за отклонение. Верования и правила по‑прежнему важны, но они описывают и кодируют этот механизм, а не исчерпывают его. Фаллибилизм также смещается: акторы могут ошибаться насчет того, насколько велик и стабилен «запас прочности» института.-->
<!---->
<!------->
<!---->
