...
Более того, мы принципиально отказываемся от тяжеловесного понятия «естественный вид» в сильном смысле Милля-Бойда. Поскольку параметры $r$ и $\delta$ напрямую зависят от верований, ожиданий и способности агентов интерпретировать угрозу наказания, институт неизбежно остаётся *интерактивным видом* (interactive kind) в терминологии Яна Хакинга [@hacking1999], подверженным «эффекту петли». Тем не менее, опираясь на натуралистическую онтологию Дона Росса, мы утверждаем, что эта интерактивность не мешает институтам образовывать **реальные паттерны** [@dennett1991; @ross2000]. Структурные свойства этих паттернов — поведение в окрестности равновесия $r\delta \ge \Delta u$ — остаются объективно моделируемыми, даже если их «носителями» выступают интерактивные убеждения агентов. Это снимает излишний метафизический груз «естественных видов», сохраняя при этом фундаментальную силу научного индуктивного вывода.
