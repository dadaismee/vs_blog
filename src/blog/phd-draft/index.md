...
## Interim results
In this chapter, we have put the notion of social conventions into the context of social ontology and identified the majot problems within the leading unified framework of "rules-in-equilibria" theory of Guala and Hindriks.
...
We spotted a problem with agency models in HDB game where Guala and Hindriks illegitimately transferred "correlated conventions" from evolutionary context to epistemic game. To reiterate, animal HDB, although can be seen as CE, operates on phenotypes as agents and not Bayesian-rational individuals as Guala and Hindriks stiulate. This conflation generates a problem in their insufficiency argument for introduction of rules as separate explanatory entities: if human HDB normativity is already there, while in animal HDB rules are just not needed as a correlation device. I argued that this generates a further problem with introduction of the notion of "representation" as an explanation of the difference between animal and human conventions, for they conflate scientific and cognitive notions of representation which leaves normativity unexplained and the gap between animal and human conventions mysterious. I also argued that these problems might be due to the author's subscription to a representational subsumption view of scientific explanation, according to which the the explanatory power comes from the features of representation rather than from its real-world counterpart.

Overall, reframing the explanatory target of RiE from the stability of social institutions to the transition from the stable animal conventions to stable humans ones for the sake of resolving the epistemological problem within RiE, make the problem harder. It is so because we now essentially need to explain the emergence of human social epistemology, which is much grander project than "fixing some social ontology theory from a philosophy of science point of view". The dynamic trajectory of social coordination is complex and, as @ross2012a points out, social coordination is inherently difficult due to the multiplicity of equilibria, and features of social organization tend to evolve and stabilize to make it easier. However, as he says, it does not illuminate anything about the relationship between coordination problems and emergence of normativity: 
...
What we can do is to build some models possibly explaining this dynamic trajectory and answering the question of how normativity as a "feature of environment" might have evolved from non-normative and non-epistemic agents playing CE? This is what we are going to do in the next chapter.

# Chapter 3. Evolution of normativity from non-epistemic agents with epistemic niche construction
- Sterelny's theory of decoupled representation
- Wider theory of niche construction
- reformulation of RiE's problem in terms of RL and Bayesian agents
- emergence of bayesian agent from rl agent
    - philosophical formulation (🔥 @okasha2015 + research rabbit)
    - formal formulation
- my model — RL-Bayes Niche Construction model (RLBNC)
- Implications of RLBNC model for RiE
